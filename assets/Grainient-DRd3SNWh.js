import{r as c,j as ae}from"./index-CsN9i2on.js";import{R as te,T as ne,P as ue,M as re}from"./Triangle-GlFcswsc.js";const h=i=>{const u=/^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(i);return u?[parseInt(u[1],16)/255,parseInt(u[2],16)/255,parseInt(u[3],16)/255]:[1,1,1]},ie=`#version 300 es
in vec2 position;
void main() {
