import{r,s as _,j as e}from"./index-CYkigCbj.js";import W from"./lenis-niKyKZQP.js";import{c as X}from"./company-D-rC5gQU.js";import{P as J}from"./PreviewChrome-C1Wtla8x.js";import{P as K}from"./PreviewFooter-DvBOQJv0.js";import"./copy-C7_1aP-a.js";import"./createLucideIcon-CfKWMQ9l.js";import"./proxy-CNAlm4EX.js";import"./index-Cr2_b_7w.js";import"./send-YXoEzB_j.js";import"./index-CFQYWTTj.js";import"./external-link-Bk1qr-DW.js";import"./x-DJVRURuk.js";import"./check-DMGq8Tgj.js";import"./mail-CYTNeLo2.js";import"./SndrBadge-BvAgYvFk.js";const n="/iceland-redesigns/icelandluxurylodges",D="signy@icelandluxurylodges.com",U="mailto:signy@icelandluxurylodges.com",Q="+354 822 2202",Z="tel:+3548222202",ee="Miðengi 17, 800 Selfoss, Iceland",G="https://instagram.com/icelandluxurylodges",B="https://facebook.com/icelandluxurylodges",N={heroEstate:`${n}/hero-estate.jpg`,lodgeExterior:`${n}/lodge-exterior.jpg`,lodgeWide:`${n}/lodge-wide.jpg`,lodgeSuite:`${n}/lodge-suite.jpg`,lodgeSpa:`${n}/lodge-spa.jpg`,lodgeSauna:`${n}/lodge-sauna.jpg`,lodgeGameroom:`${n}/lodge-gameroom.jpg`,lodgeGym:`${n}/lodge-gym.jpg`,lodgeInt2:`${n}/lodge-int-2.jpg`,lodgeInt3:`${n}/lodge-int-3.jpg`,lodgeInt4:`${n}/lodge-int-4.jpg`,lodgeFamily:`${n}/lodge-family.jpg`,villa1:`${n}/villa-1.jpg`,villa2:`${n}/villa-2.jpg`,villa3:`${n}/villa-3.jpg`,villa4:`${n}/villa-4.jpg`,villa5:`${n}/villa-5.jpg`,villa6:`${n}/villa-6.jpg`,aslundurHouse:`${n}/aslundur-house.jpg`,aslundurPatio:`${n}/aslundur-patio.jpg`,aslundurDining:`${n}/aslundur-dining.jpg`,aslundurLiving:`${n}/aslundur-living.jpg`,aslundurTerrace:`${n}/aslundur-terrace.jpg`,aslundurMaster:`${n}/aslundur-master.jpg`,auroraStill:`${n}/aurora-night.jpg`,auroraFilm:`${n}/aurora-night.mp4`},R=[{id:"husin",label:"The houses"},{id:"ulfljotsskali",label:"Úlfljótsskáli"},{id:"alftavik",label:"Álftavík"},{id:"aslundur",label:"Áslundur"},{id:"bokun",label:"Enquire"}],q={word:"Iceland Luxury Lodges",sub:"Four private houses on the lakes of the Golden Circle. One family, one key each."},C={lead:"Still water carries the whole collection.",body:"Úlfljótsskáli stands by Úlfljótsvatn, Álftavík and Áslundur on the shore of Álftavatn, and a fourth key opens an apartment in Reykjavík. Each house is let whole, run by the same family, and reached inside an hour from the city."},ie=[{id:"ulfljotsskali",name:"Úlfljótsskáli",kind:"The lodge",sleeps:"Sleeps 19",img:"lodgeExterior",alt:"Úlfljótsskáli at dusk, hot tub and firepit on the deck"},{id:"alftavik",name:"Álftavík",kind:"The lakefront villa",sleeps:"Sleeps 12",img:"villa1",alt:"Álftavík villa on the shore of Álftavatn"},{id:"aslundur",name:"Áslundur",kind:"The lake house",sleeps:"Sleeps 8",img:"aslundurHouse",alt:"Áslundur lake house at Álftavatn"}],te=[{id:"ulfljotsskali",ord:"I",name:"Úlfljótsskáli",water:"by Úlfljótsvatn",lead:"A ten-bedroom lodge in the heart of the Golden Circle.",body:"The whole house comes with the key: a high-ceilinged hall for dining and long evenings, a spa wing with sauna and relaxation lounge, a gym, a game room, and a large hot tub under the open sky. Built for families and small groups, and quietly good at weddings.",facts:[{n:"10",l:"bedrooms"},{n:"19",l:"guests"},{n:"9½",l:"bathrooms"}],amenities:["High-ceiling hall with bar and dining","Sauna and relaxation lounge","Gym","Game room","Large outdoor hot tub","Fireplace and outdoor firepit"],photos:[{img:"lodgeWide",alt:"The bar and dining hall",wide:!0},{img:"lodgeSuite",alt:"Master suite"},{img:"lodgeSpa",alt:"Spa and sauna lounge"},{img:"lodgeSauna",alt:"The sauna"},{img:"lodgeGameroom",alt:"Game room"},{img:"lodgeGym",alt:"Gym"},{img:"lodgeFamily",alt:"En-suite bathroom of the family bedroom"}]},{id:"alftavik",ord:"II",name:"Álftavík",water:"on Álftavatn",lead:"The infinity hot tub meets the surface of the lake.",body:"A modern 170 m² villa on the shore of Álftavatn, fifty minutes from Reykjavík. The deck carries an infinity hot tub set flush against the waterline and a glass-walled panorama sauna facing the lake. Below the house: a black sand beach with its own firepit.",facts:[{n:"4",l:"bedrooms"},{n:"12",l:"guests"},{n:"170",l:"m²"}],amenities:["Infinity hot tub on the waterline","Panorama glass sauna","Black sand beach with firepit","Indoor and outdoor fireplaces","Three bathrooms","50 minutes from Reykjavík"],photos:[{img:"villa2",alt:"Álftavík living space with lake view",wide:!0},{img:"villa3",alt:"The villa interior"},{img:"villa4",alt:"Bedroom facing the lake"},{img:"villa5",alt:"The deck at dusk"},{img:"villa6",alt:"The shore below the villa"}],chip:{score:"4.94 of 5 · 162 reviews",source:"Airbnb, Top guest favorite"}},{id:"aslundur",ord:"III",name:"Áslundur",water:"on Álftavatn",lead:"The quiet one, with a sandy beach and the mountain across the water.",body:"Four bedrooms on the shore of the same lake: hot tub on the patio, fireplace inside, and a beach below the house that ends in open water. The view runs straight across Álftavatn to the mountain on the far side.",facts:[{n:"4",l:"bedrooms"},{n:"8",l:"guests"},{n:"2½",l:"bathrooms"}],amenities:["Hot tub on the patio","Fireplace","Sandy lakefront beach","Mountain view across the lake","Full kitchen and dining for the house"],photos:[{img:"aslundurPatio",alt:"Patio and hot tub",wide:!0},{img:"aslundurLiving",alt:"Living room with the loft above and the fireplace lit"},{img:"aslundurDining",alt:"Dining table facing Álftavatn through the glass"},{img:"aslundurTerrace",alt:"Covered terrace looking across the lake to the mountain"},{img:"aslundurMaster",alt:"Master bedroom with robes laid out"}]}],$={name:"The Art Collector’s Apartment",place:"Reykjavík",body:"The city key of the collection: a private apartment in Reykjavík for the nights before and after the lake. Ask us for details and dates."},b={score:"10/10",count:"28 reviews",source:"Vrbo",sourceNote:"Real reviews, quoted verbatim from your Vrbo listing on 16 August 2026, where Úlfljótsskáli holds 10/10 across 28 reviews with every sub-score at 10. On your own site they would sit here, on your own domain, working for you instead of for Vrbo.",quotes:[{text:"We were able to see the Northern Lights from the hot tub.",name:"Shawn R.",meta:"Úlfljótsskáli · Vrbo, November 2024 · 10/10"},{text:"This was the perfect place to bring our family to celebrate our wedding.",name:"Carrie S.",meta:"Úlfljótsskáli · Vrbo, May 2025 · 10/10"},{text:"Our stay at this property was absolutely incredible — the house itself is simply beyond nice.",name:"Patricia P.",meta:"Úlfljótsskáli · Vrbo, March 2026 · 10/10"},{text:"The common areas are extremely well designed for a large gathering, with everything you need provided.",name:"Blair B.",meta:"Úlfljótsskáli · Vrbo, January 2025 · 10/10"},{text:"Amazing stay at a wonderful property.",name:"Joshua S.",meta:"Álftavík · Vrbo, July 2025 · 10/10"}]},S={title:"Ask for a house",body:"Tell us which house, your dates and your party. We reply personally with availability and a price. No card, no charge, nothing is booked yet.",properties:["Úlfljótsskáli — the lodge","Álftavík — the lakefront villa","Áslundur — the lake house","The Art Collector’s Apartment"],success:"Thank you. Your enquiry is with us and we answer personally, usually within a day."},ae={"@context":"https://schema.org","@graph":[{"@type":"Organization",name:"Iceland Luxury Lodges",url:"https://icelandluxurylodges.com",email:D,telephone:"+3548222202",address:{"@type":"PostalAddress",streetAddress:"Miðengi 17",postalCode:"800",addressLocality:"Selfoss",addressCountry:"IS"},sameAs:[G,B]},{"@type":"LodgingBusiness",name:"Úlfljótsskáli Luxury Lodge",description:"10-bedroom private lodge in the Golden Circle, sleeps 19, with sauna, gym, game room and large outdoor hot tub.",address:{"@type":"PostalAddress",addressLocality:"Úlfljótsvatn, 805 Selfoss",addressCountry:"IS"},parentOrganization:{"@type":"Organization",name:"Iceland Luxury Lodges"}},{"@type":"LodgingBusiness",name:"Álftavík Lakefront Villa",description:"170 m² lakefront villa on Álftavatn with infinity hot tub, panorama sauna and private black sand beach. Sleeps up to 12.",aggregateRating:{"@type":"AggregateRating",ratingValue:"4.94",reviewCount:"162",bestRating:"5"},address:{"@type":"PostalAddress",addressLocality:"Grímsnes- og Grafningshreppur",addressCountry:"IS"},parentOrganization:{"@type":"Organization",name:"Iceland Luxury Lodges"}},{"@type":"LodgingBusiness",name:"Áslundur Lake House",description:"4-bedroom lake house on Álftavatn with hot tub, fireplace and a sandy lakefront beach.",address:{"@type":"PostalAddress",addressLocality:"Grímsnes- og Grafningshreppur",addressCountry:"IS"},parentOrganization:{"@type":"Organization",name:"Iceland Luxury Lodges"}}]},M=X,H="#EFF3F5",re="#0E161D",le="#41607A",O="ill_seen";let L=null;const F=new Set;let I=0,y=!1;function Y(){if(I=0,!F.size)return;const a=window.innerHeight,m=[];F.forEach(o=>{const l=o.el.getBoundingClientRect(),h=l.bottom>-80&&l.top<a+80,p=(l.top+l.height/2-a/2)/(a/2+l.height/2);m.push({n:o,p,vis:h})});for(const{n:o,p:l,vis:h}of m){if(!h)continue;const p=o.kind==="refl"?1:-1;o.el.style.transform=`translate3d(0, ${(p*-l*o.d).toFixed(3)}%, 0)`}I=requestAnimationFrame(Y)}function V(a,m,o){if(!a||y)return()=>{};const l={el:a,d:m,kind:o};return F.add(l),I||(I=requestAnimationFrame(Y)),()=>{F.delete(l),a.style.transform=""}}function P({src:a,alt:m,drift:o=9,className:l="",priority:h=!1,videoSrc:p}){const f=r.useRef(null),[u,v]=r.useState(!1);r.useEffect(()=>V(f.current,o,"img"),[o]),r.useEffect(()=>{if(!p||y)return;const s=navigator.connection;s!=null&&s.saveData||v(!0)},[p]);const d=Math.max(9,o*1.35);return e.jsx("figure",{className:`ill-stage ${l}`,children:e.jsx("div",{className:"ill-stage-frame",style:{"--dz":`${d}%`},children:e.jsxs("div",{className:"ill-stage-in",ref:f,children:[e.jsx("img",{src:a,alt:m,loading:h?"eager":"lazy",decoding:"async"}),u&&e.jsx("video",{className:"ill-stage-film",src:p,poster:a,autoPlay:!0,muted:!0,loop:!0,playsInline:!0,"aria-hidden":"true"})]})})})}function oe({src:a,alt:m,drift:o=10,wide:l=!1}){const h=r.useRef(null);r.useEffect(()=>V(h.current,o,"img"),[o]);const p=Math.max(9,o*1.35);return e.jsx("figure",{className:`ill-frame ${l?"is-wide":""}`,style:{"--dz":`${p}%`},children:e.jsx("div",{className:"ill-stage-in",ref:h,children:e.jsx("img",{src:a,alt:m,loading:"lazy",decoding:"async"})})})}function ne(){const[a,m]=r.useState(0),[o,l]=r.useState(!1),[h,p]=r.useState(!1),f=b.quotes.length;r.useEffect(()=>{if(y||o)return;const d=window.setInterval(()=>m(s=>(s+1)%f),7e3);return()=>window.clearInterval(d)},[f,o]),r.useEffect(()=>{if(y)return;const d=navigator.connection;d!=null&&d.saveData||p(!0)},[]);const u=d=>{l(!0),m(s=>(s+d+f)%f)},v=b.quotes[a];return e.jsxs("section",{className:"ill-rev","aria-label":"Guest reviews",children:[e.jsxs("div",{className:"ill-rev-bed","aria-hidden":"true",children:[e.jsx("img",{src:N.auroraStill,alt:"",loading:"lazy",decoding:"async"}),h&&e.jsx("video",{className:"ill-rev-film",src:N.auroraFilm,poster:N.auroraStill,autoPlay:!0,muted:!0,loop:!0,playsInline:!0,"aria-hidden":"true"})]}),e.jsxs("div",{className:"ill-rev-inner",children:[e.jsx("span",{className:"ill-rev-ord","aria-hidden":"true",children:b.quotes.map((d,s)=>e.jsx("b",{className:s===a?"is-on":"",children:String(s+1).padStart(2,"0")},d.name))}),e.jsxs("p",{className:"ill-rev-badge",children:[e.jsx("span",{"aria-hidden":"true"}),b.score," · ",b.count," · verified on ",b.source]}),e.jsx("ul",{className:"ill-rev-list",children:b.quotes.map((d,s)=>e.jsx("li",{className:`ill-rev-q ${s===a?"is-on":""}`,"aria-hidden":s!==a,children:e.jsx("blockquote",{children:d.text.split(" ").flatMap((w,i,t)=>[e.jsx("span",{className:"ill-rev-w",children:e.jsx("i",{style:{transitionDelay:s===a?`${200+Math.min(i,26)*26}ms`:"0ms"},children:w})},`${w}-${i}`),...i<t.length-1?[" "]:[]])})},d.name))}),e.jsxs("div",{className:"ill-rev-foot",children:[e.jsxs("p",{className:"ill-rev-who",children:[e.jsx("i",{"aria-hidden":"true"}),v.name," · ",v.meta]}),e.jsxs("div",{className:"ill-rev-nav",children:[e.jsx("button",{type:"button","aria-label":"Previous review",onClick:()=>u(-1),children:e.jsx("svg",{viewBox:"0 0 16 16",width:"16",height:"16","aria-hidden":"true",children:e.jsx("path",{d:"M10 12L6 8l4-4",fill:"none",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",strokeLinejoin:"round"})})}),e.jsx("button",{type:"button","aria-label":"Next review",onClick:()=>u(1),children:e.jsx("svg",{viewBox:"0 0 16 16",width:"16",height:"16","aria-hidden":"true",children:e.jsx("path",{d:"M6 4l4 4-4 4",fill:"none",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",strokeLinejoin:"round"})})})]})]}),e.jsx("div",{className:"ill-rev-rail","aria-hidden":"true",children:b.quotes.map((d,s)=>e.jsx("span",{className:s===a?"is-on":""},d.name))}),e.jsx("p",{className:"ill-rev-note",children:b.sourceNote})]})]})}function x({as:a="div",className:m="",children:o}){return e.jsx(a,{className:`ill-rise ${m}`,children:e.jsx("span",{className:"ill-rise-in",children:o})})}function se({onDone:a}){const[m,o]=r.useState(0),l=r.useRef(!1);return r.useEffect(()=>{const h=performance.now();let p=0,f=0;const u=Array.from(document.images),v=Math.max(1,u.length);let d=u.filter(i=>i.complete).length;const s=()=>{d+=1};u.forEach(i=>{i.complete||(i.addEventListener("load",s),i.addEventListener("error",s))});const w=()=>{const i=performance.now()-h;f=Math.max(f,Math.min(1,d/v));const t=Math.min(1,i/1100),c=i/2400,g=Math.min(1,Math.max(c,Math.min(f,t)));if(o(Math.round(g*100)),g>=1&&!l.current){l.current=!0,window.setTimeout(()=>{a(),window.dispatchEvent(new CustomEvent("ill:revealed"))},240);return}p=requestAnimationFrame(w)};return p=requestAnimationFrame(w),()=>cancelAnimationFrame(p)},[a]),e.jsxs("div",{className:"ill-loader",role:"status","aria-label":"Loading",children:[e.jsxs("div",{className:"ill-loader-mark",style:{"--p":`${100-m}%`},children:[e.jsx("span",{children:"Iceland"}),e.jsx("span",{children:"Luxury Lodges"})]}),e.jsx("div",{className:"ill-loader-line","aria-hidden":"true"})]})}function de(){const[a,m]=r.useState(!1),o=l=>{l.preventDefault();const h=new FormData(l.currentTarget),p=Object.fromEntries(h.entries());try{const f="ill_demo_requests",u=JSON.parse(localStorage.getItem(f)||"[]");u.push({...p,at:new Date().toISOString()}),localStorage.setItem(f,JSON.stringify(u))}catch{}m(!0)};return a?e.jsxs("div",{className:"ill-book-done",role:"status",children:[e.jsx("div",{className:"ill-book-done-seam","aria-hidden":"true"}),e.jsx("p",{children:S.success})]}):e.jsxs("form",{className:"ill-book-form",onSubmit:o,children:[e.jsxs("div",{className:"ill-field",children:[e.jsx("label",{htmlFor:"ill-house",children:"House"}),e.jsx("select",{id:"ill-house",name:"house",required:!0,defaultValue:S.properties[0],children:S.properties.map(l=>e.jsx("option",{value:l,children:l},l))})]}),e.jsxs("div",{className:"ill-field-row",children:[e.jsxs("div",{className:"ill-field",children:[e.jsx("label",{htmlFor:"ill-in",children:"Arrival"}),e.jsx("input",{id:"ill-in",name:"arrival",type:"date",required:!0})]}),e.jsxs("div",{className:"ill-field",children:[e.jsx("label",{htmlFor:"ill-out",children:"Departure"}),e.jsx("input",{id:"ill-out",name:"departure",type:"date",required:!0})]}),e.jsxs("div",{className:"ill-field",children:[e.jsx("label",{htmlFor:"ill-guests",children:"Guests"}),e.jsx("input",{id:"ill-guests",name:"guests",type:"number",min:"1",max:"19",defaultValue:"4",required:!0})]})]}),e.jsxs("div",{className:"ill-field-row is-two",children:[e.jsxs("div",{className:"ill-field",children:[e.jsx("label",{htmlFor:"ill-name",children:"Name"}),e.jsx("input",{id:"ill-name",name:"name",type:"text",autoComplete:"name",required:!0})]}),e.jsxs("div",{className:"ill-field",children:[e.jsx("label",{htmlFor:"ill-email",children:"Email"}),e.jsx("input",{id:"ill-email",name:"email",type:"email",autoComplete:"email",required:!0})]})]}),e.jsx("button",{className:"ill-cta",type:"submit",children:"Send the enquiry"}),e.jsx("p",{className:"ill-book-note",children:"Demo prototype: the enquiry is stored only in this browser."})]})}function Ee(){const[a,m]=r.useState(!1),[o,l]=r.useState(!1),h=r.useRef(null),p=r.useRef(null),f=r.useRef(null),u=r.useRef(null),v=r.useRef(null);r.useEffect(()=>{const i=f.current,t=u.current,c=v.current,g=p.current;if(!i||!t||!c||!g)return;if(y){i.style.transform="scaleY(1)",t.style.clipPath="inset(0)",c.style.clipPath="inset(0)";return}i.style.transform="scaleY(0)",t.style.clipPath="inset(0% 0% 0% 100%)",c.style.clipPath="inset(0% 100% 0% 0%)";let E=!1;const A=()=>{i.style.transition="transform .85s cubic-bezier(.16,1,.3,1)",i.style.transform="scaleY(1)",window.setTimeout(()=>{for(const[k,j]of[[t,26],[c,-26]])k.style.transition="clip-path 1.5s cubic-bezier(.16,1,.3,1), transform 1.5s cubic-bezier(.16,1,.3,1)",k.style.transform=`translateX(${j}px)`,requestAnimationFrame(()=>{k.style.clipPath="inset(0% 0% 0% 0%)",k.style.transform="translateX(0px)"});window.setTimeout(()=>{E=!0,i.style.transition="",t.style.transition="",c.style.transition="",T()},1560)},430)};window.addEventListener("ill:revealed",A,{once:!0});let z=0;function T(){z||!E||(z=requestAnimationFrame(()=>{z=0;const k=g.getBoundingClientRect(),j=Math.min(1,Math.max(0,-k.top/Math.max(1,k.height)));t.style.transform=`translateX(${(-14*j).toFixed(2)}%)`,c.style.transform=`translateX(${(14*j).toFixed(2)}%)`,t.style.opacity=c.style.opacity=`${(1-j*.92).toFixed(3)}`,i.style.transform=`scaleY(${(1+j*2.4).toFixed(3)})`,i.style.opacity=`${(1-j).toFixed(3)}`}))}return window.addEventListener("scroll",T,{passive:!0}),()=>{window.removeEventListener("ill:revealed",A),window.removeEventListener("scroll",T),z&&cancelAnimationFrame(z)}},[]),r.useEffect(()=>{y=window.matchMedia("(prefers-reduced-motion: reduce)").matches,_(H),document.title="Iceland Luxury Lodges — Four private houses on the lakes of the Golden Circle";const i=new URLSearchParams(window.location.search).has("loader");let t=!1;try{t=sessionStorage.getItem(O)==="1"}catch{t=!0}if(!y&&(i||!t)){l(!0);try{sessionStorage.setItem(O,"1")}catch{}}else m(!0),window.setTimeout(()=>window.dispatchEvent(new CustomEvent("ill:revealed")),60)},[]),r.useEffect(()=>{if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const i=new W({lerp:.1,smoothWheel:!0});L=i;let t=requestAnimationFrame(function c(g){i.raf(g),t=requestAnimationFrame(c)});return()=>{cancelAnimationFrame(t),i.destroy(),L=null}},[]),r.useEffect(()=>{const i=h.current;if(!i)return;if(i.classList.add("js"),y){i.classList.add("reduced");return}const t=new IntersectionObserver(c=>c.forEach(g=>{g.isIntersecting&&(g.target.classList.add("is-on"),t.unobserve(g.target))}),{threshold:.22});return i.querySelectorAll(".ill-rise, .ill-rule, .ill-door, .ill-fact, .ill-amen li, .ill-frame").forEach(c=>t.observe(c)),()=>t.disconnect()},[a]),r.useEffect(()=>{const i=()=>{var t;return(t=h.current)==null?void 0:t.classList.add("is-revealed")};return window.addEventListener("ill:revealed",i),()=>window.removeEventListener("ill:revealed",i)},[]),r.useEffect(()=>{var g;const i=(g=h.current)==null?void 0:g.querySelector(".ill-nav"),t=p.current;if(!i||!t)return;const c=new IntersectionObserver(([E])=>i.classList.toggle("is-past",!E.isIntersecting),{rootMargin:"-72px 0px 0px 0px",threshold:0});return c.observe(t),()=>c.disconnect()},[]);const d=i=>t=>{t.preventDefault();const c=document.getElementById(i);c&&(L?L.scrollTo(c,{offset:-10}):c.scrollIntoView({behavior:y?"auto":"smooth",block:"start"}))},[s,w]=r.useState(!1);return e.jsxs("div",{className:"ill-root",ref:h,children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:ce}}),e.jsx("script",{type:"application/ld+json",dangerouslySetInnerHTML:{__html:JSON.stringify(ae)}}),o&&!a&&e.jsx(se,{onDone:()=>m(!0)}),e.jsxs("header",{className:"ill-nav",children:[e.jsxs("a",{className:"ill-nav-mark",href:"#top",onClick:d("top"),children:[e.jsx("span",{children:"Iceland"})," ",e.jsx("span",{children:"Luxury Lodges"})]}),e.jsx("nav",{className:"ill-nav-links","aria-label":"Sections",children:R.map(i=>e.jsx("a",{href:`#${i.id}`,onClick:d(i.id),children:i.label},i.id))}),e.jsxs("button",{className:`ill-burger ${s?"is-x":""}`,"aria-expanded":s,"aria-label":s?"Close menu":"Open menu",onClick:()=>w(i=>!i),children:[e.jsx("i",{}),e.jsx("i",{})]})]}),e.jsx("div",{className:`ill-sheet ${s?"is-open":""}`,"aria-hidden":!s,children:R.map((i,t)=>e.jsx("a",{href:`#${i.id}`,style:{transitionDelay:`${80+t*55}ms`},onClick:c=>{w(!1),d(i.id)(c)},children:i.label},i.id))}),e.jsxs("main",{id:"top",children:[e.jsxs("section",{className:"ill-hero",ref:p,children:[e.jsx(P,{src:N.heroEstate,videoSrc:"/iceland-redesigns/icelandluxurylodges/hero-film.mp4",alt:"The infinity pool on the terrace above the lake, mountains across the water",drift:7,className:"is-hero",priority:!0}),e.jsxs("h1",{className:"ill-wordmark","aria-label":q.word,children:[e.jsx("span",{className:"ill-wm-word ill-wm-l",ref:u,children:"Iceland"}),e.jsx("span",{className:"ill-wm-seam","aria-hidden":"true",ref:f}),e.jsx("span",{className:"ill-wm-word ill-wm-r",ref:v,children:"Luxury Lodges"})]}),e.jsx("p",{className:"ill-hero-sub",children:e.jsx("span",{className:"ill-hero-sub-in",children:q.sub})})]}),e.jsxs("section",{className:"ill-statement",children:[e.jsx(x,{as:"h2",className:"ill-statement-lead",children:C.lead}),e.jsx(x,{as:"p",className:"ill-statement-body",children:C.body})]}),e.jsx("section",{className:"ill-doors",id:"husin","aria-label":"The houses",children:ie.map((i,t)=>e.jsxs("a",{className:"ill-door",href:`#${i.id}`,onClick:d(i.id),style:{transitionDelay:`${t*90}ms`},children:[e.jsx("div",{className:"ill-door-media",children:e.jsx("img",{src:N[i.img],alt:i.alt,loading:"lazy",decoding:"async"})}),e.jsxs("div",{className:"ill-door-copy",children:[e.jsx("span",{className:"ill-door-kind",children:i.kind}),e.jsx("span",{className:"ill-door-name",children:i.name}),e.jsx("span",{className:"ill-door-sleeps",children:i.sleeps})]})]},i.id))}),te.map(i=>e.jsxs("section",{className:"ill-chapter",id:i.id,children:[e.jsxs("header",{className:"ill-chapter-head",children:[e.jsx("div",{className:"ill-chapter-ord","aria-hidden":"true",children:i.ord}),e.jsxs("div",{children:[e.jsx(x,{as:"h2",className:"ill-chapter-name",children:i.name}),e.jsx(x,{as:"p",className:"ill-chapter-water",children:i.water})]})]}),e.jsxs("div",{className:"ill-chapter-grid",children:[e.jsxs("div",{className:"ill-chapter-copy",children:[e.jsx(x,{as:"h3",className:"ill-chapter-lead",children:i.lead}),e.jsx(x,{as:"p",className:"ill-chapter-body",children:i.body}),e.jsx("div",{className:"ill-facts",role:"list",children:i.facts.map(t=>e.jsxs("div",{className:"ill-fact",role:"listitem",children:[e.jsx("span",{className:"ill-fact-n",children:t.n}),e.jsx("span",{className:"ill-fact-l",children:t.l})]},t.l))}),e.jsx("ul",{className:"ill-amen",children:i.amenities.map(t=>e.jsx("li",{children:t},t))}),i.chip&&e.jsxs("p",{className:"ill-chip",children:[e.jsx("strong",{children:i.chip.score}),e.jsx("span",{children:i.chip.source})]})]}),e.jsx("div",{className:"ill-chapter-photos",children:i.photos.map(t=>e.jsx(oe,{src:N[t.img],alt:t.alt,wide:t.wide,drift:t.wide?12:9},t.img))})]})]},i.id)),e.jsx("section",{className:"ill-fourth",children:e.jsxs("div",{className:"ill-fourth-card",children:[e.jsx("span",{className:"ill-fourth-rule","aria-hidden":"true"}),e.jsx(x,{as:"p",className:"ill-fourth-place",children:$.place}),e.jsx(x,{as:"h2",className:"ill-fourth-name",children:$.name}),e.jsx(x,{as:"p",className:"ill-fourth-body",children:$.body})]})}),e.jsx(ne,{}),e.jsxs("section",{className:"ill-book",id:"bokun",children:[e.jsxs("div",{className:"ill-book-copy",children:[e.jsx(x,{as:"h2",children:S.title}),e.jsx(x,{as:"p",children:S.body})]}),e.jsx(de,{})]}),e.jsxs("footer",{className:"ill-footer",children:[e.jsx(P,{src:N.lodgeExterior,alt:"Úlfljótsskáli at dusk",drift:6,className:"is-footer"}),e.jsxs("div",{className:"ill-footer-grid",children:[e.jsx("div",{className:"ill-footer-word","aria-hidden":"true",children:"Sjáumst við vatnið"}),e.jsxs("dl",{className:"ill-footer-dl",children:[e.jsxs("div",{children:[e.jsx("dt",{children:"Email"}),e.jsx("dd",{children:e.jsx("a",{href:U,children:D})})]}),e.jsxs("div",{children:[e.jsx("dt",{children:"Phone"}),e.jsx("dd",{children:e.jsx("a",{href:Z,children:Q})})]}),e.jsxs("div",{children:[e.jsx("dt",{children:"Address"}),e.jsx("dd",{children:ee})]}),e.jsxs("div",{children:[e.jsx("dt",{children:"Follow"}),e.jsxs("dd",{children:[e.jsx("a",{href:G,rel:"noreferrer",target:"_blank",children:"Instagram"})," · ",e.jsx("a",{href:B,rel:"noreferrer",target:"_blank",children:"Facebook"})]})]})]})]}),e.jsx(K,{company:M})]})]}),e.jsx(J,{company:M})]})}const ce=`
@font-face{font-family:'Gambarino';src:url('/iceland-redesigns/fonts/gambarino/Gambarino-Regular.woff2') format('woff2');font-weight:400;font-display:swap}
@font-face{font-family:'SwitzerIll';src:url('/iceland-redesigns/fonts/switzer/Switzer-Light.woff2') format('woff2');font-weight:300;font-display:swap}
@font-face{font-family:'SwitzerIll';src:url('/iceland-redesigns/fonts/switzer/Switzer-Regular.woff2') format('woff2');font-weight:400;font-display:swap}
@font-face{font-family:'SwitzerIll';src:url('/iceland-redesigns/fonts/switzer/Switzer-Medium.woff2') format('woff2');font-weight:500;font-display:swap}

.ill-root{
  --ice:${H}; --ink:${re}; --dusk:${le};
