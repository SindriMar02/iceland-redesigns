const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Grainient-DZ5Z7tlH.js","assets/index-hZNpox4W.js","assets/index-DyXeFLk8.css","assets/Triangle-GlFcswsc.js","assets/Grainient-BdwqdHbZ.css"])))=>i.map(i=>d[i]);
import{r as n,x as Pe,s as se,j as e,y as co,z as mo,B as b,C as M,D as po,G as fo,J as Te,Q as Ce,R as Le,U as ie,V as le,W as ho,X as Me,Y as _e,Z as Fe,$ as xo,a0 as go,_ as uo,a1 as ce,a2 as De}from"./index-hZNpox4W.js";import bo from"./lenis-niKyKZQP.js";import{D as wo,T as Ie,P as yo}from"./Dock-YwSutdoe.js";import{S as vo}from"./SndrBadge-C5wcfMcU.js";import{W as jo}from"./wine-CIu425Dh.js";import{C as ko}from"./cup-soda-BJlCSkG9.js";import{C as $o}from"./coffee-cw-SPi-4.js";import{U as No}from"./utensils-crossed-Cqsc8_Sh.js";import"./createLucideIcon-DD4odd3a.js";import"./react-GBKh5AAY.js";import"./use-spring-BKlzv9nA.js";const Eo=n.lazy(()=>uo(()=>import("./Grainient-DZ5Z7tlH.js"),__vite__mapDeps([0,1,2,3,4]))),zo={Pizzur:e.jsx(yo,{size:20,strokeWidth:1.8}),Meðlæti:e.jsx(No,{size:20,strokeWidth:1.8}),Álegg:e.jsx(Ie,{size:20,strokeWidth:1.8}),Kaffi:e.jsx($o,{size:20,strokeWidth:1.8}),Drykkir:e.jsx(ko,{size:20,strokeWidth:1.8}),Vín:e.jsx(jo,{size:20,strokeWidth:1.8})},L="/iceland-redesigns/",J="#F3EBD8",t="#1C1712",l="#FCF5E7",f="#C8371C",j="rgba(28,23,18,0.6)",Ro="#443C34",O=co,w="'Tanker-Regular', Georgia, serif",y="'Satoshi', system-ui, sans-serif";function p({children:k,className:S="",delay:$=0,y:A=26}){const N=n.useRef(null);return n.useEffect(()=>{const u=N.current;if(!u)return;const h=()=>{u.style.opacity="1",u.style.transform="none"},x=new IntersectionObserver(Q=>Q.forEach(Z=>{Z.isIntersecting&&(h(),x.disconnect())}),{threshold:.12,rootMargin:"0px 0px -6% 0px"});x.observe(u);const _=window.setTimeout(h,1600);return()=>{x.disconnect(),window.clearTimeout(_)}},[]),e.jsx("div",{ref:N,className:S,style:{opacity:0,transform:`translateY(${A}px)`,transition:`opacity 1.1s ease ${$}ms, transform 1.1s cubic-bezier(.16,.7,.2,1) ${$}ms`},children:k})}function q({children:k,href:S=M,active:$=!1,ext:A=!0,solid:N=!1}){const u=$||N;return e.jsx("a",{href:S,...A?{target:"_blank",rel:"noreferrer"}:{},className:"eo-pill",style:{background:u?Ro:"rgba(252,245,231,.9)",color:u?l:t,borderColor:t},children:k})}function Yo(){const k=n.useRef(null),S=n.useRef(null),$=n.useRef(null),A=n.useRef(null),N=n.useRef(null),u=n.useRef(null),[h,x]=n.useState(!1);n.useEffect(()=>{document.title="Eldofninn — Ítölsk eldbökuð pizza í Reykjavík"},[]),n.useEffect(()=>{if(!h)return;const r=a=>{a.key==="Escape"&&x(!1)};return window.addEventListener("keydown",r),()=>window.removeEventListener("keydown",r)},[h]);const _=n.useMemo(()=>["fonts","hero","bg","logo","grain"],[]),[Q,Z]=n.useState({}),[de,Oe]=n.useState(!1),ee=n.useCallback(r=>Z(a=>a[r]?a:{...a,[r]:!0}),[]),me=_.reduce((r,a)=>r+(Q[a]?1:0),0),P=de||me===_.length,Be=de?1:me/_.length;n.useEffect(()=>{let r=!0;const a=g=>{r&&ee(g)},s=(g,i)=>{const m=new Image;m.src=g,m.decode().catch(()=>{}).finally(()=>{i&&a(i)})};(document.fonts?document.fonts.ready:Promise.resolve()).then(()=>a("fonts")),s(b.whole,"hero"),s(b.ingredientsBg,"bg"),s(b.logoBadge,"logo"),Pe.forEach(g=>s(g.img)),s(b.slice);const d=window.setTimeout(()=>{r&&Oe(!0)},4500);return()=>{r=!1,window.clearTimeout(d)}},[ee]);const[Ue,Ye]=n.useState(!0);return n.useEffect(()=>{if(!P)return;const r=window.setTimeout(()=>Ye(!1),780);return()=>window.clearTimeout(r)},[P]),n.useEffect(()=>{var s;if(!P){se("#ffffff");return}se(O);const r=(s=k.current)==null?void 0:s.querySelector(".eo-frame");if(!r)return;const a=new IntersectionObserver(([d])=>se(d.isIntersecting?J:O),{rootMargin:"0px 0px -92% 0px"});return a.observe(r),()=>a.disconnect()},[P]),n.useEffect(()=>{const r=u.current;if(!r||window.matchMedia("(prefers-reduced-motion:reduce)").matches)return;const a=18,s={x:0,y:0},d={x:0,y:0},g=D=>{s.x=(D.clientX/window.innerWidth-.5)*2,s.y=(D.clientY/window.innerHeight-.5)*2};window.addEventListener("mousemove",g,{passive:!0});let i=0,m=!document.hidden;const E=()=>{d.x+=(s.x-d.x)*.05,d.y+=(s.y-d.y)*.05,r.style.transform=`translate3d(${(-d.x*a).toFixed(1)}px, ${(-d.y*a).toFixed(1)}px, 0)`,i=requestAnimationFrame(E)},T=()=>{m&&i===0&&(i=requestAnimationFrame(E))},F=()=>{i!==0&&(cancelAnimationFrame(i),i=0)},B=()=>{m=!document.hidden,m?T():F()};return document.addEventListener("visibilitychange",B),T(),()=>{F(),window.removeEventListener("mousemove",g),document.removeEventListener("visibilitychange",B)}},[]),n.useEffect(()=>{const r=k.current,a=S.current,s=$.current,d=A.current,g=N.current;if(!r||!a||!s||!d||!g)return;const i=r.style,m=o=>Math.min(1,Math.max(0,o)),E=(o,c,v)=>o+(c-o)*v,T=o=>o<.5?4*o*o*o:1-Math.pow(-2*o+2,3)/2,F=o=>1-Math.pow(1-o,3),B=window.matchMedia("(prefers-reduced-motion:reduce)").matches,D=.06,He=.52,pe=.12,We=.3,fe=.3,oe=.54,he=.56,Ke=.94,Ge=360,Ve=.1,Xe=.06;let xe=0,I=0,ge=0,ue=0,be=0,we=0;const U=()=>{xe=window.innerHeight||800,a.offsetTop,Math.max(1,a.offsetHeight-xe);const o=d.getBoundingClientRect(),c=s.getBoundingClientRect(),v=g.getBoundingClientRect();I=d.offsetWidth,ge=(o.left+o.right)/2-c.left,ue=(o.top+o.bottom)/2-c.top,be=v.left+v.width/2,we=v.top};U();const Y=o=>{const c=T(m((o-D)/(He-D)))*Ge,v=m((o-pe)/(We-pe)),oo=F(m((o-fe)/(oe-fe))),ro=m((o-oe)/(1-oe)),V=T(m((o-he)/(Ke-he))),ne=(oo*Ve+ro*Xe)*I;i.setProperty("--spin",c.toFixed(2)),i.setProperty("--cut",v.toFixed(3)),i.setProperty("--spread",ne.toFixed(1)+"px");const X=c*Math.PI/180,ze=ce.cx*I+De.ux*ne,Re=ce.cy*I+De.uy*ne,to=ge+(ze*Math.cos(X)-Re*Math.sin(X)),ao=ue+(ze*Math.sin(X)+Re*Math.cos(X)),no=ce.w*I,Se=56,so=Se/.689,io=we+14-so/2;i.setProperty("--slx",E(to,be,V).toFixed(1)+"px"),i.setProperty("--sly",E(ao,io,V).toFixed(1)+"px"),i.setProperty("--slw",E(no,Se,V).toFixed(1)+"px"),i.setProperty("--slr",E(c,-6,V).toFixed(1)+"deg");const Ae=.85,lo=T(m((o-Ae)/(.97-Ae)));i.setProperty("--armed",lo.toFixed(3))};if(B){a.style.height="100svh",Y(0);return}Y(0),i.setProperty("--seq","0.000");let H="idle";const ye=()=>{U()},W=new bo({duration:1.15,easing:o=>Math.min(1,1.001-Math.pow(2,-10*o)),smoothWheel:!0});let re=0;const ve=o=>{W.raf(o),re=requestAnimationFrame(ve)};re=requestAnimationFrame(ve);const je=3400;let K=0,C=0,G=0,z=1,te=0;const qe=300,Je=2.1,ke=6,Qe=o=>{const c=o-te;if(te=o,c<qe||z>=ke)return;const v=(o-C)*z;z=Math.min(ke,z*Je),C=o-v/z},$e=()=>{H!=="released"&&(H="released",window.removeEventListener("wheel",R),window.removeEventListener("touchmove",R),window.removeEventListener("keydown",ae),window.clearTimeout(G),a.style.height="100svh",Y(1),i.setProperty("--seq","1.000"),W.start())},Ne=o=>{C||(C=o);const c=F(m((o-C)*z/je));if(i.setProperty("--seq",c.toFixed(3)),Y(c),c<1){K=requestAnimationFrame(Ne);return}$e()},R=o=>{if(o.type!=="touchmove"&&o.cancelable&&o.preventDefault(),H!=="idle"){Qe(performance.now());return}U(),H="playing",C=0,z=1,te=performance.now(),K=requestAnimationFrame(Ne),window.clearTimeout(G),G=window.setTimeout($e,je*2)},Ze=new Set([" ","Spacebar","PageDown","PageUp","ArrowDown","ArrowUp","End","Home"]),eo=o=>{if(!(o instanceof HTMLElement))return!1;const c=o.tagName;return c==="INPUT"||c==="TEXTAREA"||c==="SELECT"||o.isContentEditable},ae=o=>{o.defaultPrevented||o.metaKey||o.ctrlKey||o.altKey||!Ze.has(o.key)||eo(o.target)||R(o)};W.stop(),window.addEventListener("wheel",R,{passive:!1}),window.addEventListener("touchmove",R,{passive:!0}),window.addEventListener("keydown",ae),window.addEventListener("resize",ye);let Ee=!1;return document.fonts.ready.then(()=>{Ee||U()}),()=>{Ee=!0,window.removeEventListener("wheel",R),window.removeEventListener("touchmove",R),window.removeEventListener("keydown",ae),window.removeEventListener("resize",ye),window.clearTimeout(G),K&&cancelAnimationFrame(K),cancelAnimationFrame(re),W.destroy()}},[]),e.jsxs("div",{ref:k,className:"eo-root","data-revealed":P?"":void 0,style:{background:J,color:t,fontFamily:y},children:[e.jsx("style",{children:So}),Ue&&e.jsx(mo,{visible:!P,progress:Be}),e.jsx("div",{className:"eo-bgwrap","aria-hidden":!0,children:e.jsx("img",{ref:u,src:b.ingredientsBg,alt:"",className:"eo-bgimg",draggable:!1})}),e.jsx("div",{ref:S,className:"eo-track",children:e.jsxs("div",{ref:$,className:"eo-stage-pin",children:[e.jsx(n.Suspense,{fallback:null,children:e.jsx(Eo,{className:"eo-grain-hero",color1:"#F6B663",color2:O,color3:"#C17D23",contrast:.9,saturation:.85,grainAmount:.05,grainScale:2.2,warpAmplitude:20,warpFrequency:3,timeSpeed:.08,zoom:1.1,maxDpr:1,fps:30,onReady:()=>ee("grain")})}),e.jsxs("header",{className:"eo-nav",children:[e.jsxs("div",{className:"eo-nav-grp",children:[e.jsx(q,{href:"#top",ext:!1,active:!0,children:"Heim"}),e.jsx(q,{href:"#sagan",ext:!1,children:"Um okkur"})]}),e.jsx("a",{href:"#top",className:"eo-badge",children:e.jsx("img",{src:b.logoBadge,alt:"Eldofninn"})}),e.jsxs("div",{className:"eo-nav-grp",children:[e.jsx(q,{href:"#matsedill",ext:!1,children:"Matseðill"}),e.jsx(q,{href:M,solid:!0,children:"Panta"})]}),e.jsx("button",{type:"button",className:"eo-burger","data-open":h,"aria-expanded":h,"aria-controls":"eo-mmenu","aria-label":h?"Loka valmynd":"Opna valmynd",onClick:()=>x(r=>!r),children:e.jsxs("span",{className:"eo-burger-lines",children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]})})]}),e.jsx("div",{className:"eo-mbackdrop","data-open":h,"aria-hidden":!0,onClick:()=>x(!1)}),e.jsxs("nav",{id:"eo-mmenu",className:"eo-mmenu","data-open":h,"aria-label":"Aðalvalmynd","aria-hidden":!h,children:[e.jsx("a",{href:"#top",onClick:()=>x(!1),children:"Heim"}),e.jsx("a",{href:"#sagan",onClick:()=>x(!1),children:"Um okkur"}),e.jsx("a",{href:"#matsedill",onClick:()=>x(!1),children:"Matseðill"}),e.jsx("a",{href:M,target:"_blank",rel:"noreferrer",className:"eo-mmenu-cta",onClick:()=>x(!1),children:"Panta núna"})]}),e.jsxs("div",{className:"eo-hero-mid",children:[e.jsx("div",{className:"eo-hero-word","aria-hidden":!0,children:"ELDOFNINN"}),e.jsxs("div",{className:"eo-hero-copy",children:[e.jsxs("h1",{className:"eo-h1",children:["Fáðu þér ",e.jsx("span",{className:"eo-sneid",children:"sneið"})]}),e.jsx("p",{className:"eo-lede",children:"Ítölsk eldbökuð pizza í Grímsbæ."}),e.jsxs("div",{className:"eo-claim",children:[e.jsx("span",{className:"eo-claim-star",children:"★"}),"Best geymda leyndarmál Reykjavíkur"]})]}),e.jsxs("div",{ref:A,className:"eo-pizza","aria-hidden":!0,children:[e.jsx("div",{className:"eo-glow"}),e.jsx("img",{src:b.whole,alt:"",className:"eo-layer eo-whole",draggable:!1}),Pe.filter(r=>!r.traveller).map(r=>e.jsx("img",{src:r.img,alt:"",className:"eo-layer eo-sl",draggable:!1,style:{"--ux":r.ux,"--uy":r.uy}},r.img))]})]}),e.jsxs("div",{className:"eo-scrollcue","aria-hidden":!0,children:[e.jsx("span",{children:"Skrunaðu"}),e.jsx("i",{})]})]})}),e.jsxs("div",{className:"eo-frame",children:[e.jsxs("section",{id:"matsedill",className:"eo-sec",children:[e.jsxs("div",{className:"eo-sec-head",children:[e.jsx(p,{children:e.jsx("h2",{className:"eo-h2",children:"Vinsælustu pizzurnar"})}),e.jsx(p,{delay:80,children:e.jsx("a",{href:M,target:"_blank",rel:"noreferrer",className:"eo-btn",children:"Allur matseðillinn"})})]}),e.jsx("div",{className:"eo-cards",children:po.map((r,a)=>e.jsx(p,{delay:a*60,children:e.jsxs("article",{className:"eo-card",children:[e.jsxs("div",{className:"eo-card-img",children:[e.jsx("img",{src:r.img,alt:r.name,loading:"lazy",width:520,height:390}),r.best&&e.jsx("span",{className:"eo-tag",children:"Best seller"})]}),e.jsxs("div",{className:"eo-card-body",children:[e.jsxs("div",{className:"eo-card-top",children:[e.jsx("h3",{children:r.name}),e.jsxs("span",{className:"eo-price",children:[r.price,e.jsx("em",{children:" kr"})]})]}),e.jsx("p",{children:r.desc})]})]})},r.name))}),e.jsx("div",{className:"eo-cat eo-dock-wrap",children:e.jsx(wo,{items:fo.map(r=>({icon:zo[r.label]??e.jsx(Ie,{size:20,strokeWidth:1.8}),label:r.label,onClick:()=>window.open(M,"_blank","noreferrer")})),magnification:62,distance:130,panelHeight:84,dockHeight:84,baseItemSize:44})})]}),e.jsx("section",{id:"sagan",className:"eo-sec eo-band",children:e.jsxs("div",{className:"eo-story",children:[e.jsx(p,{children:e.jsx("h2",{className:"eo-h2",children:Te.heading})}),e.jsx(p,{delay:70,children:e.jsx("p",{className:"eo-body",children:Te.body})}),e.jsx(p,{delay:130,children:e.jsxs("div",{className:"eo-award",children:[e.jsxs("span",{className:"eo-award-t",children:["★ ",Ce.title]}),e.jsx("span",{className:"eo-award-s",children:Ce.sub})]})})]})}),e.jsxs("section",{id:"kaffi",className:"eo-sec eo-truck",children:[e.jsxs("div",{className:"eo-truck-head",children:[e.jsx(p,{children:e.jsx("h2",{className:"eo-h2",style:{color:l},children:"Ítalskt kaffi"})}),e.jsx(p,{delay:70,children:e.jsx("p",{className:"eo-truck-lede",children:Le.intro})}),e.jsx(p,{delay:120,children:e.jsx("a",{href:`mailto:${ie}?subject=Fyrirspurn um kaffi`,className:"eo-btn eo-btn-cream",children:"Senda fyrirspurn"})})]}),e.jsx("div",{className:"eo-pkgs",children:Le.packages.map((r,a)=>e.jsx(p,{delay:a*70,children:e.jsxs("div",{className:"eo-pkg",children:[e.jsx("h3",{children:r.name}),e.jsx("p",{children:r.line}),r.rates.map(s=>e.jsxs("div",{className:"eo-rate",children:[e.jsxs("span",{children:[s.label," ",e.jsx("em",{children:s.sub})]}),e.jsxs("span",{className:"eo-rate-p",children:[s.price," kr"]})]},s.label))]})},r.name))})]}),e.jsx("section",{id:"stadur",className:"eo-sec",children:e.jsxs("div",{className:"eo-visit",children:[e.jsxs("div",{children:[e.jsx(p,{children:e.jsx("h2",{className:"eo-h2",children:le.street})}),e.jsx(p,{delay:60,children:e.jsxs("p",{className:"eo-body",style:{marginTop:".3rem"},children:[le.town,". ",ho.body]})}),e.jsx(p,{delay:120,children:e.jsxs("div",{className:"eo-visit-cta",children:[e.jsx("a",{href:Me,target:"_blank",rel:"noreferrer",className:"eo-btn",children:"Sjá á korti"}),e.jsx("a",{href:Fe,className:"eo-chip",children:_e})]})})]}),e.jsx(p,{delay:60,children:e.jsx("div",{className:"eo-hours",children:xo.map(r=>e.jsxs("div",{className:"eo-hour",children:[e.jsx("span",{children:r.day}),e.jsx("span",{children:r.time})]},r.day))})})]})}),e.jsxs("footer",{className:"eo-footer",children:[e.jsxs("div",{className:"eo-foot-top",children:[e.jsx("a",{href:"#top",className:"eo-badge eo-badge-sm",children:e.jsx("img",{src:b.logoBadge,alt:"Eldofninn"})}),e.jsxs("div",{className:"eo-foot-links",children:[e.jsx("a",{href:Me,target:"_blank",rel:"noreferrer",children:le.street}),e.jsx("a",{href:Fe,children:_e}),e.jsx("a",{href:`mailto:${ie}`,children:ie}),e.jsx("a",{href:go.instagram,target:"_blank",rel:"noreferrer",children:"Instagram"})]})]}),e.jsxs("div",{className:"eo-foot-bottom",children:[e.jsx("span",{children:"Frumgerð í hönnun, sýnishorn, ekki opinber vefur Eldofninn."}),e.jsx("span",{children:"Pantanir keyra á eldofninn.is"})]}),e.jsx("div",{className:"eo-foot-bottom",children:e.jsx(vo,{dark:!0})})]})]}),e.jsx("img",{src:b.slice,alt:"",className:"eo-slice",draggable:!1,"aria-hidden":!0}),e.jsxs("a",{ref:N,href:M,target:"_blank",rel:"noreferrer",className:"eo-sticky-panta","aria-label":"Panta núna",children:[e.jsx("span",{children:"Panta núna"}),e.jsx("img",{src:b.slice,alt:"",className:"eo-corner-slice",draggable:!1,"aria-hidden":!0})]})]})}const So=`
@font-face{font-family:'Tanker-Regular';font-weight:400;font-style:normal;font-display:swap;
  src:url('${L}fonts/tanker/fonts/Tanker-Regular.woff2') format('woff2'),
      url('${L}fonts/tanker/fonts/Tanker-Regular.woff') format('woff'),
      url('${L}fonts/tanker/fonts/Tanker-Regular.ttf') format('truetype')}
@font-face{font-family:'Satoshi';font-weight:400;font-style:normal;font-display:swap;
  src:url('${L}fonts/satoshi/Satoshi-Regular.woff2') format('woff2')}
@font-face{font-family:'Satoshi';font-weight:500;font-style:normal;font-display:swap;
  src:url('${L}fonts/satoshi/Satoshi-Medium.woff2') format('woff2')}
@font-face{font-family:'Satoshi';font-weight:700;font-style:normal;font-display:swap;
  src:url('${L}fonts/satoshi/Satoshi-Bold.woff2') format('woff2')}
...
.eo-frame{position:relative;z-index:1;max-width:min(1360px,90vw);margin:0 auto clamp(.9rem,2vw,1.6rem);background:${J};
...
.eo-card-img{position:relative;aspect-ratio:4/3;overflow:hidden;background:${J};flex:none}
