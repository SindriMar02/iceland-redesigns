import{r as $,s as Pe,j as e}from"./index-CYkigCbj.js";import{g as G}from"./index-CzGW6FVa.js";import{S as H}from"./ScrollTrigger-DNECHiyU.js";import Me from"./lenis-niKyKZQP.js";import{y as Fe,z as He,A as De,D as de,G as me,K as Re,N as We,O as ye,Q as fe,U as le,V as Ke,W as ne,X as Z,Y as Ve,Z as Be,_ as Ge,$ as Ye,a0 as Xe,a1 as qe,a2 as Je,a3 as Qe,g as Ze}from"./companies-DOEqWmuu.js";import{P as et}from"./PreviewChrome-C1Wtla8x.js";import{P as tt}from"./PreviewFooter-DvBOQJv0.js";import{A as W}from"./arrow-up-right-LVbFECkF.js";import{P as rt}from"./play-TgN08vDD.js";import"./data-C8ZDiw2z.js";import"./company-D-rC5gQU.js";import"./company-B3ttGpBR.js";import"./company-Dj0FZhSK.js";import"./company-CWG9yyz-.js";import"./outreach-sign-BcNtFClO.js";import"./company-gNW5QTrS.js";import"./copy-C7_1aP-a.js";import"./createLucideIcon-CfKWMQ9l.js";import"./proxy-CNAlm4EX.js";import"./index-Cr2_b_7w.js";import"./send-YXoEzB_j.js";import"./index-CFQYWTTj.js";import"./external-link-Bk1qr-DW.js";import"./x-DJVRURuk.js";import"./check-DMGq8Tgj.js";import"./mail-CYTNeLo2.js";import"./SndrBadge-BvAgYvFk.js";G.registerPlugin(H);const $e=Ze("listak"),X="#F0EFE8",N="#14140F",f="#C03E31",v="#A83428",y="rgba(20,20,15,0.64)",J="#F0EFE8",Y="rgba(240,239,232,0.66)",he="rgba(240,239,232,0.24)",Te="#1E7B34",a="'Familjen Grotesk Var', 'Familjen Grotesk', ui-sans-serif, system-ui, sans-serif",st="'Sentient', Georgia, 'Times New Roman', serif",ze="/iceland-redesigns/",U=t=>`${ze}listak/${t}`,M=`${ze}fonts/`,k="cubic-bezier(0.22, 1, 0.36, 1)",ee=()=>typeof window<"u"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,at=()=>typeof window<"u"&&window.matchMedia("(hover: hover) and (pointer: fine)").matches,lt=()=>!ee(),we=()=>lt()&&at();let pe=null,te=null;const re=new Set,se=new Set;let Q=0;const Se=new WeakMap,q=new Set;let ue=-1e5,xe=-1e5,ae=!1;function ie(t){ue=t.clientX,xe=t.clientY,ae=!0}function oe(){ae=!1}let ce=!1;function nt(){ce||!we()||(ce=!0,window.addEventListener("pointermove",ie,{passive:!0}),window.addEventListener("pointerdown",ie,{passive:!0}),document.addEventListener("pointerleave",oe),window.addEventListener("blur",oe))}function it(){!ce||q.size||(ce=!1,ae=!1,window.removeEventListener("pointermove",ie),window.removeEventListener("pointerdown",ie),document.removeEventListener("pointerleave",oe),window.removeEventListener("blur",oe))}function Ce(){const t=window.innerHeight,s=window.innerWidth,x=[];re.forEach(i=>{const r=i.parentElement;if(!r)return;const m=r.getBoundingClientRect();m.bottom<-240||m.top>t+240||x.push([i,(m.top+m.height/2-t/2)/(t/2+m.height/2),r])});const o=[];se.forEach(i=>{const r=i.getBoundingClientRect();r.right<-s*.6||r.left>s*1.6||o.push([i,(r.left+r.width/2-s/2)/(s/2+r.width/2)])});const d=[];q.forEach(i=>{const r=i.host.getBoundingClientRect();if(r.bottom<0||r.top>t){i.amp>.001&&d.push([i,r.left,r.top]);return}d.push([i,r.left,r.top])});for(let i=0;i<x.length;i++){const[r,m,w]=x[i],b=Number(r.dataset.drift)||9,l=w.dataset.lkHover==="1"?1:0,c=Se.get(r)??0,p=c+(l-c)*.09;Se.set(r,p);const g=-m*b*(1-.55*p);r.style.transform=`translate3d(0px, ${g.toFixed(3)}%, 0)`+(p>.001?` scale(${(1+.036*p).toFixed(4)})`:"")}for(let i=0;i<d.length;i++){const[r,m,w]=d[i];let b=1/0;if(ae)for(let p=0;p<r.ox.length;p++){const g=ue-(m+r.ox[p]),E=xe-(w+r.oy[p]),T=g*g+E*E;T<b&&(b=T)}const l=r.radius*1.15,c=ae&&b<=l*l;r.amp+=((c?1:0)-r.amp)*.12,r.amp<.002&&!c&&(r.amp=0);for(let p=0;p<r.letters.length;p++){let g=r.rest;if(r.amp>0){const T=ue-(m+r.ox[p]),S=xe-(w+r.oy[p]);let R=1-Math.sqrt(T*T+S*S)/r.radius;R=R<0?0:R>1?1:R,R=R*R*(3-2*R);const _=r.lo+(r.hi-r.lo)*R;g=r.rest+(_-r.rest)*r.amp}const E=Math.round(g/20)*20;if(r.last[p]!==E){r.last[p]=E;const T=`'wght' ${E}`;r.letters[p].style.fontVariationSettings=T,r.mirror&&(r.mirror[p].style.fontVariationSettings=T)}}}for(let i=0;i<o.length;i++){const[r,m]=o[i],w=Math.min(1,Math.abs(m)),b=Math.max(0,w-.28),l=Math.round(Math.min(6,b*9)*4)/4,c=(1-Math.min(.05,b*.083)).toFixed(4),p=`${l}|${c}`;r.dataset.lkDof!==p&&(r.dataset.lkDof=p,r.style.filter=l>0?`blur(${l}px)`:"",r.style.transform=`scale(${c})`)}Q=requestAnimationFrame(Ce)}function ve(){!Q&&(re.size||se.size||q.size)&&(Q=requestAnimationFrame(Ce))}function be(){!re.size&&!se.size&&!q.size&&Q&&(cancelAnimationFrame(Q),Q=0)}function ot(t){$.useEffect(()=>{if(ee())return;const s=t.current;if(s)return re.add(s),ve(),()=>{re.delete(s),be()}},[t])}function Oe(t,s){const x=$.useRef(s);x.current=s,$.useEffect(()=>{const o=t.current;if(!o||!we())return;let d=null,i=!1;const r=()=>{if(i)return;const c=x.current,p=(n,j)=>Array.from(o.querySelectorAll(j?`${j} ${n}`:n)),g=p(".lk-vf-ch",c.measureSel),E=c.mirrorSel?p(".lk-vf-ch",c.mirrorSel):[];if(!g.length)return;g.concat(E).forEach(n=>{n.style.fontVariationSettings=`'wght' ${c.rest}`,c.fixWidths&&(n.style.width="")});const S=c.pinSvgLines?p(".lk-vf-line",c.measureSel):[],z=c.pinSvgLines&&c.mirrorSel?p(".lk-vf-line",c.mirrorSel):[];S.concat(z).forEach(n=>{n.removeAttribute("textLength"),n.removeAttribute("lengthAdjust"),Array.from(n.children).forEach(j=>j.removeAttribute("x"))});const R=S.map(n=>{if(typeof n.getNumberOfChars!="function")return null;try{const j=n.getNumberOfChars(),O=[];for(let I=0;I<j;I++){const h=n.getStartPositionOfChar(I),F=n.getEndPositionOfChar(I);O.push((h.x+F.x)/2)}return O}catch{return null}}),_=S.map(n=>typeof n.getComputedTextLength=="function"?n.getComputedTextLength():0),C=o.getBoundingClientRect(),L=[],A=[],D=[];for(let n=0;n<g.length;n++){const j=g[n].getBoundingClientRect();L.push(j.left+j.width/2-C.left),A.push(j.top+j.height/2-C.top),D.push(j.width)}for(let n=0;n<S.length;n++){const j=R[n];if(j&&j.length){const O=I=>{let h=0;Array.from(I.children).forEach(F=>{const P=(F.textContent||"").length;F.classList.contains("lk-vf-ch")&&j[h]!==void 0&&F.setAttribute("x",j[h].toFixed(2)),h+=P})};O(S[n]),z[n]&&O(z[n])}else if(_[n]>0){const O=String(_[n]);S[n].setAttribute("textLength",O),S[n].setAttribute("lengthAdjust","spacing"),z[n]&&(z[n].setAttribute("textLength",O),z[n].setAttribute("lengthAdjust","spacing"))}}if(c.fixWidths)for(let n=0;n<g.length;n++)g[n].style.width=`${D[n].toFixed(2)}px`;d&&q.delete(d),d={host:o,letters:g,mirror:E.length===g.length?E:null,ox:L,oy:A,rest:c.rest,lo:c.lo,hi:c.hi,radius:Math.max(200,window.innerWidth*c.radiusVw),amp:0,last:g.map(()=>-1)},q.add(d),nt(),ve()};let m=0;const w=()=>{cancelAnimationFrame(m),m=requestAnimationFrame(r)};document.fonts&&document.fonts.ready?document.fonts.ready.then(w).catch(w):w();let b=0;const l=()=>{window.clearTimeout(b),b=window.setTimeout(r,180)};return window.addEventListener("resize",l),()=>{i=!0,cancelAnimationFrame(m),window.clearTimeout(b),window.removeEventListener("resize",l),d&&(d.letters.concat(d.mirror??[]).forEach(c=>{c.style.fontVariationSettings="",c.style.width=""}),q.delete(d),d=null),it(),be()}},[t])}function ge(t,s){if(s==="tspan")return Array.from(t).map((d,i)=>d===" "?e.jsx("tspan",{xmlSpace:"preserve",children:" "},i):e.jsx("tspan",{className:"lk-vf-ch",children:d},i));const x=t.split(" "),o=[];return x.forEach((d,i)=>{i>0&&o.push(e.jsx("span",{children:" "},`s${i}`)),o.push(e.jsx("span",{className:"lk-vf-w",children:Array.from(d).map((r,m)=>e.jsx("span",{className:"lk-vf-ch lk-vf-ch-dom",children:r},m))},`w${i}`))}),o}function ct(t){$.useEffect(()=>{const s=t.current;if(!s||!we())return;const x=s.querySelector(".lk-frame"),o=()=>{x&&(x.dataset.lkHover="1")},d=()=>{x&&(x.dataset.lkHover="0")};return s.addEventListener("pointerenter",o),s.addEventListener("pointerleave",d),s.addEventListener("focusin",o),s.addEventListener("focusout",d),()=>{s.removeEventListener("pointerenter",o),s.removeEventListener("pointerleave",d),s.removeEventListener("focusin",o),s.removeEventListener("focusout",d),x&&delete x.dataset.lkHover}},[t])}function je({src:t,srcSet:s,sizes:x,alt:o,drift:d=9,className:i="",style:r,eager:m=!1,w,h:b}){const l=$.useRef(null);return ot(l),e.jsx("div",{className:`lk-frame ${i}`,style:r,children:e.jsx("div",{ref:l,className:"lk-frame-in","data-drift":d,style:{"--dz":`${Math.max(9,d*1.35).toFixed(2)}%`},children:e.jsx("img",{src:t,srcSet:s,sizes:x,width:w,height:b,alt:o,loading:m?"eager":"lazy",decoding:"async",...m?{fetchpriority:"high"}:{}})})})}function dt(t=.18){const s=$.useRef(null),[x,o]=$.useState(!1);return $.useEffect(()=>{const d=s.current;if(!d)return;if(typeof IntersectionObserver>"u"){o(!0);return}const i=new IntersectionObserver(r=>{r.forEach(m=>{m.isIntersecting&&(o(!0),i.unobserve(m.target))})},{threshold:t,rootMargin:"0px 0px -8% 0px"});return i.observe(d),()=>i.disconnect()},[t]),{ref:s,inView:x}}function u({children:t,className:s="",delay:x=0,soft:o=!1}){const{ref:d,inView:i}=dt();return e.jsx("div",{ref:d,className:`${o?"lk-reveal-soft":"lk-reveal"} ${i?"is-in":""} ${s}`,style:i&&x?{animationDelay:`${x}ms`}:void 0,children:t})}const mt=`
  @font-face {
...
`,Ue="LISTASAFNIÐ",Ie="Á AKUREYRI";function Ee({mode:t}){const s=x=>e.jsxs(e.Fragment,{children:[e.jsx("text",{className:"lk-hero-type lk-vf-line",x:"50%",y:"36%",fill:x,children:ge(Ue,"tspan")}),e.jsx("text",{className:"lk-hero-type lk-vf-line",x:"50%",y:"36%",dy:"0.98em",fill:x,children:ge(Ie,"tspan")})]});return t==="solid"?e.jsx("svg",{"aria-hidden":"true",focusable:"false",children:s(N)}):e.jsxs("svg",{"aria-hidden":"true",focusable:"false",children:[e.jsx("defs",{children:e.jsxs("mask",{id:"lk-wordmark-cut",children:[e.jsx("rect",{width:"100%",height:"100%",fill:"#FFFFFF"}),s("#000000")]})}),e.jsx("rect",{width:"100%",height:"100%",fill:X,mask:"url(#lk-wordmark-cut)"})]})}const pt=[{id:"syningar",label:"Sýningarnar"},{id:"husid",label:"Húsið"},{id:"framundan",label:"Framundan"},{id:"fraedsla",label:"Fræðsla"},{id:"ketilhus",label:"Ketilhús"},{id:"um",label:"Um safnið"}];function ke(t){const s=document.getElementById(t);s&&(te?te.scrollTo(s,{offset:0,immediate:ee()}):s.scrollIntoView({behavior:ee()?"auto":"smooth",block:"start"}))}function ft(){return e.jsx("header",{className:"fixed inset-x-0 top-0 z-40",style:{background:"rgba(240,239,232,0.92)",backdropFilter:"blur(10px)",WebkitBackdropFilter:"blur(10px)",borderBottom:`1px solid ${f}`},children:e.jsxs("div",{className:"mx-auto flex h-16 max-w-[1440px] items-center justify-between px-5 md:px-8",children:[e.jsx("button",{onClick:()=>te?te.scrollTo(0,{}):window.scrollTo({top:0,behavior:ee()?"auto":"smooth"}),className:"lk-mark flex min-h-[44px] items-center","aria-label":"Listasafnið á Akureyri, efst á síðu",children:e.jsx("img",{src:U("logo.png"),alt:"Listasafnið á Akureyri",className:"h-6 w-auto md:h-7"})}),e.jsxs("nav",{"aria-label":"Aðalvalmynd",className:"hidden items-center gap-7 lg:flex",children:[pt.map(t=>e.jsx("button",{onClick:()=>ke(t.id),className:"lk-nav lk-eyebrow min-h-[44px]",style:{color:N},children:t.label},t.id)),e.jsx("a",{href:me,className:"lk-nav lk-eyebrow flex min-h-[44px] items-center",style:{color:v},children:de})]}),e.jsx("button",{onClick:()=>ke("syningar"),className:"lk-eyebrow flex min-h-[44px] items-center border px-4 lg:hidden",style:{borderColor:f,color:v,borderRadius:2},children:"Sýningarnar"})]})})}function ht({status:t}){const s=$.useRef(null);return Oe(s,{rest:700,lo:400,hi:700,radiusVw:.26,pinSvgLines:!0,measureSel:".lk-hero-solid",mirrorSel:".lk-hero-veil"}),e.jsxs("section",{ref:s,className:"lk-hero",id:"efst","aria-label":"Listasafnið á Akureyri",children:[e.jsx("h1",{className:"lk-sr",children:"Listasafnið á Akureyri"}),e.jsx("div",{className:"lk-hero-photo",children:e.jsx(je,{src:U("show-kristin.jpg"),w:2e3,h:1650,alt:"Kristín Gunnlaugsdóttir í vinnustofu sinni með málningarbakka",drift:13,className:"h-full",eager:!0})}),e.jsx("div",{className:"lk-hero-veil","aria-hidden":"true",children:e.jsx(Ee,{mode:"cut"})}),e.jsx("div",{className:"lk-hero-solid","aria-hidden":"true",children:e.jsx(Ee,{mode:"solid"})}),e.jsx("p",{className:"lk-hero-credit m-0",children:"Kristín Gunnlaugsdóttir í vinnustofu sinni"}),e.jsx("div",{className:"lk-hero-foot",children:e.jsxs("div",{className:"mx-auto flex max-w-[1440px] flex-col gap-4 px-0 md:px-3",children:[e.jsx("p",{className:"lk-eyebrow m-0",style:{color:v},children:"Listasafnið á Akureyri · Kaupvangsstræti 8"}),e.jsxs("div",{className:"flex flex-wrap items-center gap-x-6 gap-y-3",children:[e.jsx("p",{className:"m-0 flex items-center gap-2.5 text-[16px]",style:{fontFamily:a,color:N},"aria-live":"polite",children:t?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"lk-dot","aria-hidden":"true",style:{background:t.open?Te:v}}),t.closedDay?"Lokað í dag":t.open?`Opið núna · í dag ${t.hoursLabel}`:`Lokað núna · opið í dag ${t.hoursLabel}`]}):e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"lk-dot","aria-hidden":"true",style:{background:y}}),"Opið alla daga"]})}),e.jsxs("button",{onClick:()=>ke("syningar"),className:"lk-btn lk-btn-ghost",children:["Sýningarnar",e.jsx(W,{size:15,"aria-hidden":!0})]})]}),e.jsxs("p",{className:"m-0 max-w-xl text-[16px] leading-relaxed",style:{fontFamily:a,color:y},children:[Re," Níu sýningar í tólf sölum, undir einu þaki."]})]})})]})}function ut({status:t}){return e.jsxs("section",{id:"stada",className:"mx-auto max-w-[1440px] px-5 py-16 md:px-8 md:py-20","aria-label":"Staðan í dag",children:[e.jsx(u,{children:e.jsx("p",{className:"lk-eyebrow m-0",style:{color:v},children:"Staðan í dag"})}),e.jsxs("div",{className:"mt-6 grid grid-cols-1 gap-5 md:grid-cols-3",children:[e.jsx(u,{className:"h-full",children:e.jsxs("div",{className:"flex h-full flex-col gap-3 p-6",style:{border:`1px solid ${f}`},children:[e.jsx("h2",{className:"m-0 text-[19px] font-semibold uppercase tracking-[-0.01em]",style:{fontFamily:a},children:"Opið í dag"}),e.jsx("p",{className:"m-0 flex items-center gap-2.5 text-[16px]",style:{fontFamily:a,color:N},children:t?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"lk-dot","aria-hidden":"true",style:{background:t.open?Te:v}}),t.closedDay?"Lokað í dag":`${t.hoursLabel}${t.open?" · opið núna":""}`]}):"Opið alla daga"}),e.jsx("p",{className:"m-0 text-[14px] leading-relaxed",style:{fontFamily:a,color:y},children:"Sumar 10:00–17:00 · vetur 12:00–17:00, alla daga. Lokað 24., 25. og 31. desember og 1. janúar."})]})}),e.jsx(u,{delay:80,className:"h-full",children:e.jsxs("div",{className:"flex h-full flex-col gap-3 p-6",style:{border:`1px solid ${f}`},children:[e.jsx("h2",{className:"m-0 text-[19px] font-semibold uppercase tracking-[-0.01em]",style:{fontFamily:a},children:"Aðgangur"}),e.jsx("dl",{className:"m-0 flex flex-col gap-1.5",children:We.map(s=>e.jsxs("div",{className:"flex items-baseline justify-between gap-4",children:[e.jsx("dt",{className:"text-[14px]",style:{fontFamily:a,color:y},children:s.label}),e.jsx("dd",{className:"m-0 whitespace-nowrap text-[14px] font-medium",style:{fontFamily:a,color:N},children:s.value})]},s.label))})]})}),e.jsx(u,{delay:160,className:"h-full",children:e.jsxs("div",{className:"flex h-full flex-col gap-3 p-6",style:{border:`1px solid ${f}`},children:[e.jsx("h2",{className:"m-0 text-[19px] font-semibold uppercase tracking-[-0.01em]",style:{fontFamily:a},children:"Ketilkaffi"}),e.jsx("p",{className:"m-0 text-[15px] leading-relaxed",style:{fontFamily:a,color:N},children:"Kaffihús í Ketilhúsi, opið alla daga 08:00–17:00."}),e.jsxs("p",{className:"m-0 mt-auto text-[14px] leading-relaxed",style:{fontFamily:a,color:y},children:[ye," ·"," ",e.jsx("a",{href:me,className:"inline-flex min-h-[44px] items-center",style:{color:v},children:de})]})]})})]})]})}function xt({show:t}){return e.jsxs("div",{className:"flex flex-wrap items-center gap-2.5",children:[e.jsx("span",{className:"lk-chip lk-chip-accent",children:t.chip}),t.dates?e.jsx("span",{className:"lk-chip lk-chip-ink",children:t.dates}):null]})}function gt(t){return{"--lk-pw":`${Math.round(t.natW*.8)}px`,"--lk-ar":String(+(t.natW/t.natH).toFixed(4))}}function kt({show:t,index:s}){const x=$.useRef(null);ct(x);const o=String(s+1).padStart(2,"0"),d=t.plate==="full"?t.layout==="wide"?"lk-stop-wide":"lk-stop-std":t.plate==="mini"?"lk-stop-plate":"lk-stop-small",i=t.natW/t.natH;return e.jsx("article",{ref:x,"data-stop":t.key,className:`lk-stop lk-stop-hov ${d} px-5 py-10`,tabIndex:0,"aria-label":`Sýning ${o} af 09: ${t.title}${t.artist&&t.artist!==t.title?`, ${t.artist}`:""}, ${t.chip}`,children:e.jsxs("div",{className:"lk-stop-core",children:[e.jsx(u,{soft:!0,children:e.jsx("div",{className:"flex items-baseline justify-between gap-4",children:e.jsx(xt,{show:t})})}),t.plate==="mini"?e.jsxs(e.Fragment,{children:[e.jsx(u,{children:e.jsx("h3",{className:"m-0 mt-4 max-w-[16em] uppercase",style:{fontFamily:a,fontWeight:600,letterSpacing:"-0.015em",fontSize:"clamp(1.7rem, 5vw, 4.6rem)",lineHeight:1.02,paddingBottom:"0.12em"},children:t.title})}),e.jsxs(u,{delay:60,children:[e.jsx("p",{className:"lk-stop-artist m-0 text-[16px] font-medium",style:{fontFamily:a,color:N},children:t.artist}),e.jsx("p",{className:"lk-stop-artist m-0 mt-1 text-[15px]",style:{fontFamily:a,color:y},children:t.fact})]}),e.jsx(u,{delay:110,children:e.jsxs("figure",{className:"m-0 mt-4 flex items-end gap-4",children:[e.jsx("div",{className:"p-2",style:{border:`1px solid ${f}`,width:`min(${t.natW}px, 56vw)`},children:e.jsx("img",{src:U(t.img),width:t.natW,height:t.natH,alt:t.alt,loading:"lazy",decoding:"async",className:"block h-auto w-full"})}),e.jsx("figcaption",{className:"pb-1 text-[12px] uppercase tracking-[0.14em]",style:{fontFamily:a,color:y},children:"Verk á sýningunni"})]})})]}):t.plate==="small"?e.jsxs(e.Fragment,{children:[e.jsx(u,{children:e.jsx("h3",{className:"m-0 mt-3 max-w-[13em] uppercase",style:{fontFamily:a,fontWeight:600,letterSpacing:"-0.015em",fontSize:"clamp(1.5rem, 3vw, 2.9rem)",lineHeight:1.04,paddingBottom:"0.12em"},children:t.title})}),e.jsx(u,{delay:70,children:e.jsxs("div",{className:"lk-labelgrid mt-3",children:[e.jsxs("div",{className:"lk-labelcol",children:[e.jsx("div",{className:"lk-rule-draw lk-labelrule","aria-hidden":"true"}),t.artist&&t.artist!==t.title?e.jsx("p",{className:"lk-stop-artist m-0 text-[16px] font-medium",style:{fontFamily:a,color:N},children:t.artist}):null,e.jsx("p",{className:"lk-stop-artist m-0 text-[15px] leading-relaxed",style:{fontFamily:a,color:y},children:t.fact}),t.datesNote?e.jsx("p",{className:"m-0 text-[14px] leading-relaxed",style:{fontFamily:a,color:y},children:t.datesNote}):null]}),e.jsxs("figure",{className:"lk-platefig",children:[e.jsx("div",{className:"lk-plate",style:gt(t),children:e.jsx("img",{src:U(t.img),width:t.natW,height:t.natH,alt:t.alt,loading:"lazy",decoding:"async"})}),e.jsxs("figcaption",{className:"lk-platecap",children:["Verk úr sýningunni · ",t.chip]})]})]})})]}):e.jsxs(e.Fragment,{children:[e.jsx(u,{children:e.jsx(je,{src:U(t.img),w:t.natW,h:t.natH,srcSet:t.img800?`${U(t.img800)} 800w, ${U(t.img)} ${t.natW}w`:void 0,sizes:t.img800?t.layout==="wide"?"(min-width: 1024px) 88vw, 100vw":"(min-width: 1024px) 56vw, 100vw":void 0,alt:t.alt,drift:9,className:"lk-stop-frame",style:{aspectRatio:String(i),"--lk-fh":`${Math.floor(t.natW/(1.42*i))}px`,"--lk-fw":`${t.natW}px`}})}),e.jsx(u,{delay:60,children:e.jsx("h3",{className:"m-0 mt-2 uppercase",style:{fontFamily:a,fontWeight:600,letterSpacing:"-0.015em",fontSize:"clamp(1.6rem, 5vw, 4.2rem)",lineHeight:1.02,paddingBottom:"0.12em"},children:t.title})}),e.jsx(u,{delay:100,children:e.jsxs("p",{className:"lk-stop-artist m-0 text-[16px]",style:{fontFamily:a,color:y},children:[t.artist&&t.artist!==t.title?e.jsxs("span",{className:"font-medium",style:{color:N},children:[t.artist," · "]}):null,t.fact,t.datesNote?e.jsxs("span",{children:[" · ",t.datesNote]}):null]})})]})]})})}function yt(){return e.jsxs("section",{id:"syningar",className:"lk-journey","aria-label":"Sýningargangurinn, níu sýningar í gangi",children:[e.jsxs("div",{className:"lk-track",children:[e.jsx("div",{className:"lk-stop lk-stop-intro px-5 py-16",children:e.jsxs("div",{className:"lk-stop-core md:pl-[6vw]",children:[e.jsx(u,{children:e.jsx("p",{className:"lk-eyebrow m-0",style:{color:v},children:"Sýningargangurinn"})}),e.jsx(u,{delay:70,children:e.jsx("h2",{className:"m-0 mt-3 uppercase",style:{fontFamily:a,fontWeight:600,letterSpacing:"-0.015em",fontSize:"clamp(2rem, 5.4vw, 5rem)",lineHeight:1,paddingBottom:"0.12em"},children:"Níu sýningar, tólf salir"})}),e.jsx(u,{delay:130,children:e.jsxs("p",{className:"m-0 mt-2 max-w-md text-[16px] leading-relaxed",style:{fontFamily:a,color:y},children:[Re," Gengið er í salaröð, frá Sal 01 að Sal 12."]})}),e.jsx(u,{delay:180,children:e.jsx("p",{className:"lk-eyebrow lk-hint m-0 mt-2",style:{color:y},children:"Skrunaðu · gangurinn liggur til hægri"})})]})}),fe.map((t,s)=>e.jsx(kt,{show:t,index:s},t.key)),e.jsx("div",{className:"lk-track-tail","aria-hidden":"true"})]}),e.jsxs("div",{className:"lk-hud","aria-hidden":"true",children:[e.jsx("div",{className:"lk-hud-rail",children:e.jsx("div",{className:"lk-hud-fill"})}),e.jsx("span",{className:"lk-eyebrow lk-hud-count",style:{color:N},children:"01/09"})]})]})}function wt(){var b;const[t,s]=$.useState(null),x=$.useRef(null);Oe(x,{rest:600,lo:420,hi:700,radiusVw:.16,fixWidths:!0});const o=l=>l?fe.find(c=>c.key===l)??null:null,d=t?((b=le.find(l=>l.id===t))==null?void 0:b.showKey)??null:null,i=l=>le.filter(c=>c.showKey===l).map(c=>c.id),r=l=>s(l),m=(l,c)=>{l.pointerType==="mouse"&&s(c)},w=l=>s(l||null);return e.jsxs("section",{id:"husid",className:"mx-auto max-w-[1440px] px-5 py-16 md:px-8 md:py-24","aria-label":"Húsið, hvaða sýning er í hvaða sal",children:[e.jsx(u,{children:e.jsx("p",{className:"lk-eyebrow m-0",style:{color:v},children:"Húsið"})}),e.jsx(u,{delay:60,children:e.jsx("h2",{ref:x,className:"m-0 mt-3 uppercase",style:{fontFamily:a,fontWeight:600,letterSpacing:"-0.015em",fontSize:"clamp(1.8rem, 4vw, 3.4rem)",lineHeight:1.02,paddingBottom:"0.12em"},children:ge("Hvaða sýning er í hvaða sal","span")})}),e.jsx(u,{delay:110,children:e.jsx("p",{className:"m-0 mt-3 max-w-[42em] text-[16px] leading-relaxed",style:{fontFamily:a,color:y},children:"Níu sýningar standa yfir í tólf sölum. Veldu sal eða sýningu, þá lýsist hitt upp á móti."})}),e.jsxs("div",{className:"mt-9 grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-12",children:[e.jsxs(u,{delay:60,children:[e.jsx("h3",{className:"lk-eyebrow m-0",style:{color:y},children:"Salirnir tólf · skýringarmynd"}),e.jsx("div",{className:"lk-halls mt-3",role:"group","aria-label":"Salir safnsins",children:le.map(l=>{const c=o(l.showKey),p=l.id===t||d!==null&&l.showKey===d;return e.jsxs("button",{type:"button",className:`lk-hall ${p?"is-lit":""}`,"aria-pressed":p,onPointerEnter:g=>m(g,l.id),onPointerLeave:g=>m(g,null),onFocus:()=>r(l.id),onBlur:()=>r(null),onClick:()=>w(l.id),children:[e.jsxs("span",{className:"lk-hall-n",children:["Salur ",l.id]}),e.jsx("span",{className:"lk-hall-t",children:c?c.title:Ke})]},l.id)})}),e.jsx("p",{className:"m-0 mt-3 text-[13px] leading-relaxed",style:{fontFamily:a,color:y},children:"Skýringarmyndin sýnir röð salanna, ekki lögun hússins eða stærð þeirra."})]}),e.jsxs(u,{delay:120,children:[e.jsx("h3",{className:"lk-eyebrow m-0",style:{color:y},children:"Sýningarnar níu"}),e.jsx("div",{className:"mt-3",children:fe.map(l=>{const c=i(l.key),p=d===l.key;return e.jsxs("button",{type:"button",className:`lk-showrow ${p?"is-lit":""}`,"aria-pressed":p,onPointerEnter:g=>m(g,c[0]??null),onPointerLeave:g=>m(g,null),onFocus:()=>r(c[0]??null),onBlur:()=>r(null),onClick:()=>w(c[0]??""),children:[e.jsxs("span",{className:"flex flex-col gap-1",children:[e.jsx("span",{className:"text-[16px] font-medium uppercase tracking-[-0.01em] md:text-[18px]",style:{fontFamily:a},children:l.title}),e.jsx("span",{className:"text-[13px]",style:{fontFamily:a,color:y},children:l.artist&&l.artist!==l.title?l.artist:l.fact})]}),e.jsx("span",{className:"lk-showrow-halls",children:l.chip})]},l.key)})})]})]}),e.jsx(u,{delay:80,children:e.jsxs("figure",{className:"m-0 mt-12 grid grid-cols-1 gap-6 lg:grid-cols-[minmax(0,1.35fr)_minmax(0,1fr)] lg:items-start lg:gap-12",children:[e.jsxs("div",{className:"lk-plan",children:[e.jsx("img",{src:U(ne.src),width:ne.w,height:ne.h,loading:"lazy",decoding:"async",alt:"Grunnteikning Listasafnsins á Akureyri. Á teikningunni eru salir 01 til 05 tölusettir með rauðu."}),ne.marks.map(l=>{var p;const c=l.id===t||d!==null&&((p=le.find(g=>g.id===l.id))==null?void 0:p.showKey)===d;return e.jsx("span",{className:`lk-planpin ${c?"is-lit":""}`,style:{left:`${l.x}%`,top:`${l.y}%`},"aria-hidden":"true",children:l.id},l.id)})]}),e.jsxs("figcaption",{className:"flex flex-col gap-4",children:[e.jsx("p",{className:"lk-eyebrow m-0",style:{color:v},children:"Grunnteikning"}),e.jsx("p",{className:"m-0 text-[15px] leading-relaxed",style:{fontFamily:a,color:N},children:"Safnið birtir sjálft grunnteikningar af húsinu. Þetta er teikning þeirra, óbreytt."}),e.jsx("p",{className:"m-0 text-[14px] leading-relaxed",style:{fontFamily:a,color:y},children:"Á þessari teikningu eru fimm salir tölusettir, salir 01 til 05, og hringirnir sitja á þeim tölum. Salir 06 til 12 eru ekki á þessu blaði og eru því ekki merktir hér."}),e.jsxs("a",{href:Z,target:"_blank",rel:"noreferrer",className:"lk-row",style:{borderTop:`1px solid ${f}`,borderBottom:"none"},children:[e.jsx("span",{className:"text-[15px] font-medium uppercase tracking-[-0.01em]",style:{fontFamily:a},children:"Grunnteikningar á listak.is"}),e.jsx(W,{size:16,className:"lk-row-arrow","aria-hidden":!0})]})]})]})})]})}function vt(){return e.jsxs("section",{id:"framundan",className:"mx-auto max-w-[1440px] px-5 py-16 md:px-8 md:py-24","aria-label":"Framundan",children:[e.jsx(u,{children:e.jsx("p",{className:"lk-eyebrow m-0",style:{color:v},children:"Framundan"})}),e.jsx(u,{delay:60,children:e.jsx("h2",{className:"m-0 mt-3 uppercase",style:{fontFamily:a,fontWeight:600,letterSpacing:"-0.015em",fontSize:"clamp(1.8rem, 4vw, 3.4rem)",lineHeight:1.02,paddingBottom:"0.12em"},children:"Á dagskrá safnsins"})}),e.jsxs("div",{className:"mt-8",children:[Ve.map((t,s)=>e.jsxs(u,{soft:!0,delay:s*40,children:[e.jsx("div",{className:"lk-rule-draw h-px w-full",style:{background:f},"aria-hidden":"true"}),e.jsxs("a",{href:Z,target:"_blank",rel:"noreferrer",className:"lk-row",style:{borderBottom:"none"},children:[e.jsxs("span",{className:"flex items-baseline gap-5",children:[e.jsx("span",{className:"lk-eyebrow",style:{color:y},"aria-hidden":"true",children:String(s+1).padStart(2,"0")}),e.jsx("span",{className:"text-[17px] font-medium uppercase tracking-[-0.01em] md:text-[20px]",style:{fontFamily:a},children:t})]}),e.jsx(W,{size:17,className:"lk-row-arrow","aria-hidden":!0})]})]},t)),e.jsx(u,{soft:!0,children:e.jsx("div",{className:"lk-rule-draw h-px w-full",style:{background:f},"aria-hidden":"true"})})]}),e.jsx(u,{delay:80,children:e.jsx("p",{className:"m-0 mt-5 text-[14px]",style:{fontFamily:a,color:y},children:"Dagsetningar birtast á listak.is þegar nær dregur."})})]})}function bt(){return e.jsxs("section",{id:"fraedsla",className:"mx-auto max-w-[1440px] px-5 py-16 md:px-8 md:py-24","aria-label":"Fræðsla og fyrirlestrar",children:[e.jsx(u,{children:e.jsx("p",{className:"lk-eyebrow m-0",style:{color:v},children:"Fræðsla og fyrirlestrar"})}),e.jsx("div",{className:"mt-6 grid grid-cols-1 gap-5 md:grid-cols-3",children:Be.map((t,s)=>e.jsx(u,{delay:s*80,className:"h-full",children:e.jsxs("a",{href:Z,target:"_blank",rel:"noreferrer",className:"lk-card flex h-full flex-col gap-3 p-6 no-underline",style:{border:`1px solid ${f}`,color:N},children:[e.jsx("h3",{className:"m-0 text-[19px] font-semibold uppercase tracking-[-0.01em]",style:{fontFamily:a},children:t.title}),e.jsx("p",{className:"m-0 text-[15px]",style:{fontFamily:a,color:y},children:t.line}),e.jsxs("span",{className:"lk-eyebrow mt-auto flex items-center gap-2",style:{color:v},children:["Nánar á listak.is",e.jsx(W,{size:14,className:"lk-row-arrow","aria-hidden":!0})]})]})},t.title))})]})}function jt(){return e.jsx("section",{id:"ketilhus",className:"mx-auto max-w-[1440px] px-5 py-16 md:px-8 md:py-24","aria-label":"Ketilhús og Ketilkaffi",children:e.jsxs("div",{className:"grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16",children:[e.jsxs("div",{children:[e.jsx(u,{children:e.jsx("p",{className:"lk-eyebrow m-0",style:{color:v},children:"Í húsinu"})}),e.jsx(u,{delay:60,children:e.jsx("h2",{className:"m-0 mt-3 uppercase",style:{fontFamily:a,fontWeight:600,letterSpacing:"-0.015em",fontSize:"clamp(1.8rem, 4vw, 3.4rem)",lineHeight:1.02,paddingBottom:"0.12em"},children:"Ketilhús og Ketilkaffi"})}),e.jsx(u,{delay:120,children:e.jsxs("div",{className:"mt-6 flex flex-col",children:[e.jsxs("div",{className:"py-4",style:{borderTop:`1px solid ${f}`},children:[e.jsx("h3",{className:"m-0 text-[17px] font-semibold uppercase tracking-[-0.01em]",style:{fontFamily:a},children:"Ketilhús"}),e.jsx("p",{className:"m-0 mt-1.5 text-[15px] leading-relaxed",style:{fontFamily:a,color:y},children:"Viðburðahús safnsins: sýningarrými og útleiga fyrir viðburði."})]}),e.jsxs("div",{className:"py-4",style:{borderTop:`1px solid ${f}`},children:[e.jsx("h3",{className:"m-0 text-[17px] font-semibold uppercase tracking-[-0.01em]",style:{fontFamily:a},children:"Ketilkaffi"}),e.jsx("p",{className:"m-0 mt-1.5 text-[15px] leading-relaxed",style:{fontFamily:a,color:y},children:"Kaffihús í Ketilhúsi, opið alla daga 08:00–17:00."})]}),e.jsxs("div",{className:"py-4",style:{borderTop:`1px solid ${f}`,borderBottom:`1px solid ${f}`},children:[e.jsx("h3",{className:"m-0 text-[17px] font-semibold uppercase tracking-[-0.01em]",style:{fontFamily:a},children:"Safnbúðin"}),e.jsx("p",{className:"m-0 mt-1.5 text-[15px] leading-relaxed",style:{fontFamily:a,color:y},children:"Safnbúð með völdum vörum, sjá myndina hér til hliðar."})]}),e.jsxs("p",{className:"m-0 mt-4 text-[14px]",style:{fontFamily:a,color:y},children:[ye," · ",e.jsx("a",{href:me,className:"inline-flex min-h-[44px] items-center",style:{color:v},children:de})]})]})})]}),e.jsx(u,{delay:100,children:e.jsxs("figure",{className:"m-0",children:[e.jsx(je,{src:U("samsett-mynd-1400.jpg"),w:1400,h:736,srcSet:`${U("samsett-mynd-800.jpg")} 800w, ${U("samsett-mynd-1400.jpg")} 1400w`,sizes:"(min-width: 1024px) 82vw, 100vw",alt:"Samsett mynd úr safnbúð Listasafnsins á Akureyri: vörur og varningur búðarinnar",drift:9,className:"aspect-[4/3]"}),e.jsx("figcaption",{className:"mt-2.5 text-[12px] uppercase tracking-[0.14em]",style:{fontFamily:a,color:y},children:"Safnbúðin"})]})})]})})}const Le="CXHdAGkYNIQ",Ae="Að norðan: Listasafnið á Akureyri — N4";function Nt(){const[t,s]=$.useState(!1);return t?e.jsx("div",{className:"lk-video-frame",style:{aspectRatio:"16/9",background:"#000"},children:e.jsx("iframe",{className:"h-full w-full",src:`https://www.youtube-nocookie.com/embed/${Le}?autoplay=1`,title:Ae,allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share",allowFullScreen:!0})}):e.jsxs("button",{type:"button",onClick:()=>s(!0),className:"lk-video-frame group relative block w-full cursor-pointer border-0 p-0",style:{aspectRatio:"16/9"},"aria-label":`Spila myndband: ${Ae}`,children:[e.jsx("img",{src:`https://i.ytimg.com/vi/${Le}/hqdefault.jpg`,alt:"",loading:"lazy",className:"h-full w-full object-cover"}),e.jsx("span",{className:"absolute inset-0",style:{background:"rgba(20,20,15,0.28)"},"aria-hidden":!0}),e.jsx("span",{className:"lk-play absolute left-1/2 top-1/2 flex h-16 w-16 -translate-x-1/2 -translate-y-1/2 items-center justify-center","aria-hidden":!0,children:e.jsx(rt,{size:22,fill:"currentColor",style:{marginLeft:3}})}),e.jsx("span",{className:"absolute bottom-3 left-3 right-3 text-left text-[12px] font-medium uppercase tracking-[0.08em]",style:{fontFamily:a,color:"#fff"},children:"N4 · Að norðan"})]})}function Ft(){return e.jsx("section",{id:"um",className:"mx-auto max-w-[1440px] px-5 py-14 md:px-8 md:py-16","aria-label":"Um safnið",children:e.jsxs("div",{className:"grid grid-cols-1 gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,380px)] lg:gap-20",children:[e.jsxs("div",{children:[e.jsx(u,{children:e.jsx("p",{className:"lk-eyebrow m-0",style:{color:v},children:"Um safnið"})}),e.jsx(u,{delay:70,children:e.jsx("p",{className:"lk-serif m-0 mt-6 max-w-[34em] text-[20px] font-light leading-[1.75] md:text-[23px]",style:{color:N},children:"Listasafnið á Akureyri er opinbert safn sem Akureyrarbær rekur, til húsa við Kaupvangsstræti 8. Í húsinu eru tólf sýningarsalir ásamt Ketilhúsi, viðburðahúsi safnsins, og þar standa níu sýningar yfir samtímis. Safnið er viðurkennt safn."})}),e.jsx(u,{delay:140,children:e.jsxs("div",{className:"mt-8 flex items-center gap-4",children:[e.jsx("img",{src:U("vidurkennt.png"),alt:"Viðurkennt safn, viðurkenningarmerki",width:56,height:56,loading:"lazy",className:"h-14 w-14"}),e.jsx("p",{className:"m-0 text-[14px]",style:{fontFamily:a,color:y},children:"Viðurkennt safn · Rekið af Akureyrarbæ"})]})})]}),e.jsx(u,{delay:120,children:e.jsxs("div",{className:"flex flex-col",children:[e.jsx(Nt,{}),e.jsx("p",{className:"m-0 mb-6 mt-2 text-[12px]",style:{color:y},children:"Að norðan, N4 sjónvarp: sjónvarpsþáttur um safnið."}),e.jsxs("a",{href:Z,target:"_blank",rel:"noreferrer",className:"lk-row",style:{borderTop:`1px solid ${f}`},children:[e.jsx("span",{className:"text-[16px] font-medium uppercase tracking-[-0.01em]",style:{fontFamily:a},children:"Vinir Listasafnsins"}),e.jsx(W,{size:16,className:"lk-row-arrow","aria-hidden":!0})]}),e.jsxs("a",{href:Z,target:"_blank",rel:"noreferrer",className:"lk-row",children:[e.jsx("span",{className:"text-[16px] font-medium uppercase tracking-[-0.01em]",style:{fontFamily:a},children:"Útleiga á Ketilhúsi"}),e.jsx(W,{size:16,className:"lk-row-arrow","aria-hidden":!0})]})]})})]})})}function $t(){const t=[{label:"Instagram · @listak.is",href:Ge},{label:"Facebook",href:Ye},{label:"Póstlisti · skráning á listak.is",href:Xe}];return e.jsxs("section",{id:"fylgstu",className:"mx-auto max-w-[1440px] px-5 py-12 md:px-8 md:py-14","aria-label":"Fylgstu með",children:[e.jsx(u,{children:e.jsx("p",{className:"lk-eyebrow m-0",style:{color:v},children:"Fylgstu með"})}),e.jsx("div",{className:"mt-6 grid grid-cols-1 gap-x-10 md:grid-cols-3",children:t.map((s,x)=>e.jsx(u,{soft:!0,delay:x*60,children:e.jsxs("a",{href:s.href,target:"_blank",rel:"noreferrer",className:"lk-row",style:{borderTop:`1px solid ${f}`,borderBottom:"none"},children:[e.jsx("span",{className:"text-[15px] font-medium",style:{fontFamily:a},children:s.label}),e.jsx(W,{size:16,className:"lk-row-arrow","aria-hidden":!0})]})},s.label))})]})}function St(){return e.jsxs("footer",{id:"samband",className:"mt-2",style:{background:N,color:J},"aria-label":"Hafðu samband",children:[e.jsxs("div",{className:"mx-auto max-w-[1440px] px-5 py-16 md:px-8 md:py-20",children:[e.jsx("p",{className:"m-0 uppercase",style:{fontFamily:a,fontWeight:700,letterSpacing:"-0.02em",fontSize:"clamp(1.7rem, 4.6vw, 4rem)",lineHeight:1,color:J,paddingBottom:"0.22em",marginBottom:"-0.1em"},children:"Listasafnið á Akureyri"}),e.jsxs("div",{className:"mt-10 grid grid-cols-1 gap-10 md:grid-cols-3",children:[e.jsxs("div",{children:[e.jsx("p",{className:"lk-eyebrow m-0",style:{color:Y},children:"Heimsókn"}),e.jsxs("address",{className:"mt-4 flex flex-col gap-2 not-italic",style:{fontFamily:a},children:[e.jsx("span",{className:"text-[15px]",children:ye}),e.jsx("a",{href:me,className:"lk-flink inline-flex min-h-[44px] w-fit max-w-full items-center text-[15px]",style:{color:J},children:de}),e.jsx("a",{href:Je,className:"lk-flink inline-flex min-h-[44px] w-fit max-w-full items-center break-all text-[15px]",style:{color:J},children:qe})]})]}),e.jsxs("div",{children:[e.jsx("p",{className:"lk-eyebrow m-0",style:{color:Y},children:"Opnunartímar"}),e.jsx("dl",{className:"m-0 mt-4 flex flex-col",children:Qe.map(t=>e.jsxs("div",{className:"flex flex-col gap-0.5 py-2.5",style:{borderTop:`1px solid ${he}`},children:[e.jsx("dt",{className:"text-[13px]",style:{fontFamily:a,color:Y},children:t.label}),e.jsx("dd",{className:"m-0 text-[15px]",style:{fontFamily:a},children:t.value})]},t.label))})]}),e.jsxs("div",{className:"flex flex-col items-start gap-4",children:[e.jsx("p",{className:"lk-eyebrow m-0",style:{color:Y},children:"Safnið"}),e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsx("img",{src:U("vidurkennt.png"),alt:"Viðurkennt safn, viðurkenningarmerki",width:48,height:48,loading:"lazy",className:"h-12 w-12",style:{background:J,padding:4}}),e.jsxs("p",{className:"m-0 text-[14px] leading-relaxed",style:{fontFamily:a,color:Y},children:["Viðurkennt safn",e.jsx("br",{}),"Rekið af Akureyrarbæ"]})]}),e.jsxs("a",{href:Z,target:"_blank",rel:"noreferrer",className:"lk-flink lk-eyebrow inline-flex min-h-[44px] w-fit max-w-full items-center gap-2",style:{color:J},children:["listak.is",e.jsx(W,{size:14,"aria-hidden":!0})]})]})]})]}),e.jsx("div",{className:"px-5 py-5 text-center text-[12px] tracking-[0.16em]",style:{fontFamily:a,color:Y,borderTop:`1px solid ${he}`},children:"FRUMGERÐ · SNDR STUDIO"})]})}const Et=1100,Lt=180,At=700,Rt=1700,Tt=.13,_e="lk-loader-seen";function zt(){if(typeof window>"u"||ee())return!1;try{if(new URLSearchParams(window.location.search).has("loader"))return!0}catch{}try{if(sessionStorage.getItem(_e)==="1")return!1}catch{}return!0}function Ct(){const[t,s]=$.useState(zt),x=$.useRef(null);return $.useEffect(()=>{if(!t)return;const o=x.current;if(!o)return;try{sessionStorage.setItem(_e,"1")}catch{}const d=o.querySelector(".lk-load-bar"),i=o.querySelector(".lk-load-count"),r=Array.from(document.images).filter(n=>n.loading!=="lazy"||n.complete);let m=r.filter(n=>n.complete).length,w=!1;const b=r.length+1,l=[];r.forEach(n=>{if(n.complete)return;const j=()=>{m+=1};n.addEventListener("load",j,{once:!0}),n.addEventListener("error",j,{once:!0}),l.push(()=>{n.removeEventListener("load",j),n.removeEventListener("error",j)})});try{document.fonts.ready.then(()=>{w=!0})}catch{w=!0}const c=performance.now();let p=0,g=-1,E=0,T=!1,S=0,z=0,R=0;const _=n=>{n!==g&&(d&&(d.style.transform=`scaleX(${n/100})`),i&&(i.textContent=`${String(n).padStart(3,"0")}%`),g=n)},C=()=>{T||(T=!0,window.clearInterval(S),window.clearTimeout(z),l.forEach(n=>n()),window.removeEventListener("pointerdown",A,L),window.removeEventListener("touchmove",A,L),window.removeEventListener("wheel",A,L),window.removeEventListener("keydown",A,L),o.classList.add("is-out"),R=window.setTimeout(()=>s(!1),At))},L={passive:!0,capture:!0};function A(){C()}window.addEventListener("pointerdown",A,L),window.addEventListener("touchmove",A,L),window.addEventListener("wheel",A,L),window.addEventListener("keydown",A,L);const D=()=>{const n=performance.now(),j=(m+(w?1:0))/b,O=Math.min(j,(n-c)/Et);p=Math.min(O,p+Tt);const I=p>=1?100:Math.max(0,Math.floor(p*100));_(I),I===100&&(E||(E=n),n-E>=Lt&&C())};return _(0),S=window.setInterval(D,50),z=window.setTimeout(C,Rt),()=>{window.clearInterval(S),window.clearTimeout(z),window.clearTimeout(R),l.forEach(n=>n()),window.removeEventListener("pointerdown",A,L),window.removeEventListener("touchmove",A,L),window.removeEventListener("wheel",A,L),window.removeEventListener("keydown",A,L)}},[t]),t?e.jsx("div",{ref:x,className:"lk-load","aria-hidden":"true",children:e.jsxs("div",{className:"lk-load-in",children:[e.jsxs("p",{className:"lk-load-mark",children:[e.jsx("span",{children:Ue}),e.jsx("span",{children:Ie})]}),e.jsx("div",{className:"lk-load-track",children:e.jsx("div",{className:"lk-load-bar"})}),e.jsxs("div",{className:"lk-load-meta",children:[e.jsx("p",{className:"lk-eyebrow m-0",style:{color:y},children:"Kaupvangsstræti 8, Akureyri"}),e.jsx("p",{className:"lk-eyebrow lk-load-count m-0",children:"000%"})]})]})}):null}function or(){const t=$.useRef(null),[s,x]=$.useState(null);return $.useEffect(()=>{document.title=Fe.title,Pe(X),document.documentElement.lang="is";const o=document.querySelector('meta[name="description"]'),d=(o==null?void 0:o.getAttribute("content"))??"";o==null||o.setAttribute("content",Fe.description);const i=document.createElement("script");i.type="application/ld+json",i.textContent=JSON.stringify(He),document.head.appendChild(i);const r=["familjen-grotesk-v11-latin_latin-ext-700.woff2","familjen-grotesk-v11-latin_latin-ext-600.woff2"].map(m=>{const w=document.createElement("link");return w.rel="preload",w.as="font",w.type="font/woff2",w.crossOrigin="anonymous",w.href=`${M}familjen-grotesk/${m}`,document.head.appendChild(w),w});return()=>{o==null||o.setAttribute("content",d),i.remove(),r.forEach(m=>m.remove())}},[]),$.useEffect(()=>{x(De())},[]),$.useEffect(()=>{const o=t.current;if(!o)return;const d=G.matchMedia();return d.add({motion:"(prefers-reduced-motion: no-preference)",desktop:"(min-width: 1024px)",fine:"(pointer: fine)"},i=>{const r=i.conditions;if(!r.motion||!r.desktop||!r.fine)return;const m=new Me({lerp:.1,wheelMultiplier:1,smoothWheel:!0});m.on("scroll",H.update),te=m,window.__lkLenis=m;const w=h=>m.raf(h*1e3);G.ticker.add(w),G.ticker.lagSmoothing(0);const b=o.querySelector(".lk-journey"),l=o.querySelector(".lk-track"),c=o.querySelector(".lk-hud-fill"),p=o.querySelector(".lk-hud-count");if(!b||!l)return;const g=()=>Math.max(1,l.scrollWidth-window.innerWidth),E=G.to(l,{x:()=>-g(),ease:"none",force3D:!0}),T=Array.from(l.querySelectorAll(".lk-stop:not(.lk-stop-intro)"));let S=[],z=1;const R=()=>{z=g(),S=T.map(h=>h.offsetLeft+h.offsetWidth/2)};R();let _=-1;const C=H.create({animation:E,trigger:b,pin:b,scrub:1,start:"top top",end:()=>"+="+g(),anticipatePin:1,invalidateOnRefresh:!0,onRefresh:R,onUpdate:h=>{if(c&&(c.style.transform=`scaleX(${h.progress})`),p&&S.length){const F=z*h.progress+window.innerWidth/2;let P=0,K=1/0;for(let V=0;V<S.length;V++){const B=Math.abs(S[V]-F);B<K&&(K=B,P=V)}P!==_&&(_=P,p.textContent=`${String(P+1).padStart(2,"0")}/09`)}}});pe={master:C,track:l,lenis:m};const L=Array.from(l.querySelectorAll(".lk-stop:not(.lk-stop-intro) .lk-stop-core"));L.forEach(h=>se.add(h)),ve();const A=[];Array.from(l.querySelectorAll(".lk-stop-frame > .lk-frame-in > img")).forEach(h=>{A.push(G.fromTo(h,{xPercent:5.5,scale:1.14},{xPercent:-5.5,scale:1.14,ease:"none",scrollTrigger:{trigger:h.closest(".lk-stop"),containerAnimation:E,start:"left 100%",end:"right 0%",scrub:!0}}))});let D=null;const n=()=>{const h=document.activeElement;D=h&&h!==document.body&&b.contains(h)?h:null},j=()=>{const h=D;D=null,h&&h.isConnected&&document.activeElement!==h&&h.focus({preventScroll:!0})};H.addEventListener("refreshInit",n),H.addEventListener("refresh",j);const O=h=>{var B,Ne;const F=(Ne=(B=h.target)==null?void 0:B.closest)==null?void 0:Ne.call(B,".lk-stop");if(!F||!pe)return;b.scrollLeft=0,b.scrollTop=0;const P=g(),K=Math.min(Math.max(0,F.offsetLeft-(window.innerWidth-F.offsetWidth)/2),P),V=Math.min(C.end,C.start+K/P*(C.end-C.start));Math.abs(window.scrollY-V)<2||m.scrollTo(V,{})};b.addEventListener("focusin",O),document.fonts.ready.then(()=>H.refresh());const I=Array.from(l.querySelectorAll("img"));return Promise.all(I.map(h=>{const F=h;return F.complete&&F.naturalWidth>0?Promise.resolve():(F.decode?F.decode().catch(()=>{}):void 0)??new Promise(K=>{F.addEventListener("load",()=>K(),{once:!0}),F.addEventListener("error",()=>K(),{once:!0})})})).then(()=>{C.progress>0||H.refresh()}),()=>{H.removeEventListener("refreshInit",n),H.removeEventListener("refresh",j),b.removeEventListener("focusin",O),A.forEach(h=>{var F;(F=h.scrollTrigger)==null||F.kill(),h.kill()}),C.kill(),E.kill(),L.forEach(h=>{se.delete(h),h.style.filter="",h.style.transform="",delete h.dataset.lkDof}),be(),G.ticker.remove(w),m.destroy(),delete window.__lkLenis,pe=null,te=null}}),()=>{d.revert()}},[]),e.jsxs("div",{ref:t,lang:"is",className:"lk-root min-h-[100svh] antialiased",style:{fontFamily:a},children:[e.jsx("style",{children:mt}),e.jsx("a",{href:"#meginmal",className:"lk-skip",children:"Beint í efni"}),e.jsx(ft,{}),e.jsxs("main",{id:"meginmal",children:[e.jsx(ht,{status:s}),e.jsx(ut,{status:s}),e.jsx(yt,{}),e.jsx(wt,{}),e.jsx(vt,{}),e.jsx(bt,{}),e.jsx(jt,{}),e.jsx(Ft,{}),e.jsx($t,{})]}),e.jsx(St,{}),e.jsx(tt,{company:$e}),e.jsx(et,{company:$e}),e.jsx(Ct,{})]})}export{or as default};
