import{r as h,s as be,a as Ne,j as e,L as we}from"./index-HJW3YLSn.js";import{g as A}from"./index-CzGW6FVa.js";import{S as le}from"./ScrollTrigger-DNECHiyU.js";import $e from"./lenis-niKyKZQP.js";import{g as ze}from"./companies-DhNyAQKb.js";import{P as Se}from"./PreviewChrome-CrxZHc_f.js";import{P as Ee}from"./PreviewFooter-BU5K87w6.js";import{d as Te}from"./demoStore-Cl8pI4vE.js";import{m as Ae}from"./proxy-DhFuJBH5.js";import"./data-C8ZDiw2z.js";import"./company-D-rC5gQU.js";import"./company-B3ttGpBR.js";import"./company-Dj0FZhSK.js";import"./company-CWG9yyz-.js";import"./outreach-sign-BcNtFClO.js";import"./company-gNW5QTrS.js";import"./copy-6rQ_WnRy.js";import"./createLucideIcon-DKRh8nux.js";import"./send-BRHnbns5.js";import"./index-C5HiW_aO.js";import"./external-link-CCJOogst.js";import"./x-MsA_vcns.js";import"./mail-rWF3sUWI.js";import"./SndrBadge-C1hgOKfx.js";const ye="",Fe="https://property.godo.is/booking2.php";function ve(t){const[n,r,v]=t.split("-").map(Number);return`${n}-${r}-${v}`}function me(){return ye.trim().length>0}function Le(t){const n=new URLSearchParams;return n.set("propid",ye),t.checkin&&n.set("checkin",ve(t.checkin)),t.checkout&&n.set("checkout",ve(t.checkout)),n.set("numadult",String(Math.max(1,t.adults??2))),n.set("numchild","0"),n.set("lang",t.lang??"en"),n.set("referer","villanorth-web"),`${Fe}?${n.toString()}`}const x="/iceland-redesigns/villanorth/",Oe={"tub-night-small.jpg":520,"winter-river.jpg":800},ee=t=>{const n=Oe[t.split("/").pop()??""]??1200,r=`${t.replace(/\.jpg$/,"-800.jpg")} 800w`;return n<=800&&n!==520?r:`${r}, ${t} ${n}w`},U={name:"the owner",responseRate:"100%",respondsWithin:"within an hour",rating:5,reviewCount:58,badges:["Guest favorite","Top 5% of homes"]},s={glassGrid:{src:`${x}glass-grid.jpg`,alt:"The two-storey glass gable of Villa North against a pale blue sky, dark timber cladding at its edges"},gridSunset:{src:`${x}grid-sunset.jpg`,alt:"The gable end of Villa North in silhouette against an orange sunset, its roofline the source of this page's drawing",ratio:"3 / 2"},aerialSunset:{src:`${x}aerial-sunset.jpg`,alt:"Aerial view of Villa North at sunset, cut into the hillside above Fnjóskadalur with the hot tub on its deck"},aerialSunsetB:{src:`${x}aerial-sunset-b.jpg`,alt:"A wider aerial view of Villa North at dusk, the valley and dark fells behind it",ratio:"4 / 3"},aerialRiver:{src:`${x}aerial-river.jpg`,alt:"Aerial daylight view of Villa North above Fnjóskadalur, the river Fnjóská winding through the valley below",ratio:"4 / 3"},aerialMist:{src:`${x}aerial-mist.jpg`,alt:"Aerial view of Villa North with morning mist low in the valley and fog on the fells behind",ratio:"4 / 3"},mezzanine:{src:`${x}mezzanine.jpg`,alt:"Looking down from the upstairs gallery into the double-height sitting room, glass wall onto the valley",ratio:"3 / 2"},dining:{src:`${x}dining.jpg`,alt:"The round dining table for six, glass walls open to the deck and the valley beyond",ratio:"3 / 2"},bedroom:{src:`${x}bedroom.jpg`,alt:"A bedroom with a dark upholstered bed, folded towels, and a wall sconce either side of the headboard",ratio:"16 / 9"},bedroomAttic:{src:`${x}bedroom-attic.jpg`,alt:"The upstairs bedroom under the sloped roof, a bed against the low wall and a balcony door beyond",ratio:"16 / 9"},living:{src:`${x}living.jpg`,alt:"The sitting room, a grey sectional sofa facing a floor to ceiling glass wall onto the valley",ratio:"3 / 2"},livingSofa:{src:`${x}living-sofa.jpg`,alt:"The sitting room in the evening, a throw blanket over the sofa arm, the valley through the glass behind it",ratio:"3 / 2"},kitchenRun:{src:`${x}kitchen-run.jpg`,alt:"The kitchen counter run, a warm light strip glowing under the shelf above the worktop",ratio:"3 / 2"},kitchenPendants:{src:`${x}kitchen-pendants.jpg`,alt:"The kitchen island under three pendant lights, a vase of fresh flowers and a bowl of fruit on the counter",ratio:"3 / 2"},kitchenDining:{src:`${x}kitchen-dining.jpg`,alt:"The kitchen island under pendant lights, the dining table and valley view visible beyond it",ratio:"3 / 2"},bath:{src:`${x}bath.jpg`,alt:"A bathroom with dark tile, a round backlit mirror, and a black oval basin",ratio:"3 / 2"},concreteDetail:{src:`${x}concrete-detail.jpg`,alt:"A steel wall light set into board-formed concrete, the timber cladding continuing beyond it",ratio:"3 / 2"},claddingDetail:{src:`${x}cladding-detail.jpg`,alt:"A black steel light fixture mounted on dark vertical timber cladding",ratio:"2 / 3"},walkway:{src:`${x}walkway.jpg`,alt:"The concrete walkway along the house, a steel handrail edge in the foreground and timber cladding beyond",ratio:"2 / 3"},winterNight:{alt:"Villa North lit up at dusk in winter, snow patches on the ground and the hot tub visible on its deck"},tourWhales:{src:`${x}tour-whales.jpg`,alt:"A whale surfacing in open water off the north coast",ratio:"3 / 2"},tourGodafoss:{src:`${x}tour-godafoss.jpg`,alt:"A wide waterfall breaking over a dark basalt lip",ratio:"3 / 2"},tourHorses:{src:`${x}tour-horses.jpg`,alt:"Icelandic horses grazing below a mountain ridge",ratio:"3 / 2"},winterRiver:{src:`${x}winter-river.jpg`,alt:"An aerial dusk view in winter, the river system tracing through the valley beyond the lit house",ratio:"3 / 2"},wineGlasses:{src:`${x}wine-glasses.jpg`,alt:"Two wine glasses on the deck rail at golden hour, an amber light strip glowing beneath the rail",ratio:"3 / 2"},tubNightSmall:{src:`${x}tub-night-small.jpg`,alt:"The hot tub at night, warm light glowing under its rim, bare snow-dusted birch trees behind it",ratio:"520 / 546"},livingTall:{src:`${x}living-tall.jpg`,alt:"A portrait view inside the sitting room, the angled timber ceiling and a black steel wall brace above the sofa",ratio:"2 / 3"}},B=[{id:"br1",level:"efri",label:"Svefnherbergi 1",fact:"1 king + 2 single beds",note:"Upstairs. No bathroom on this floor.",photo:s.bedroomAttic},{id:"br2",level:"nedri",label:"Svefnherbergi 2",fact:"1 queen bed",photo:s.bedroom},{id:"br3",level:"nedri",label:"Svefnherbergi 3",fact:"1 queen bed",photo:s.bedroom,photoNote:"Same room type as Svefnherbergi 2; the photo is shared."},{id:"br4",level:"nedri",label:"Svefnherbergi 4",fact:"1 single bed",photo:s.bedroom,photoNote:"The smallest room; the photo is shared with the two queen rooms."},{id:"stofa",level:"nedri",label:"Stofa",fact:"The sitting room",note:"Floor to ceiling glass on the valley side.",photo:s.living},{id:"eldhus",level:"nedri",label:"Eldhús",fact:"The kitchen",note:"Miele appliances, very well stocked, open to the dining table.",photo:s.kitchenRun},{id:"pallur",level:"nedri",label:"Pallurinn",fact:"The sundeck",note:"The hot tub sits at its edge: trees on one side, the valley on the other.",photo:s.wineGlasses}],re={fact:"1.5 bathrooms, both on the main level",detail:"The upstairs bedroom (Svefnherbergi 1) has no bathroom of its own; both bathrooms are downstairs.",photo:s.bath},pe={intro:"Below the house, the river Fnjóská curves past the farm at Steinkirkja, with Vaglaskógur, one of Iceland's largest forests, a short walk away.",draws:[{name:"Vaglaskógur",note:"One of Iceland's largest forests, a short walk from the house."},{name:"Fnjóská",note:"A rod-fishing river, right below the hillside."},{name:"Akureyri",note:"Fifteen to twenty minutes through the toll tunnel, Vaðlaheiðargöng. Guests recommend buying the 10-pass."},{name:"9-hole golf course",note:"Nearby, in the same valley."},{name:"Hiking trails",note:"Starting from the forest edge."}]},K={intro:"Board-formed concrete outside, dark timber cladding, and steel fixtures set flush into both. Inside, the furniture is the real thing.",names:["Minotti","Miele","Stelton"],quote:{quote:"Where other design houses are filled with Ikea products and furniture, this home is the real deal.",author:"Harold",when:"April 2026"}},J={intro:"The hot tub sits on the edge of the sundeck, trees on one side, the valley on the other, open through the winter.",auroraFact:"Guests have watched the northern lights from the tub, mentioned in three or more reviews.",quote:{quote:"Just wait until you see the view from the hot tub on your first evening there!",author:"Katie",when:"September 2025"}},X={src:`${x}glow-film.mp4`,poster:`${x}glow-poster.jpg`,posterSmall:`${x}glow-poster-800.jpg`},ue={intro:"Recurring across many guest reviews, the same small ritual greets every arrival.",items:["Fresh flowers","Champagne or sparkling wine","Chocolate","Fruit"]},Ce=[{quote:"Probably the best Airbnb experience I have ever had.",author:"Eric",when:"June 2026"},{quote:"Thoughtful design, unparalleled views. 11/10!",author:"Naomi",when:"July 2026"},{quote:"It was squeaky clean and the epitome of luxury. The house was designed and engineered perfectly.",author:"Kris",when:"August 2025"}],W={guests:7,bedrooms:4,beds:6,baths:"1.5",checkIn:"After 4:00 PM, self check-in with a lockbox",checkOut:"Before 11:00 AM",security:"Exterior security cameras are in use",water:"The hot tub has no gate or lock; a river runs nearby"},te=[{place:"Akureyri",name:"Whale watching",note:"From Akureyri harbour, twenty minutes away",photo:s.tourWhales},{place:"Mývatn",name:"Goðafoss and Mývatn",note:"A day east along the Ring Road",photo:s.tourGodafoss},{place:"Fnjóskadalur",name:"Riding in the valley",note:"Icelandic horses, an hour or an afternoon",photo:s.tourHorses}],Z={src:`${x}aerial-film.mp4`,poster:`${x}aerial-film-poster.jpg`,posterSmall:`${x}aerial-film-poster-800.jpg`},Ie={"@context":"https://schema.org","@type":"LodgingBusiness",name:"Villa North",description:"A villa in Fnjóskadalur valley, Þingeyjarsveit, North Iceland, with a view over the river Fnjóská and the farm Steinkirkja. Sleeps seven across four bedrooms, with a private hot tub on the sundeck.",address:{"@type":"PostalAddress",addressLocality:"Fnjóskadalur, Þingeyjarsveit",addressRegion:"Norðurland",addressCountry:"IS"},aggregateRating:{"@type":"AggregateRating",ratingValue:5,reviewCount:58},amenityFeature:[{"@type":"LocationFeatureSpecification",name:"Private hot tub",value:!0},{"@type":"LocationFeatureSpecification",name:"River view",value:!0},{"@type":"LocationFeatureSpecification",name:"Valley view",value:!0},{"@type":"LocationFeatureSpecification",name:"Free parking",value:!0},{"@type":"LocationFeatureSpecification",name:"Kitchen",value:!0}]};A.registerPlugin(le);const ge=ze("villanorth"),ne="#F0F1F2",Y="#17181A",H="#101216",O="'Apfel Grotezk', system-ui, sans-serif",Me="'Onest', system-ui, sans-serif",c="'Azeret Mono', ui-monospace, monospace",ie="(min-width: 1440px) 432px, (min-width: 992px) 30vw, 100vw",se="3 / 2",qe="(min-width: 1200px) 300px, (min-width: 700px) 44vw, 90vw",fe=4600,D="/iceland-redesigns/",ce=()=>typeof matchMedia<"u"&&matchMedia("(hover: none) and (pointer: coarse)").matches,Re=ce()?.35:!0,V=()=>{var t;return typeof window<"u"&&((t=window.matchMedia)==null?void 0:t.call(window,"(prefers-reduced-motion: reduce)").matches)===!0},o=(t,n)=>`clamp(${n}px, calc(var(--u) * ${t}), ${+(t*1.15).toFixed(1)}px)`;function De(t){h.useEffect(()=>{if(!t)return;const n=document.querySelector(".vn-root");if(!n)return;if(V()){n.classList.add("vn-static");return}n.classList.add("vn-js"),le.config({ignoreMobileResize:!0});const r=ce()?null:new $e({duration:1.1,smoothWheel:!0}),v=new IntersectionObserver(w=>w.forEach(u=>u.isIntersecting&&u.target.classList.add("is-in")),{threshold:.2});n.querySelectorAll(".vn-rv").forEach(w=>v.observe(w));const m=Array.from(n.querySelectorAll(".vn-frame-in"));let j=null;const b=()=>{if(j!=null&&j.isActive)return;const w=window.innerHeight,u=window.innerWidth<992,T=[];for(const y of m){const g=y.parentElement;if(!g)continue;const f=g.getBoundingClientRect();if(f.bottom<-240||f.top>w+240)continue;const a=Number(y.dataset.drift||9),l=u?a*.5:a,i=(f.top+f.height/2-w/2)/(w/2+f.height/2);T.push([y,`translate3d(0,${(-i*l).toFixed(2)}%,0)`])}for(const[y,g]of T)y.style.transform=g},S=[],F=A.context(()=>{const w=n.querySelectorAll(".vn-wm-word"),u=n.querySelector(".vn-wm-rule"),T=n.querySelector(".vn-measure-text");if(w.length){A.set(w,{yPercent:120,opacity:0}),u&&A.set(u,{scaleX:0}),T&&A.set(T,{opacity:0,y:8});const $=A.timeline({paused:!0,delay:.25}).to(u,{scaleX:1,duration:.9,ease:"expo.out"}).to(w,{yPercent:0,opacity:1,duration:1.35,ease:"expo.out",stagger:.1},"-=0.55").to(T,{opacity:1,y:0,duration:.6,ease:"power2.out"},"-=0.7"),k=()=>{!$.isActive()&&$.progress()===0&&$.play()},_=()=>{document.visibilityState==="visible"&&k()};document.querySelector(".vn-loader")?window.addEventListener("vn:revealed",_,{once:!0}):_();const ae=()=>{document.visibilityState==="visible"&&k()};document.addEventListener("visibilitychange",ae);const G=window.setTimeout(()=>{$.progress()===0&&$.progress(1)},6e3);S.push(()=>{document.removeEventListener("visibilitychange",ae),window.clearTimeout(G)});const de=n.querySelector(".vn-hero"),he=n.querySelector(".vn-wordmark");if(de&&he){const oe={trigger:de,start:"top top",end:"bottom top",scrub:.6};A.to(w,{y:84,ease:"none",stagger:.04,scrollTrigger:oe}),u&&A.to(u,{scaleX:2.8,opacity:0,ease:"none",scrollTrigger:oe}),A.to(he,{opacity:.1,ease:"none",scrollTrigger:oe})}}const y=!ce();n.querySelectorAll("[data-vn-headline]").forEach($=>{const k=$.querySelectorAll(".vn-char");k.length&&A.fromTo(k,{opacity:0,y:10,...y?{filter:"blur(12px)"}:null},{opacity:1,y:0,...y?{filter:"blur(0px)"}:null,duration:.6,ease:"power2.out",stagger:.02,clearProps:y?"filter":"",scrollTrigger:{trigger:$,start:"top 88%",once:!0}})});const g=n.querySelector(".vn-drawing-inner"),f=n.querySelector(".vn-elev-line"),a=n.querySelector(".vn-elev-secondary"),l=n.querySelector(".vn-elev-mullions"),i=n.querySelector(".vn-elev-hatch"),N=n.querySelector(".vn-elev-svg"),d=n.querySelector(".vn-elev-photo"),I=n.querySelector(".vn-elev-cap-sketch"),M=n.querySelector(".vn-elev-cap-photo"),q=$=>{if(!$||!("getTotalLength"in $))return;const k=$.getTotalLength();A.set($,{strokeDasharray:k,strokeDashoffset:k})};if(q(f),q(a),q(l),i&&A.set(i,{opacity:0}),d&&A.set(d,{opacity:0}),M&&A.set(M,{opacity:0}),g&&f&&d&&N){const $=[f,a].filter(Boolean);if(window.innerWidth>=768){const k=A.timeline({scrollTrigger:{trigger:g,start:"top top",end:"+=220%",pin:!0,scrub:Re,anticipatePin:1,invalidateOnRefresh:!0}});j=k.scrollTrigger??null,k.to($,{strokeDashoffset:0,ease:"none",duration:.4},0),l&&k.to(l,{strokeDashoffset:0,ease:"none",duration:.22},.16),i&&k.to(i,{opacity:.3,ease:"none",duration:.14},.38),I&&k.to(I,{opacity:0,ease:"none",duration:.08},.58),k.to(N,{opacity:0,ease:"none",duration:.2},.6),k.to(d,{opacity:1,ease:"none",duration:.2},.6),M&&k.to(M,{opacity:1,ease:"none",duration:.1},.68)}else{const k=new IntersectionObserver(_=>{_.forEach(ae=>{if(!ae.isIntersecting)return;k.disconnect();const G=A.timeline();G.to($,{strokeDashoffset:0,ease:"power1.inOut",duration:1.1}),l&&G.to(l,{strokeDashoffset:0,ease:"power1.inOut",duration:.6},"-=0.35"),i&&G.to(i,{opacity:.3,duration:.5},"-=0.2"),I&&G.to(I,{opacity:0,duration:.3}),G.to(N,{opacity:0,duration:.6},"<"),G.to(d,{opacity:1,duration:.6},"<"),M&&G.to(M,{opacity:1,duration:.4},"-=0.3")})},{threshold:.35});k.observe(g),S.push(()=>k.disconnect())}}const R=n.querySelector(".vn-glow");if(R){const $=new IntersectionObserver(k=>k.forEach(_=>{R.classList.toggle("is-dark",_.isIntersecting),be(_.isIntersecting?H:ne)}),{threshold:.3});$.observe(R),S.push(()=>$.disconnect())}},n),p=n.querySelector(".vn-drawing"),L=()=>p==null?void 0:p.classList.add("vn-force-resolved"),E=()=>p==null?void 0:p.classList.remove("vn-force-resolved");p==null||p.addEventListener("focusin",L),p==null||p.addEventListener("focusout",E),S.push(()=>{p==null||p.removeEventListener("focusin",L),p==null||p.removeEventListener("focusout",E)}),r&&r.on("scroll",le.update);const C=w=>{b(),r==null||r.raf(w*1e3)};return A.ticker.add(C),A.ticker.lagSmoothing(0),b(),()=>{A.ticker.remove(C),v.disconnect(),S.forEach(w=>w()),F.revert(),r==null||r.destroy()}},[t])}function P({text:t,size:n,floor:r,as:v="h2",className:m="",measure:j}){return e.jsx(v,{"data-vn-headline":!0,"aria-label":t,className:`vn-headline ${m}`,style:{fontSize:o(n,r),maxWidth:j?`calc(var(--u) * ${j})`:void 0},children:t.split(" ").map((b,S,F)=>e.jsxs("span",{className:"vn-word","aria-hidden":"true",children:[Array.from(b).map((p,L)=>e.jsx("span",{className:"vn-char",children:p},L)),S<F.length-1?e.jsx("span",{className:"vn-char",children:" "}):null]},S))})}function z({photo:t,className:n="",priority:r=!1,maxWidth:v,sizes:m,drift:j=9,ratio:b}){return e.jsxs("figure",{className:`vn-frame vn-rv ${n}`,style:{"--vn-ar":b??t.ratio,...v?{"--vn-fw":`${v}px`}:null},children:[e.jsx("svg",{className:"vn-frame-svg",viewBox:"0 0 100 100",preserveAspectRatio:"none","aria-hidden":"true",children:e.jsx("rect",{x:"0.6",y:"0.6",width:"98.8",height:"98.8"})}),e.jsx("div",{className:"vn-frame-in","data-drift":j,style:{"--dz":`${Math.max(9,j*1.35)}%`},children:e.jsx("img",{src:t.src,srcSet:ee(t.src),sizes:m??"(max-width: 899px) 100vw, 50vw",alt:t.alt,loading:r?"eager":"lazy",decoding:"async"})})]})}function Pe({tour:t}){const n=e.jsxs(e.Fragment,{children:[e.jsx(z,{photo:t.photo,className:"vn-tour-shot",ratio:"4 / 5",sizes:qe,drift:5}),e.jsx("span",{className:"vn-tour-veil","aria-hidden":"true"}),e.jsxs("span",{className:"vn-tour-over",children:[e.jsx("span",{className:"vn-tour-place",children:t.place}),e.jsx("span",{className:"vn-tour-name",children:t.name}),e.jsx("span",{className:"vn-tour-cta","aria-hidden":"true",children:"→"})]})]});return e.jsx("article",{className:"vn-tour-plate",tabIndex:0,children:n})}const Ge=[{photo:s.concreteDetail,label:"Board-formed concrete"},{photo:s.claddingDetail,label:"Dark timber cladding"},{photo:s.walkway,label:"The walkway"}];function Be(){const[t,n]=h.useState(null),r=V();return e.jsx("div",{className:"vn-mat-expand",role:"group","aria-label":"Materials",children:Ge.map((v,m)=>e.jsxs(Ae.button,{type:"button",className:"vn-mat-panel","aria-expanded":t===m,"aria-current":t===m?"true":void 0,onMouseEnter:()=>n(m),onFocus:()=>n(m),onClick:()=>n(m),animate:{flexGrow:t===m?2.2:1},transition:{duration:r?0:.5,ease:[.25,1,.5,1]},children:[e.jsx("img",{src:v.photo.src,srcSet:ee(v.photo.src),sizes:"(max-width: 767px) 100vw, 33vw",alt:v.photo.alt,loading:"lazy",decoding:"async"}),e.jsx("span",{className:`vn-mat-scrim ${t===m?"is-active":""}`,"aria-hidden":"true"}),e.jsx("span",{className:`vn-mat-label ${t===m?"is-active":""}`,children:v.label})]},v.label))})}const We=()=>{if(typeof window>"u"||V())return!1;if(new URLSearchParams(window.location.search).has("loader"))return!0;try{return!sessionStorage.getItem("vn_seen")}catch{return!0}};function Ve({onDone:t}){const[n,r]=h.useState(0),[v,m]=h.useState(!1);return h.useEffect(()=>{try{sessionStorage.setItem("vn_seen","1")}catch{}const j=performance.now();let b=0,S=0,F=!1;const p=new Image;p.decoding="async";const L=()=>{F=!0};p.addEventListener("load",L,{once:!0}),p.addEventListener("error",L,{once:!0}),p.src=s.aerialSunset.src,p.complete&&(F=!0);let E=!1;document.fonts.ready.then(()=>{E=!0});const C=1100,w=2400,u=()=>{const T=performance.now()-j;let y=(F?55:Math.min(50,T/24))+(E?45:0);T>=w&&(y=100),S+=(y-S)*.12;const g=Math.min(100,Math.round(S));if(r(g),g>=100&&T>=C){m(!0),window.setTimeout(t,950);return}b=requestAnimationFrame(u)};return b=requestAnimationFrame(u),()=>cancelAnimationFrame(b)},[t]),e.jsxs("div",{className:`vn-loader ${v?"is-leaving":""}`,"aria-hidden":"true",children:[e.jsx("p",{className:"vn-loader-mark",style:{backgroundPositionX:`${100-n}%`},children:"VILLA NORTH"}),e.jsxs("p",{className:"vn-loader-pct",children:[n,"%"]})]})}const ke=864e5,_e=(t,n)=>{const r=new Date(`${t}T12:00:00`);return new Date(r.getTime()+n*ke).toISOString().slice(0,10)},xe=t=>String(t).padStart(2,"0"),He=(t,n,r)=>`${t}-${xe(n+1)}-${xe(r)}`,Ue=(t,n)=>new Date(t,n+1,0).getDate(),Ye=(t,n)=>(new Date(t,n,1).getDay()+6)%7,je=(t,n)=>Math.round((new Date(`${n}T12:00:00`).getTime()-new Date(`${t}T12:00:00`).getTime())/ke),Ke=["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"],Je=["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],Q=t=>{const n=new Date(`${t}T12:00:00`);return`${Je[n.getDay()]} ${n.getDate()} ${Ke[n.getMonth()]}`},Xe=(t,n)=>new Date(t,n,1).toLocaleDateString("en-GB",{month:"long",year:"numeric"}),Ze=["M","T","W","T","F","S","S"];function Qe({stay:t,onChange:n,minDate:r}){const v=h.useMemo(()=>{const f=new Date(`${r}T12:00:00`);return{y:f.getFullYear(),m:f.getMonth()}},[r]),[m,j]=h.useState(v),[b,S]=h.useState(null),[F,p]=h.useState(t.from||r),L=h.useRef(!1),E=t.to??(t.from&&b&&b>t.from?b:null),C=f=>j(a=>{const l=new Date(a.y,a.m+f,1),i={y:l.getFullYear(),m:l.getMonth()};return i.y*12+i.m<v.y*12+v.m?a:i}),w=m.y*12+m.m<=v.y*12+v.m,u=f=>{!t.from||t.to||f<=t.from?n({from:f,to:null}):n({from:t.from,to:f})},T=f=>{var R;const l={ArrowLeft:-1,ArrowRight:1,ArrowUp:-7,ArrowDown:7,PageUp:-28,PageDown:28}[f.key];if(l===void 0)return;f.preventDefault();const i=((R=f.target.dataset)==null?void 0:R.vnDay)||F,N=_e(i,l);if(N<r)return;L.current=!0,p(N);const[d,I]=[Number(N.slice(0,4)),Number(N.slice(5,7))-1],M=d*12+I,q=m.y*12+m.m;if(M<q)j({y:d,m:I});else if(M>q+1){const $=new Date(d,I-1,1);j({y:$.getFullYear(),m:$.getMonth()})}};h.useEffect(()=>{if(!L.current)return;L.current=!1;const f=document.querySelector(`[data-vn-day="${F}"]`);f==null||f.focus()},[F]);const y=f=>{const a=new Date(m.y,m.m+f,1),l=a.getFullYear(),i=a.getMonth(),N=Array.from({length:Ye(l,i)},()=>null);for(let d=1;d<=Ue(l,i);d++)N.push(He(l,i,d));for(;N.length%7;)N.push(null);return e.jsxs("div",{className:"vn-cal-month",children:[e.jsx("p",{className:"vn-cal-title",children:Xe(l,i)}),e.jsx("div",{className:"vn-cal-dows","aria-hidden":"true",children:Ze.map((d,I)=>e.jsx("span",{className:"vn-cal-dow",children:d},I))}),e.jsx("div",{className:"vn-cal-grid",role:"grid",onKeyDown:T,children:N.map((d,I)=>{if(!d)return e.jsx("span",{className:"vn-cal-cell is-blank"},`b${I}`);const M=d<r,q=d===t.from,R=!!E&&d===E,$=!!t.from&&!!E&&d>t.from&&d<E,k=["vn-cal-cell",q?"is-from":"",R?"is-to":"",$?"is-in":""].filter(Boolean).join(" ");return e.jsx("span",{className:k,children:e.jsx("button",{type:"button","data-vn-day":d,className:`vn-cal-day ${q||R?"is-end":""}`,disabled:M,tabIndex:d===F?0:-1,"aria-label":Q(d),"aria-pressed":q||R,onFocus:()=>p(d),onMouseEnter:()=>S(d),onMouseLeave:()=>S(null),onClick:()=>u(d),children:Number(d.slice(8))})},d)})})]},`${l}-${i}`)},g=t.from&&E?je(t.from,E):0;return e.jsxs("div",{className:"vn-cal",children:[e.jsxs("div",{className:"vn-cal-head",children:[e.jsx("span",{className:"vn-field-label",children:"Your dates"}),e.jsxs("span",{className:"vn-cal-nav",children:[e.jsx("button",{type:"button",onClick:()=>C(-1),disabled:w,"aria-label":"Previous month",children:"←"}),e.jsx("button",{type:"button",onClick:()=>C(1),"aria-label":"Next month",children:"→"})]})]}),e.jsxs("div",{className:"vn-cal-months",children:[y(0),y(1)]}),e.jsx("div",{className:"vn-cal-dim","aria-live":"polite",children:t.from&&E?e.jsxs(e.Fragment,{children:[e.jsxs("span",{className:"vn-cal-dim-end",children:[e.jsx("em",{children:"Arrival"}),Q(t.from)]}),e.jsx("span",{className:"vn-cal-dim-rule is-left"}),e.jsxs("span",{className:"vn-cal-dim-figure",children:[g," ",g===1?"night":"nights"]}),e.jsx("span",{className:"vn-cal-dim-rule is-right"}),e.jsxs("span",{className:"vn-cal-dim-end is-right",children:[e.jsx("em",{children:"Departure"}),Q(E)]})]}):e.jsx("p",{className:"vn-cal-dim-empty",children:t.from?"Now choose the day you leave.":"Choose the day you arrive."})})]})}function ea({onOpen:t}){const[n,r]=h.useState(0);h.useEffect(()=>{if(V())return;const m=window.setInterval(()=>r(j=>(j+1)%te.length),fe);return()=>window.clearInterval(m)},[]);const v=te[n];return e.jsx("a",{className:"vn-hero-tours",href:"#tours",onClick:t,"aria-label":"See example tours",children:e.jsxs("span",{className:"vn-ht-stack",children:[te.map((m,j)=>e.jsx("img",{className:`vn-ht-img ${j===n?"is-on":""}`,src:m.photo.src,srcSet:ee(m.photo.src),sizes:"260px",alt:"",loading:"eager",decoding:"async"},m.name)),e.jsx("span",{className:"vn-ht-veil"}),e.jsx("span",{className:"vn-ht-marks","aria-hidden":"true"}),e.jsx("span",{className:"vn-ht-mat","aria-hidden":"true"}),e.jsx("span",{className:"vn-ht-prog","aria-hidden":"true",children:e.jsx("span",{className:"vn-ht-prog-fill",style:{animationDuration:`${fe}ms`}},n)}),e.jsxs("span",{className:"vn-ht-stamp",children:["Tours · examples",e.jsx("span",{className:"vn-ht-count",children:String(n+1).padStart(2,"0")})]}),e.jsxs("span",{className:"vn-ht-body",children:[e.jsx("span",{className:"vn-ht-place",children:v.place}),e.jsx("span",{className:"vn-ht-name",children:v.name})]},v.name),e.jsx("span",{className:"vn-ht-cta","aria-hidden":"true",children:"→"})]})})}function aa(){const[t,n]=h.useState(""),[r,v]=h.useState(""),[m,j]=h.useState(""),[b,S]=h.useState({from:null,to:null}),[F,p]=h.useState(7),[L,E]=h.useState(""),[C,w]=h.useState(null),[u,T]=h.useState(null),y=h.useMemo(()=>new Date().toISOString().slice(0,10),[]),g=b.from&&b.to?je(b.from,b.to):0;function f(a){if(a.preventDefault(),!b.from||!b.to){w("Choose the day you arrive and the day you leave.");return}if(!t.trim()||!r.trim()){w("A name and an email are needed so the owner can reply.");return}w(null);const l={id:`vn-${Date.now().toString(36)}-${Math.random().toString(36).slice(2,7)}`,resourceId:"villanorth",date:b.from,endDate:b.to,people:F,customer:{name:t.trim(),phone:m.trim(),email:r.trim()},note:L.trim()||void 0,quote:{lines:[],total:0,deposit:0,units:g,estimate:!0},status:"REQUESTED",createdAt:new Date().toISOString()};Te.add(l),T(l)}if(u){const a=u.endDate??u.date;return e.jsxs("div",{className:"vn-book-done",role:"status",children:[e.jsx("p",{className:"vn-book-done-title",children:"Your request is on its way."}),e.jsxs("p",{className:"vn-book-done-body",children:[Q(u.date)," to ",Q(a),", ",u.quote.units," ",u.quote.units===1?"night":"nights",", ",u.people," ",u.people===1?"guest":"guests",". The owner confirms each request personally. The price for your dates comes with the reply to ",u.customer.email,"."]}),e.jsxs("p",{className:"vn-book-note",children:["This is a prototype. The request lives only in this browser."," ",e.jsx(we,{className:"vn-a",to:"/preview/villanorth/stjornbord",children:"See the owner's side"})," ","to watch it arrive."]}),e.jsx("button",{type:"button",className:"vn-ghost",onClick:()=>T(null),children:"Make another request"})]})}return e.jsxs("form",{className:"vn-book-form",onSubmit:f,noValidate:!0,children:[e.jsxs("div",{className:"vn-book-grid",children:[e.jsx(Qe,{stay:b,onChange:S,minDate:y}),e.jsxs("label",{className:"vn-field vn-field-guests",children:[e.jsx("span",{className:"vn-field-label",children:"Guests"}),e.jsx("select",{name:"guests",value:F,onChange:a=>p(Number(a.target.value)),children:[1,2,3,4,5,6,7].map(a=>e.jsx("option",{value:a,children:a},a))})]}),e.jsxs("label",{className:"vn-field vn-field-wide",children:[e.jsx("span",{className:"vn-field-label",children:"Name"}),e.jsx("input",{type:"text",name:"name",autoComplete:"name",value:t,required:!0,onChange:a=>n(a.target.value)})]}),e.jsxs("label",{className:"vn-field vn-field-wide",children:[e.jsx("span",{className:"vn-field-label",children:"Email"}),e.jsx("input",{type:"email",name:"email",autoComplete:"email",inputMode:"email",value:r,required:!0,onChange:a=>v(a.target.value)})]}),e.jsxs("label",{className:"vn-field vn-field-wide",children:[e.jsxs("span",{className:"vn-field-label",children:["Phone ",e.jsx("span",{className:"vn-optional",children:"(optional)"})]}),e.jsx("input",{type:"tel",name:"phone",autoComplete:"tel",inputMode:"tel",value:m,onChange:a=>j(a.target.value)})]}),e.jsxs("label",{className:"vn-field vn-field-wide",children:[e.jsxs("span",{className:"vn-field-label",children:["Anything you would like the owner to know ",e.jsx("span",{className:"vn-optional",children:"(optional)"})]}),e.jsx("textarea",{rows:3,name:"note",value:L,onChange:a=>E(a.target.value)})]})]}),C&&e.jsx("p",{className:"vn-field-error",role:"alert",children:C}),me()?e.jsx("a",{className:"vn-cta vn-cta-block",href:Le({checkin:b.from,checkout:b.to,adults:F}),children:"Continue to secure booking"}):e.jsx("button",{type:"submit",className:"vn-cta vn-cta-block",children:"Enquire about your stay"}),e.jsx("p",{className:"vn-book-note",children:me()?"Your dates carry over. Availability, the exact price and payment are all handled on the secure booking page.":"No payment today. Send your preferred dates and the owner replies with availability and the nightly price. Payment is settled on arrival."})]})}function Sa(){const[t,n]=h.useState(!1),[r,v]=h.useState(B[0].id),[m,j]=h.useState(!1),[b,S]=h.useState(!1),F=h.useRef(null),p=h.useRef([]),L=h.useRef(null),E=h.useRef(null);h.useEffect(()=>{be(ne),document.title="Villa North",n(!0)},[]),h.useEffect(()=>Ne(),[]),De(t),h.useEffect(()=>{if(V())return;const a=[];for(const l of[L,E]){const i=l.current;if(!i)continue;i.muted=!0;const N=()=>{var d;i.muted=!0,(d=i.play())==null||d.catch(()=>{})};i.addEventListener("canplay",N),i.addEventListener("loadeddata",N),N(),a.push(()=>{i.removeEventListener("canplay",N),i.removeEventListener("loadeddata",N)})}return()=>a.forEach(l=>l())},[]);const[C,w]=h.useState(We),[u,T]=h.useState(!1),y=B.find(a=>a.id===r)??B[0],g=a=>l=>{l.preventDefault();const i=()=>{var N;(N=document.getElementById(a))==null||N.scrollIntoView({behavior:V()?"auto":"smooth"}),history.replaceState(null,"",`#${a}`)};if(!u){i();return}T(!1),requestAnimationFrame(()=>requestAnimationFrame(i))};h.useEffect(()=>{if(!u)return;const a=i=>{i.key==="Escape"&&T(!1)},l=document.body.style.overflow;return document.body.style.overflow="hidden",window.addEventListener("keydown",a),()=>{document.body.style.overflow=l,window.removeEventListener("keydown",a)}},[u]);const f=(a,l)=>{var d;if(!["ArrowDown","ArrowUp","ArrowRight","ArrowLeft"].includes(a.key))return;a.preventDefault();const i=a.key==="ArrowDown"||a.key==="ArrowRight"?1:-1,N=(l+i+B.length)%B.length;(d=p.current[N])==null||d.focus()};return e.jsxs("div",{ref:F,className:"vn-root",children:[e.jsx("style",{children:ta}),C&&e.jsx(Ve,{onDone:()=>{w(!1),window.dispatchEvent(new Event("vn:revealed"))}}),e.jsx("script",{type:"application/ld+json",dangerouslySetInnerHTML:{__html:JSON.stringify(Ie)}}),e.jsx(Se,{company:ge}),e.jsxs("header",{className:"vn-nav",children:[e.jsxs("a",{className:"vn-nav-mark",href:"#top",onClick:g("top"),children:[e.jsx("span",{className:"vn-logo-mark","aria-hidden":"true"}),"VILLA NORTH"]}),e.jsxs("nav",{className:"vn-nav-links","aria-label":"Page",children:[e.jsx("a",{href:"#drawing",onClick:g("drawing"),children:"The house"}),e.jsx("a",{href:"#rooms",onClick:g("rooms"),children:"Rooms"}),e.jsx("a",{href:"#gallery",onClick:g("gallery"),children:"Gallery"}),e.jsx("a",{href:"#tours",onClick:g("tours"),children:"Tours"}),e.jsx("a",{href:"#guests",onClick:g("guests"),children:"Guests"})]}),e.jsx("a",{className:"vn-nav-cta",href:"#booking",onClick:g("booking"),children:"Book now"}),e.jsxs("button",{type:"button",className:`vn-burger ${u?"is-open":""}`,"aria-label":u?"Close menu":"Open menu","aria-expanded":u,"aria-controls":"vn-menu",onClick:()=>T(a=>!a),children:[e.jsx("span",{"aria-hidden":"true"}),e.jsx("span",{"aria-hidden":"true"})]})]}),e.jsxs("div",{id:"vn-menu",className:`vn-menu ${u?"is-open":""}`,"aria-hidden":!u,children:[e.jsxs("nav",{className:"vn-menu-links","aria-label":"Sections",children:[e.jsx("a",{href:"#drawing",onClick:g("drawing"),children:"The house"}),e.jsx("a",{href:"#rooms",onClick:g("rooms"),children:"Rooms"}),e.jsx("a",{href:"#gallery",onClick:g("gallery"),children:"Gallery"}),e.jsx("a",{href:"#tours",onClick:g("tours"),children:"Tours"}),e.jsx("a",{href:"#guests",onClick:g("guests"),children:"Guests"}),e.jsx("a",{href:"#contact",onClick:g("contact"),children:"Finding the house"})]}),e.jsx("a",{className:"vn-menu-cta",href:"#booking",onClick:g("booking"),children:"Book now"}),e.jsxs("p",{className:"vn-menu-foot",children:[e.jsx("a",{href:"tel:+3548449808",children:"+354 844 9808"}),e.jsx("a",{href:"mailto:villanorthiceland@gmail.com",children:"villanorthiceland@gmail.com"})]})]}),e.jsxs("section",{className:"vn-hero",id:"top",children:[e.jsx("div",{className:"vn-hero-media vn-rv",children:e.jsx("img",{src:s.aerialSunset.src,srcSet:ee(s.aerialSunset.src),sizes:"100vw",alt:s.aerialSunset.alt,loading:"eager",decoding:"async"})}),e.jsxs("h1",{className:"vn-wordmark","aria-label":"Villa North",children:[e.jsx("span",{className:"vn-wm-rule","aria-hidden":"true"}),e.jsxs("span",{className:"vn-wm-row","aria-hidden":"true",children:[e.jsx("span",{className:"vn-wm-line",children:e.jsx("span",{className:"vn-wm-word",children:"VILLA"})})," ",e.jsx("span",{className:"vn-wm-line",children:e.jsx("span",{className:"vn-wm-word",children:"NORTH"})})]})]}),e.jsxs("div",{className:"vn-hero-block",children:[e.jsx("p",{className:"vn-measure-text",children:"Sleeps 7 · four bedrooms"}),e.jsx("p",{className:"vn-hero-sub",children:"Designed with precision, built for gathering. An engineer's house of glass and dark timber above Fnjóskadalur, made for seven."}),e.jsx("a",{className:"vn-cta",href:"#booking",onClick:g("booking"),children:"Book now"})]}),e.jsx(ea,{onOpen:g("tours")})]}),e.jsxs("section",{className:"vn-drawing",id:"drawing",children:[e.jsxs("div",{className:"vn-drawing-copy",children:[e.jsx(P,{text:"Every angle, decided first.",size:64,floor:32,measure:600}),e.jsx("p",{className:"vn-body vn-rv",children:"The owner trained as an engineer, and every line feels intentional: an asymmetric roofline, long glass on one side and dark timber cladding on the other, cut into a hillside above Fnjóskadalur."})]}),e.jsxs("div",{className:"vn-drawing-inner",children:[e.jsx("div",{className:"vn-elev-svg",children:e.jsxs("svg",{className:"vn-elev",viewBox:"0 0 1200 802",preserveAspectRatio:"xMidYMid slice","aria-hidden":"true",children:[e.jsxs("defs",{children:[e.jsx("pattern",{id:"vnHatch",width:"9",height:"9",patternTransform:"rotate(45)",patternUnits:"userSpaceOnUse",children:e.jsx("line",{x1:"0",y1:"0",x2:"0",y2:"9",stroke:Y,strokeWidth:"1"})}),e.jsx("clipPath",{id:"vnGableClip",children:e.jsx("path",{d:"M572,272 L290,384 L289,660 L607,663 L607,204 Z"})})]}),e.jsx("rect",{className:"vn-elev-hatch",x:"289",y:"204",width:"318",height:"459",fill:"url(#vnHatch)",clipPath:"url(#vnGableClip)"}),e.jsx("path",{className:"vn-elev-secondary",d:"M572,272 L290,384 L289,660 L607,663"}),e.jsx("path",{className:"vn-elev-mullions",d:"M604,459 L983,459 M702,271 L714,660 M877,350 L885,660 M976,390 L989,660"}),e.jsx("path",{className:"vn-elev-line",d:"M570,151 L1030,368 L1033,525 M607,204 L607,663 L983,660"})]})}),e.jsx("div",{className:"vn-elev-photo",children:e.jsx("img",{src:s.glassGrid.src,srcSet:ee(s.glassGrid.src),sizes:"100vw",alt:s.glassGrid.alt,loading:"lazy",decoding:"async"})}),e.jsxs("div",{className:"vn-elev-caps",children:[e.jsx("p",{className:"vn-elev-cap vn-elev-cap-sketch",children:"The elevation, traced from the photograph line for line."}),e.jsx("p",{className:"vn-elev-cap vn-elev-cap-photo",children:"Villa North, Fnjóskadalur valley."})]})]}),e.jsx("p",{className:"vn-elev-credit vn-rv",children:"Traced to the pixel from this exact photograph, the owner's own: the roofline, both posts, the window grid and the ground it stands on."}),e.jsxs("div",{className:"vn-drawing-inside",children:[e.jsxs("div",{className:"vn-drawing-inside-copy",children:[e.jsx("p",{className:"vn-drawing-inside-kicker",children:"Sama þakið, að innan"}),e.jsx("p",{className:"vn-drawing-inside-line",children:"The angle drawn above is the same angle overhead in here. The roofline traced outside is the ceiling line inside."})]}),e.jsx(z,{photo:s.livingTall,className:"vn-drawing-inside-fig",drift:7})]})]}),e.jsxs("section",{className:"vn-valley",id:"valley",children:[e.jsxs("div",{className:"vn-valley-copy",children:[e.jsx(P,{text:"The valley below.",size:56,floor:30,measure:520}),e.jsx("p",{className:"vn-body vn-rv",children:pe.intro}),e.jsx("dl",{className:"vn-draws vn-rv",children:pe.draws.map(a=>e.jsxs("div",{children:[e.jsx("dt",{children:a.name}),e.jsx("dd",{children:a.note})]},a.name))})]}),e.jsxs("div",{className:"vn-valley-figs",children:[e.jsx(z,{photo:s.aerialRiver,className:"vn-valley-main",drift:11}),e.jsxs("div",{className:"vn-valley-duo",children:[e.jsx(z,{photo:s.aerialMist,className:"vn-valley-duo-a",drift:8}),e.jsx(z,{photo:s.aerialSunsetB,className:"vn-valley-duo-b",drift:8})]})]})]}),e.jsx("section",{className:"vn-film",id:"film","aria-label":"Aerial film of the house",children:e.jsxs("div",{className:"vn-film-bleed",children:[e.jsx("img",{src:Z.poster,srcSet:`${Z.posterSmall} 800w, ${Z.poster} 1120w`,sizes:"100vw",alt:s.aerialSunset.alt,loading:"lazy",decoding:"async",className:"vn-film-poster"}),e.jsx("video",{ref:E,className:`vn-film-video ${b?"is-errored":""}`,poster:Z.poster,autoPlay:!V(),muted:!0,loop:!0,playsInline:!0,preload:"metadata","aria-hidden":"true",onError:()=>S(!0),children:e.jsx("source",{src:Z.src,type:"video/mp4"})}),e.jsx("div",{className:"vn-film-caps",children:e.jsx("p",{className:"vn-film-label",children:"Úr lofti"})})]})}),e.jsxs("section",{className:"vn-rooms",id:"rooms",children:[e.jsx(P,{text:"Plan who sleeps where.",size:64,floor:32,measure:620}),e.jsx("p",{className:"vn-body vn-rv",children:"A simple guide to how the villa flows: four bedrooms, the sitting room, the kitchen and the sundeck. Einföld skýringarmynd, ekki í mælikvarða: a schematic, not to scale."}),e.jsx(z,{photo:s.mezzanine,className:"vn-rooms-lead",drift:11}),e.jsxs("div",{className:"vn-rooms-explorer",children:[e.jsx("div",{className:"vn-rooms-index",role:"group","aria-label":"Herbergi",children:B.map((a,l)=>e.jsxs("div",{className:"vn-rooms-index-item",children:[(l===0||B[l-1].level!==a.level)&&e.jsx("p",{className:"vn-rooms-zone-label",children:a.level==="efri"?"Efri hæð (upstairs)":"Neðri hæð (main level)"}),e.jsxs("button",{type:"button",ref:i=>{p.current[l]=i},className:`vn-room-btn ${r===a.id?"is-active":""}`,onMouseEnter:()=>v(a.id),onFocus:()=>v(a.id),onClick:()=>v(a.id),onKeyDown:i=>f(i,l),"aria-pressed":r===a.id,children:[e.jsx("span",{className:"vn-room-btn-label",children:a.label}),e.jsx("span",{className:"vn-room-btn-fact",children:a.fact})]})]},a.id))}),e.jsxs("div",{className:"vn-rooms-pane","aria-live":"polite",children:[e.jsx(z,{photo:y.photo,className:"vn-rooms-pane-frame",sizes:"(max-width: 899px) 100vw, 46vw",drift:8}),e.jsx("p",{className:"vn-rooms-pane-label",children:y.label}),e.jsxs("p",{className:"vn-rooms-pane-fact",children:[y.fact,y.note?` · ${y.note}`:""]}),y.photoNote&&e.jsx("p",{className:"vn-rooms-pane-note",children:y.photoNote})]}),e.jsx("div",{className:"vn-rooms-acc",children:B.map(a=>e.jsxs("div",{className:"vn-rooms-acc-item",children:[e.jsxs("button",{type:"button",className:`vn-rooms-acc-btn ${r===a.id?"is-open":""}`,onClick:()=>v(a.id),"aria-expanded":r===a.id,children:[e.jsx("span",{children:a.label}),e.jsx("span",{className:"vn-rooms-acc-fact",children:a.fact})]}),e.jsx("div",{className:`vn-rooms-acc-panel ${r===a.id?"is-open":""}`,children:e.jsxs("div",{className:"vn-rooms-acc-panel-in",children:[e.jsx(z,{photo:a.photo}),a.note&&e.jsx("p",{className:"vn-rooms-acc-note",children:a.note}),a.photoNote&&e.jsx("p",{className:"vn-rooms-acc-note",children:a.photoNote})]})})]},a.id))})]}),e.jsxs("div",{className:"vn-rooms-bath vn-rv",children:[e.jsx(z,{photo:re.photo,className:"vn-rooms-bath-frame",drift:6}),e.jsxs("div",{children:[e.jsx("p",{className:"vn-rooms-bath-fact",children:re.fact}),e.jsxs("p",{className:"vn-rooms-bath-detail",children:["ATH: ",re.detail]})]})]})]}),e.jsxs("section",{className:"vn-materials",id:"materials",children:[e.jsx(P,{text:"Furnished like the real thing.",size:56,floor:30,measure:560}),e.jsx("p",{className:"vn-body vn-rv",children:K.intro}),e.jsx("ul",{className:"vn-materials-names vn-rv",children:K.names.map(a=>e.jsx("li",{children:a},a))}),e.jsx(Be,{}),e.jsxs("blockquote",{className:"vn-quote-block vn-rv",children:[e.jsxs("p",{children:["“",K.quote.quote,"”"]}),e.jsxs("cite",{children:[K.quote.author,", ",K.quote.when]})]})]}),e.jsxs("section",{className:"vn-glow",id:"glow",children:[e.jsxs("div",{className:"vn-glow-bleed",children:[e.jsx("img",{src:X.poster,srcSet:`${X.posterSmall} 800w, ${X.poster} 1280w`,sizes:"100vw",alt:s.winterNight.alt,loading:"lazy",decoding:"async",className:"vn-glow-poster"}),e.jsx("video",{ref:L,className:`vn-glow-video ${m?"is-errored":""}`,poster:X.poster,autoPlay:!V(),muted:!0,loop:!0,playsInline:!0,preload:"metadata","aria-hidden":"true",onError:()=>j(!0),children:e.jsx("source",{src:X.src,type:"video/mp4"})}),e.jsxs("div",{className:"vn-glow-caps",children:[e.jsx("p",{className:"vn-glow-label",children:"Glóðin"}),e.jsx("p",{className:"vn-glow-cap",children:J.intro})]})]}),e.jsxs("div",{className:"vn-glow-row",children:[e.jsx(z,{photo:s.wineGlasses,className:"vn-glow-wine",ratio:se,sizes:ie,drift:9}),e.jsxs("div",{className:"vn-glow-tub-col",children:[e.jsx(z,{photo:s.tubNightSmall,className:"vn-glow-tub",ratio:se,sizes:ie,drift:6}),e.jsx("p",{className:"vn-glow-fact",children:J.auroraFact})]}),e.jsx(z,{photo:s.winterRiver,className:"vn-glow-river",ratio:se,sizes:ie,drift:7})]}),e.jsxs("blockquote",{className:"vn-quote-block vn-glow-quote vn-rv",children:[e.jsxs("p",{children:["“",J.quote.quote,"”"]}),e.jsxs("cite",{children:[J.quote.author,", ",J.quote.when]})]})]}),e.jsxs("section",{className:"vn-welcome",id:"welcome",children:[e.jsxs("div",{className:"vn-welcome-copy",children:[e.jsx(P,{text:"Ready before you arrive.",size:56,floor:30,measure:520}),e.jsx("p",{className:"vn-body vn-rv",children:ue.intro}),e.jsx("ul",{className:"vn-ritual-list vn-rv",children:ue.items.map(a=>e.jsx("li",{children:a},a))})]}),e.jsxs("div",{className:"vn-welcome-figs",children:[e.jsx(z,{photo:s.kitchenPendants,className:"vn-welcome-main"}),e.jsxs("div",{className:"vn-welcome-duo",children:[e.jsx(z,{photo:s.dining,className:"vn-welcome-duo-a"}),e.jsx(z,{photo:s.livingSofa,className:"vn-welcome-duo-b"})]})]})]}),e.jsxs("section",{className:"vn-gallery",id:"gallery",children:[e.jsxs("div",{className:"vn-gallery-head",children:[e.jsx(P,{text:"The house in pictures.",size:56,floor:30,measure:560}),e.jsx("p",{className:"vn-body vn-rv",children:"Glass, dark timber and the valley, room by room."})]}),e.jsxs("div",{className:"vn-gallery-grid",children:[e.jsx(z,{photo:s.living,className:"vn-g-a",drift:7,ratio:"16 / 10",sizes:"(max-width: 899px) 100vw, 62vw"}),e.jsx(z,{photo:s.bedroom,className:"vn-g-b",drift:6,ratio:"4 / 5",sizes:"(max-width: 899px) 100vw, 31vw"}),e.jsx(z,{photo:s.kitchenDining,className:"vn-g-c",drift:6,ratio:"1 / 1",sizes:"(max-width: 899px) 100vw, 31vw"}),e.jsx(z,{photo:s.bath,className:"vn-g-d",drift:6,ratio:"1 / 1",sizes:"(max-width: 899px) 100vw, 31vw"}),e.jsx(z,{photo:s.bedroomAttic,className:"vn-g-e",drift:6,ratio:"1 / 1",sizes:"(max-width: 899px) 100vw, 31vw"}),e.jsx(z,{photo:s.gridSunset,className:"vn-g-f",drift:9,ratio:"21 / 9",sizes:"100vw"})]})]}),e.jsx("section",{className:"vn-tours",id:"tours",children:e.jsxs("div",{className:"vn-tours-sheet",children:[e.jsxs("p",{className:"vn-tours-stamp","aria-label":"Example section",children:[e.jsx("span",{className:"vn-tours-stamp-a",children:"Example section"}),e.jsx("span",{className:"vn-tours-stamp-b",children:"Tour booking connects here"})]}),e.jsxs("div",{className:"vn-tours-head",children:[e.jsx(P,{text:"Trips from the door.",size:56,floor:30,measure:560}),e.jsx("p",{className:"vn-body vn-rv",children:"The valley is a base as much as a destination. Guests will browse and book tours right here, without leaving the page."})]}),e.jsxs("div",{className:"vn-tours-grid vn-rv",children:[te.map(a=>e.jsx(Pe,{tour:a},a.name)),e.jsxs("div",{className:"vn-tour-plate vn-tour-ghost",children:[e.jsx("span",{className:"vn-tour-ghost-plus","aria-hidden":"true",children:"+"}),e.jsx("p",{className:"vn-tour-ghost-note",children:"The rest land here"})]})]}),e.jsx("p",{className:"vn-tours-foot",children:"The live tours come from TourDesk or Bókun, whichever is chosen. Guests book on the spot and the house earns a commission on every seat."})]})}),e.jsxs("section",{className:"vn-guests",id:"guests",children:[e.jsx(P,{text:"What guests keep saying.",size:64,floor:32,measure:620}),e.jsxs("p",{className:"vn-guests-meta vn-rv",children:[U.rating.toFixed(1)," of 5 across ",U.reviewCount," reviews · ",U.badges.join(" · ")]}),e.jsx("div",{className:"vn-reviews vn-rv",children:Ce.map(a=>e.jsxs("figure",{className:"vn-review",children:[e.jsx("span",{className:"vn-review-rule","aria-hidden":"true"}),e.jsx("blockquote",{className:"vn-review-quote",children:e.jsxs("p",{children:["“",a.quote,"”"]})}),e.jsxs("figcaption",{className:"vn-review-by",children:[e.jsx("span",{className:"vn-review-name",children:a.author}),e.jsx("span",{className:"vn-review-when",children:a.when})]})]},a.author))})]}),e.jsxs("section",{className:"vn-book",id:"booking",children:[e.jsxs("div",{className:"vn-book-intro",children:[e.jsx(P,{text:"Ask for your dates.",size:72,floor:34,measure:560}),e.jsxs("p",{className:"vn-body vn-rv",children:["Requests go straight to ",U.name,", who responds to ",U.responseRate," of messages, usually ",U.respondsWithin,"."]}),e.jsxs("div",{className:"vn-owner-note vn-rv",children:[e.jsx("p",{className:"vn-owner-note-label",children:"The owner's dashboard"}),e.jsxs("p",{className:"vn-owner-note-body",children:["Every request lands in a dashboard built for this house: confirm or decline in one tap, watch requests arrive."," ",e.jsx(we,{className:"vn-a",to:"/preview/villanorth/stjornbord",children:"See how direct bookings could work"})," ","beside this tab and send yourself a request."]})]})]}),e.jsx(aa,{})]}),e.jsxs("section",{className:"vn-contact",id:"contact",children:[e.jsxs("div",{className:"vn-contact-copy",children:[e.jsx(P,{text:"Finding the house.",size:56,floor:30,measure:520}),e.jsxs("dl",{className:"vn-contact-list vn-rv",children:[e.jsxs("div",{children:[e.jsx("dt",{children:"Where"}),e.jsx("dd",{children:"Fnjóskadalur, Þingeyjarsveit, North Iceland"})]}),e.jsxs("div",{children:[e.jsx("dt",{children:"From Akureyri"}),e.jsx("dd",{children:"Fifteen to twenty minutes through Vaðlaheiðargöng"})]}),e.jsxs("div",{children:[e.jsx("dt",{children:"Phone"}),e.jsx("dd",{children:e.jsx("a",{className:"vn-a",href:"tel:+3548449808",children:"+354 844 9808"})})]}),e.jsxs("div",{children:[e.jsx("dt",{children:"Email"}),e.jsx("dd",{children:e.jsx("a",{className:"vn-a",href:"mailto:villanorthiceland@gmail.com",children:"villanorthiceland@gmail.com"})})]})]})]}),e.jsxs("div",{className:"vn-contact-map vn-rv",children:[e.jsx("iframe",{title:"Map of Fnjóskadalur, North Iceland",src:"https://www.google.com/maps?q=Fnj%C3%B3skadalur%2C%20%C3%9Eingeyjarsveit&z=10&output=embed",loading:"lazy",referrerPolicy:"no-referrer-when-downgrade",allowFullScreen:!0}),e.jsx("p",{className:"vn-map-cap",children:"Fnjóskadalur — the valley east of Akureyri."})]})]}),e.jsxs("footer",{className:"vn-foot",children:[e.jsxs("div",{className:"vn-foot-hero",children:[e.jsx("p",{className:"vn-foot-wordmark","aria-hidden":"true",children:"VILLA NORTH"}),e.jsx("a",{className:"vn-cta",href:"#booking",onClick:g("booking"),children:"Book now"})]}),e.jsxs("div",{className:"vn-foot-grid",children:[e.jsxs("div",{children:[e.jsx("p",{className:"vn-foot-label",children:"Find us"}),e.jsx("p",{className:"vn-foot-line",children:"Fnjóskadalur, Þingeyjarsveit, North Iceland"}),e.jsx("p",{className:"vn-foot-line",children:e.jsx("a",{className:"vn-foot-a",href:"tel:+3548449808",children:"+354 844 9808"})}),e.jsx("p",{className:"vn-foot-line",children:e.jsx("a",{className:"vn-foot-a",href:"mailto:villanorthiceland@gmail.com",children:"villanorthiceland@gmail.com"})})]}),e.jsxs("div",{children:[e.jsx("p",{className:"vn-foot-label",children:"The house"}),e.jsxs("p",{className:"vn-foot-line",children:["Guests ",W.guests," · ",W.bedrooms," bedrooms · ",W.beds," beds · ",W.baths," bathrooms"]}),e.jsxs("p",{className:"vn-foot-line",children:["Check-in ",W.checkIn]}),e.jsxs("p",{className:"vn-foot-line",children:["Check-out ",W.checkOut]})]}),e.jsxs("div",{children:[e.jsx("p",{className:"vn-foot-label",children:"Good to know"}),e.jsx("p",{className:"vn-foot-line",children:W.security}),e.jsx("p",{className:"vn-foot-line",children:W.water}),e.jsx("p",{className:"vn-foot-line",children:"Washer and dryer are outside the main house"})]})]}),e.jsxs("div",{className:"vn-foot-base",children:[e.jsx("p",{className:"vn-foot-line",children:"© 2026 Villa North"}),e.jsx("a",{className:"vn-foot-a vn-foot-sndr",href:"https://sndr-studio.pages.dev",target:"_blank",rel:"noopener",children:"Designed by SNDR Studio"})]})]}),e.jsx(Ee,{company:ge})]})}const ta=`
@font-face { font-family: 'Apfel Grotezk'; src: url('${D}fonts/apfel-grotezk/ApfelGrotezk-Regular.woff2') format('woff2'); font-weight: 400; font-display: swap; }
@font-face { font-family: 'Apfel Grotezk'; src: url('${D}fonts/apfel-grotezk/ApfelGrotezk-Mittel.woff2') format('woff2'); font-weight: 500; font-display: swap; }
@font-face { font-family: 'Apfel Grotezk'; src: url('${D}fonts/apfel-grotezk/ApfelGrotezk-Fett.woff2') format('woff2'); font-weight: 700; font-display: swap; }
@font-face { font-family: 'Onest'; src: url('${D}fonts/onest/Onest-Regular.woff2') format('woff2'); font-weight: 400; font-display: swap; }
@font-face { font-family: 'Onest'; src: url('${D}fonts/onest/Onest-Medium.woff2') format('woff2'); font-weight: 500; font-display: swap; }
@font-face { font-family: 'Onest'; src: url('${D}fonts/onest/Onest-Bold.woff2') format('woff2'); font-weight: 700; font-display: swap; }
@font-face { font-family: 'Azeret Mono'; src: url('${D}fonts/azeret-mono/AzeretMono-Regular.woff2') format('woff2'); font-weight: 400; font-display: swap; }
@font-face { font-family: 'Azeret Mono'; src: url('${D}fonts/azeret-mono/AzeretMono-Medium.woff2') format('woff2'); font-weight: 500; font-display: swap; }
...
.vn-root ::selection { background: var(--vn-amber); color: ${Y}; }
...
.vn-nav-mark {
  font-family: ${O}; font-weight: 700; letter-spacing: .06em; text-decoration: none;
...
.vn-menu-links a {
  ...
  font-family: ${O}; font-weight: 700; letter-spacing: -.01em;
...
.vn-wordmark {
  ...
  color: #F5F4F1;
  font-family: ${O}; font-weight: 700; letter-spacing: .05em;
...
/* shared text */
.vn-headline {
  margin: 0; font-family: ${O}; font-weight: 700; letter-spacing: -.01em;
...
.vn-elev-cap { grid-area: 1 / 1; margin: 0; font-family: ${O}; font-weight: 500; font-size: ${o(22,16)}; }
...
.vn-drawing-inside-line {
  font-family: ${O}; font-weight: 500; font-size: ${o(23,18)}; line-height: 1.4; margin: 0;
}
...
.vn-rooms-pane-label { font-family: ${O}; font-weight: 500; font-size: ${o(20,17)}; margin: calc(var(--u) * 20) 0 0; }
...
.vn-glow-bleed { position: relative; aspect-ratio: 21 / 9; overflow: hidden; background: ${H}; }
...
.vn-glow-cap { margin: 0; font-family: ${O}; font-weight: 500; font-size: ${o(24,17)}; line-height: 1.3; }
.vn-glow-row {
...
.vn-review-quote p {
  margin: 0; font-family: ${O}; font-weight: 500;
...
.vn-review-by {
  ...
  font-family: ${c}; font-size: 11px; letter-spacing: .06em;
}
...
.vn-book-done-title { margin: 0; font-family: ${O}; font-weight: 700; font-size: ${o(30,21)}; }
...
.vn-film-bleed { position: relative; aspect-ratio: 21 / 9; overflow: hidden; background: ${H}; }
...
.vn-logo-mark {
  ...
  background: currentColor;
  -webkit-mask: url('${D}villanorth/logo-mark.png') center / contain no-repeat;
  mask: url('${D}villanorth/logo-mark.png') center / contain no-repeat;
}
...
.vn-ht-stack { position: relative; display: block; aspect-ratio: 4 / 5; overflow: hidden; background: ${H}; }
...
.vn-ht-stamp {
  ...
  font-family: ${c}; font-size: 10px; letter-spacing: .16em; text-transform: uppercase;
  color: #F2F1EE;
}
...
.vn-ht-place { font-family: ${c}; font-size: 10px; letter-spacing: .16em; text-transform: uppercase; color: #F2F1EE; margin-bottom: calc(var(--u) * 6); }
.vn-ht-name { display: block; font-family: ${O}; font-weight: 700; font-size: ${o(17,15)}; line-height: 1.15; color: #F2F1EE; }
.vn-ht-cta {
...
.vn-hero-tours:hover .vn-ht-cta {
  background: #F2F1EE; border-color: #F2F1EE; color: ${H}; transform: translateX(3px);
}
...
.vn-tour-name { display: block; font-family: ${O}; font-weight: 700; font-size: ${o(19,16)}; line-height: 1.15; }
...
.vn-tour-ghost-plus { font-family: ${c}; font-size: ${o(22,20)}; line-height: 1; color: var(--vn-mute); }
.vn-tour-ghost-note { margin: 0; font-family: ${c}; font-size: 11px; letter-spacing: .04em; color: var(--vn-mute); }
...
.vn-foot-wordmark {
  margin: 0; font-family: ${O}; font-weight: 700; line-height: .96;
...
.vn-loader {
  position: fixed; inset: 0; z-index: 60; background: ${ne};
...
.vn-loader-mark {
  margin: 0; font-family: ${O}; font-weight: 700; letter-spacing: .05em;
  font-size: clamp(30px, 7.2vw, 108px); white-space: nowrap; line-height: 1;
  background-image: linear-gradient(90deg, ${Y} 50%, rgba(23,24,26,.14) 50%);
