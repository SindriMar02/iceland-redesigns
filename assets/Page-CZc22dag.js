...
.vn-nav-mark {
  ...
  font-size: ${r(16,15)}; color: inherit;
}
.vn-nav-links { display: flex; gap: calc(var(--u) * 28); margin-left: auto; }
.vn-nav-links a {
  text-decoration: none; font-size: ${r(14,15)}; color: inherit;
  opacity: .72; transition: opacity .25s ease;
}
.vn-nav-links a:hover { opacity: 1; }
.vn-nav-cta {
  text-decoration: none; font-size: ${r(14,15)}; font-weight: 500;
...
.vn-measure-text {
  margin: 0; font-family: ${c}; font-weight: 500; font-size: ${r(15,13)};
  letter-spacing: .04em; color: #F2F1EE;
}
.vn-hero-sub {
  margin: calc(var(--u) * 22) 0 0; font-size: ${r(18,15)}; line-height: 1.55;
...
.vn-cta {
  ...
  font-weight: 500; font-size: ${r(15,13)}; text-decoration: none;
...
.vn-body {
  font-size: ${r(17,15)}; line-height: 1.6; font-weight: 400;
  color: var(--vn-mute); max-width: 58ch; margin: calc(var(--u) * 24) 0 0;
}
.vn-stat { font-family: ${c}; font-size: ${r(12,12)}; color: var(--vn-mute); margin: calc(var(--u) * 14) 0 0; }
.vn-a { color: inherit; }
.vn-quote-block { max-width: 60ch; margin: calc(var(--u) * 40) 0 0; }
.vn-quote-block p { margin: 0; font-size: ${r(20,16)}; line-height: 1.45; font-weight: 400; }
.vn-quote-block cite {
  display: block; font-style: normal; font-family: ${c}; font-size: ${r(12,12)};
...
.vn-elev-cap { grid-area: 1 / 1; margin: 0; font-family: ${D}; font-weight: 500; font-size: ${r(22,16)}; }
...
.vn-elev-credit {
  font-family: ${c}; font-size: ${r(12,12)}; color: var(--vn-mute); line-height: 1.6;
...
.vn-drawing-inside-kicker {
  font-family: ${c}; font-size: ${r(11,12)}; letter-spacing: .12em; text-transform: uppercase;
  color: var(--vn-amber-text); margin: 0 0 calc(var(--u) * 14);
}
.vn-drawing-inside-line {
  font-family: ${D}; font-weight: 500; font-size: ${r(23,18)}; line-height: 1.4; margin: 0;
}
...
.vn-draws dt { font-weight: 500; font-size: ${r(15,14)}; }
.vn-draws dd { margin: 0; font-size: ${r(14,13)}; color: var(--vn-mute); line-height: 1.5; }
...
.vn-room-btn-label { font-weight: 500; font-size: ${r(16,15)}; }
.vn-room-btn-fact { font-family: ${c}; font-size: ${r(12,12)}; color: var(--vn-mute); }
.vn-room-btn.is-active .vn-room-btn-label { color: var(--vn-amber-text); }
.vn-rooms-pane { display: block; }
.vn-rooms-pane-frame { width: 100%; }
.vn-rooms-pane-label { font-family: ${D}; font-weight: 500; font-size: ${r(20,17)}; margin: calc(var(--u) * 20) 0 0; }
.vn-rooms-pane-fact { font-size: ${r(15,14)}; color: var(--vn-mute); margin: calc(var(--u) * 8) 0 0; line-height: 1.5; }
.vn-rooms-pane-note { font-family: ${c}; font-size: ${r(12,12)}; color: var(--vn-mute); margin: calc(var(--u) * 10) 0 0; }
...
.vn-rooms-bath-fact { font-weight: 500; font-size: ${r(16,15)}; margin: 0; }
.vn-rooms-bath-detail { font-size: ${r(14,13)}; color: var(--vn-mute); margin: calc(var(--u) * 8) 0 0; line-height: 1.5; max-width: 46ch; }
...
.vn-materials-names {
  ...
  border-top: 1px solid var(--vn-hair); font-family: ${c}; font-size: ${r(15,13)}; letter-spacing: .04em;
}
...
.vn-mat-label {
  ...
  font-family: ${c}; font-size: ${r(13,12)}; color: #F2F1EE; white-space: nowrap;
...
.vn-glow-label { font-family: ${c}; font-size: ${r(12,12)}; letter-spacing: .16em; text-transform: uppercase; color: #D9A968; margin: 0 0 calc(var(--u) * 10); }
.vn-glow-cap { margin: 0; font-family: ${D}; font-weight: 500; font-size: ${r(24,17)}; line-height: 1.3; }
.vn-glow-row {
...
.vn-glow-fact { font-family: ${c}; font-size: ${r(12,12)}; color: var(--vn-mute); margin: 0; max-width: 26ch; }
...
.vn-ritual-list li {
  font-family: ${c}; font-size: ${r(14,13)}; padding: calc(var(--u) * 10) 0; border-top: 1px solid var(--vn-hair);
}
...
.vn-guests-meta { font-family: ${c}; font-size: ${r(13,12)}; color: var(--vn-mute); margin: calc(var(--u) * 20) 0 0; }
...
.vn-mq-card blockquote p { margin: 0; font-size: ${r(17,15)}; line-height: 1.5; }
.vn-mq-card figcaption { font-family: ${c}; font-size: ${r(11,11)}; letter-spacing: .06em; color: var(--vn-mute); }
.vn-mq-stat { justify-content: center; align-items: flex-start; width: calc(var(--u) * 210); }
.vn-mq-stat-n { margin: 0; font-family: ${c}; font-variant-numeric: tabular-nums; font-size: ${r(40,30)}; line-height: 1; color: var(--vn-amber-text); }
.vn-mq-stat-l { margin: 0; font-size: ${r(13,12)}; line-height: 1.45; color: var(--vn-mute); max-width: 16ch; }
.vn-themes {
...
.vn-themes dt { font-size: ${r(14,13)}; color: var(--vn-mute); }
.vn-themes dd { margin: 0; font-variant-numeric: tabular-nums; font-family: ${c}; font-size: ${r(26,19)}; }
...
.vn-field-label { font-family: ${c}; font-size: ${r(11,12)}; letter-spacing: .1em; text-transform: uppercase; color: var(--vn-mute); }
...
.vn-field-error { color: #A5462F; font-size: ${r(14,13)}; margin: calc(var(--u) * 16) 0 0; }
...
.vn-cal-title {
  font-family: ${c}; font-size: ${r(11,11)}; letter-spacing: .1em; text-transform: uppercase;
...
.vn-cal-day {
  ...
  font-family: ${c}; font-size: ${r(13,13)}; font-variant-numeric: tabular-nums;
...
.vn-cal-dim-end { font-family: ${c}; font-size: ${r(13,12)}; font-variant-numeric: tabular-nums; }
...
.vn-cal-dim-figure {
  font-family: ${c}; font-size: ${r(12,12)}; letter-spacing: .06em;
  text-transform: uppercase; color: var(--vn-amber-text); white-space: nowrap;
}
.vn-cal-dim-empty { margin: 0; grid-column: 1 / -1; font-size: ${r(13,13)}; color: var(--vn-mute); }

.vn-owner-note { margin-top: calc(var(--u) * 44); padding-top: calc(var(--u) * 22); border-top: 1px solid var(--vn-hair); }
.vn-owner-note-label { font-family: ${c}; font-size: ${r(11,12)}; letter-spacing: .12em; text-transform: uppercase; color: var(--vn-amber-text); margin: 0 0 calc(var(--u) * 10); }
.vn-owner-note-body { font-size: ${r(14,13)}; line-height: 1.6; color: var(--vn-mute); margin: 0; max-width: 44ch; }
.vn-book-note { font-size: ${r(13,12)}; line-height: 1.6; color: var(--vn-mute); margin: calc(var(--u) * 16) 0 0; }
.vn-book-done-title { margin: 0; font-family: ${D}; font-weight: 700; font-size: ${r(30,21)}; }
.vn-book-done-body { margin: calc(var(--u) * 16) 0 0; line-height: 1.6; font-size: ${r(16,14)}; }
.vn-ghost {
  margin-top: calc(var(--u) * 22); font: inherit; font-size: ${r(14,13)}; font-weight: 500; cursor: pointer;
...
.vn-film-label { margin: 0; font-family: ${c}; font-size: ${r(11,11)}; letter-spacing: .14em; text-transform: uppercase; color: #F2F1EE; }
...
.vn-logo-mark {
  ...
  -webkit-mask: url('${C}villanorth/logo-mark.png') center / contain no-repeat;
  mask: url('${C}villanorth/logo-mark.png') center / contain no-repeat;
}
...
.vn-ht-name { display: block; font-family: ${D}; font-weight: 700; font-size: ${r(16,15)}; }
.vn-ht-note { display: block; margin-top: 3px; font-size: ${r(12,12)}; line-height: 1.5; color: rgba(242, 241, 238, .72); }
...
.vn-tour-name { margin: 0; font-family: ${D}; font-weight: 700; font-size: ${r(19,16)}; }
.vn-tour-note { margin: calc(var(--u) * 8) 0 0; color: var(--vn-mute); font-size: ${r(13.5,13)}; line-height: 1.55; }
.vn-tour-tag {
...
.vn-tour-ghost-plus { margin: 0; font-family: ${c}; font-size: ${r(22,20)}; line-height: 1; color: var(--vn-mute); }
...
.vn-contact-list dt { font-family: ${c}; font-size: ${r(11,11)}; letter-spacing: .12em; text-transform: uppercase; color: var(--vn-mute); }
.vn-contact-list dd { margin: 0; font-size: ${r(16,15)}; line-height: 1.55; }
...
.vn-map-cap { margin: calc(var(--u) * 12) 0 0; font-family: ${c}; font-size: ${r(11,11)}; color: var(--vn-mute); letter-spacing: .04em; }
...
.vn-foot-label {
  margin: 0 0 calc(var(--u) * 14); font-family: ${c}; font-size: ${r(11,11)};
  letter-spacing: .14em; text-transform: uppercase; color: var(--vn-amber);
}
.vn-foot-line { font-size: ${r(13.5,14)}; line-height: 1.65; color: rgba(242, 241, 238, .66); margin: 0 0 calc(var(--u) * 6); }
...
.vn-foot-sndr { font-size: ${r(12.5,13)}; }
