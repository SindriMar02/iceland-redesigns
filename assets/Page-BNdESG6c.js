...
.vn-root ::selection { background: var(--vn-amber); color: ${Q}; }
...
.vn-menu-cta {
  ...
  background: var(--vn-amber); color: ${Q};
...
.vn-loader-mark {
  ...
  background-image: linear-gradient(90deg, ${Q} 50%, rgba(23,24,26,.14) 50%);
