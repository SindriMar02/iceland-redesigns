...
.vn-menu-foot {
  ...
  font-family: ${p}; font-size: 12px; letter-spacing: .04em;
}
...
.vn-measure-text {
  margin: 0; font-family: ${p}; font-weight: 500; font-size: ${o(15,13)};
...
.vn-stat { font-family: ${p}; font-size: ${o(12,12)}; color: var(--vn-mute); margin: calc(var(--u) * 14) 0 0; }
.vn-a { color: inherit; }
...
.vn-quote-block cite {
  display: block; font-style: normal; font-family: ${p}; font-size: ${o(12,12)};
...
.vn-elev-credit {
  font-family: ${p}; font-size: ${o(12,12)}; color: var(--vn-mute); line-height: 1.6;
...
.vn-drawing-inside-kicker {
  font-family: ${p}; font-size: ${o(11,12)}; letter-spacing: .12em; text-transform: uppercase;
...
.vn-room-btn-fact { font-family: ${p}; font-size: ${o(12,12)}; color: var(--vn-mute); }
...
.vn-rooms-pane-note { font-family: ${p}; font-size: ${o(12,12)}; color: var(--vn-mute); margin: calc(var(--u) * 10) 0 0; }
...
.vn-materials-names {
  ...
  border-top: 1px solid var(--vn-hair); font-family: ${p}; font-size: ${o(15,13)}; letter-spacing: .04em;
}
...
.vn-mat-label {
  ...
  font-family: ${p}; font-size: ${o(13,12)}; color: #F2F1EE; white-space: nowrap;
...
.vn-glow-label { font-family: ${p}; font-size: ${o(12,12)}; letter-spacing: .16em; text-transform: uppercase; color: #D9A968; margin: 0 0 calc(var(--u) * 10); }
...
.vn-glow-fact { font-family: ${p}; font-size: ${o(12,12)}; color: var(--vn-mute); margin: 0; max-width: 26ch; }
...
.vn-ritual-list li {
  font-family: ${p}; font-size: ${o(14,13)}; padding: calc(var(--u) * 10) 0; border-top: 1px solid var(--vn-hair);
}
...
.vn-guests-meta { font-family: ${p}; font-size: ${o(13,12)}; color: var(--vn-mute); margin: calc(var(--u) * 20) 0 0; }
...
.vn-review-by {
  ...
  font-family: ${p}; font-size: 11px; letter-spacing: .06em;
}
...
.vn-themes dd { margin: 0; font-variant-numeric: tabular-nums; font-family: ${p}; font-size: ${o(26,19)}; }
...
.vn-field-label { font-family: ${p}; font-size: ${o(11,12)}; letter-spacing: .1em; text-transform: uppercase; color: var(--vn-mute); }
...
.vn-cal-title {
  font-family: ${p}; font-size: ${o(11,11)}; letter-spacing: .1em; text-transform: uppercase;
  color: var(--vn-ink); margin: 0 0 calc(var(--u) * 10);
}
.vn-cal-dows, .vn-cal-grid { display: grid; grid-template-columns: repeat(7, 1fr); }
.vn-cal-dow {
  font-family: ${p}; font-size: 10px; letter-spacing: .06em; text-align: center;
...
.vn-cal-day {
  ...
  font-family: ${p}; font-size: ${o(13,13)}; font-variant-numeric: tabular-nums;
...
.vn-cal-dim-end { font-family: ${p}; font-size: ${o(13,12)}; font-variant-numeric: tabular-nums; }
...
.vn-cal-dim-figure {
  font-family: ${p}; font-size: ${o(12,12)}; letter-spacing: .06em;
...
.vn-owner-note-label { font-family: ${p}; font-size: ${o(11,12)}; letter-spacing: .12em; text-transform: uppercase; color: var(--vn-amber-text); margin: 0 0 calc(var(--u) * 10); }
...
.vn-film-label { margin: 0; font-family: ${p}; font-size: ${o(11,11)}; letter-spacing: .14em; text-transform: uppercase; color: #F2F1EE; }
...
.vn-ht-stamp {
  ...
  font-family: ${p}; font-size: 10px; letter-spacing: .16em; text-transform: uppercase;
  color: #F2F1EE;
}
...
.vn-ht-place { font-family: ${p}; font-size: 10px; letter-spacing: .16em; text-transform: uppercase; color: #F2F1EE; margin-bottom: calc(var(--u) * 6); }
...
.vn-tour-ghost-plus { font-family: ${p}; font-size: ${o(22,20)}; line-height: 1; color: var(--vn-mute); }
.vn-tour-ghost-note { margin: 0; font-family: ${p}; font-size: 11px; letter-spacing: .04em; color: var(--vn-mute); }
...
.vn-contact-list dt { font-family: ${p}; font-size: ${o(11,11)}; letter-spacing: .12em; text-transform: uppercase; color: var(--vn-mute); }
...
.vn-map-cap {
  ...
  font-family: ${p}; font-size: ${o(11,11)}; letter-spacing: .06em; color: rgba(242, 241, 238, .92);
}
...
.vn-foot-label {
  margin: 0 0 calc(var(--u) * 14); font-family: ${p}; font-size: ${o(11,11)};
...
@media (max-width: 767px) {
  ...
  .vn-rooms-acc-fact { font-family: ${p}; font-size: 12px; color: var(--vn-mute); }
...
.vn-loader-pct {
  ...
  margin: 0; font-family: ${p}; font-size: 12px; letter-spacing: .16em;
