import{r as c,j as e,L as z,s as Ee}from"./index-Dc_HgAJ6.js";import{u as ye,I as E,H as I,E as n,G as l,D as g,a as y,b as u,c as h,O as le,d as T,i as xe,f as Re,B as C,S as Le,e as We,g as N,h as X,F as k,j,A as ne,k as Ae,L as q,T as ce,l as U,m as se,n as A,o as Me,P as He,M as K,p as B,q as Fe,C as Oe,r as Pe,s as _e,t as De}from"./useLang-BwEY5Ny_.js";import"./image-url.umd-CbtHGZ2C.js";const Be=typeof window>"u"?c.useEffect:c.useLayoutEffect,Ge=`
  ...
  .rb-tease-card { display:flex; flex-direction:column; gap:7px; text-decoration:none;
    ...
    overflow:hidden;
    transition:border-color .24s ${n}, background .24s ${n}, transform .2s ${n}; }
  ...
  .rb-tease-pic img { width:100%; height:100%; object-fit:cover; display:block;
    filter:saturate(.96) brightness(.92); transition:transform .55s ${n}, filter .4s ${n}; }
  ...
  .rb-tease-name { font-family:${g}; font-size:clamp(20px,2.1vw,25px); color:${y}; line-height:1.15;
    transition:color .24s ${n}; }
  .rb-tease-card:hover .rb-tease-name { color:${u}; }
  .rb-tease-from { font-size:12.5px; color:${h}; font-variant-numeric:tabular-nums; }
  .rb-tease-blurb { font-size:13.5px; color:${h}; line-height:1.5; margin-top:2px; }

  .rb-tease-foot { display:flex; align-items:center; gap:18px; flex-wrap:wrap;
    margin-top:clamp(26px,4vh,36px); }
  .rb-tease-note { font-size:13.5px; color:${h}; line-height:1.55; max-width:44ch; }
...
`;function Ye(t){if(t<=3)return Math.max(t,1);for(const s of[3,2,4])if(t%s!==1)return s;return 3}function qe({lang:t,orderPath:s}){const r=le[t],{ORDER_PRODUCTS:i}=ye(),b=Ye(i.length);return e.jsxs("section",{id:"order",style:{background:E,padding:"clamp(80px,11vh,140px) clamp(20px,4.5vw,72px)"},children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:Ge}}),e.jsxs("div",{style:{maxWidth:1180,margin:"0 auto"},children:[e.jsx("div",{"data-reveal":!0,style:{borderTop:`1px solid ${I}`,paddingTop:16},children:e.jsxs("div",{style:{maxWidth:640},children:[e.jsx("div",{style:{fontSize:12,fontWeight:700,letterSpacing:".24em",textTransform:"uppercase",color:l},children:r.kicker}),e.jsx("h2",{style:{fontFamily:g,fontWeight:400,fontSize:"clamp(34px,4.6vw,62px)",lineHeight:1.03,margin:"18px 0 0",...T},children:r.title}),e.jsx("p",{style:{fontSize:16,color:h,margin:"16px 0 0",lineHeight:1.65},children:r.intro})]})}),e.jsx("div",{className:"rb-tease-grid",style:{"--tease-cols":String(b)},children:i.map(d=>e.jsxs(z,{to:`${s}?vara=${d.id}`,className:"rb-tease-card",children:[d.image&&e.jsx("span",{className:"rb-tease-pic",children:e.jsx("img",{src:d.image,alt:"",loading:"lazy",decoding:"async",width:1400,height:1050})}),e.jsx("span",{className:"rb-tease-name",children:d.name[t]}),e.jsx("span",{className:"rb-tease-from",children:d.pricePerPerson?`${xe(d.pricePerPerson)} ${r.perPerson}`:`${t==="is"?"frá":"from"} ${xe(Re(d))}`}),e.jsx("span",{className:"rb-tease-blurb",children:d.blurb[t]})]},d.id))}),e.jsxs("div",{className:"rb-tease-foot",children:[e.jsx(z,{to:s,className:"rb-cta rb-cta-gold",children:r.teaseCta}),e.jsx("span",{className:"rb-tease-note",children:r.teaseNote})]})]})]})}const Ue=`
  ...
  .rb-map-tab { flex:1; min-height:44px; padding:10px 12px; cursor:pointer; font-family:${C};
    font-size:13px; letter-spacing:.04em; color:${h}; background:transparent;
    border:1px solid rgba(238,211,170,.16); border-radius:4px;
    transition:color .22s ${n}, border-color .22s ${n}, background .22s ${n}; }
  .rb-map-tab:hover { color:${y}; border-color:rgba(238,211,170,.36); }
  .rb-map-tab[aria-selected="true"] { color:${u}; border-color:${l}; background:rgba(200,168,119,.09); }
  ...
  .rb-map-addr { font-size:13.5px; color:${h}; line-height:1.5; }
  .rb-map-open { margin-left:auto; font-size:13.5px; color:${u}; text-decoration:none;
    ...
    border-bottom:1px solid rgba(238,211,170,.32); transition:color .2s ${n}, border-color .2s ${n}; }
...
`;function Ke({lang:t,locations:s}){const[r,i]=c.useState(0),b=s[r]??s[0];if(!b)return null;const d=`https://maps.google.com/maps?q=${encodeURIComponent(b.query)}&z=15&output=embed&hl=${t}`,x=`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(b.query)}`;return e.jsxs("div",{className:"rb-map",children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:Ue}}),s.length>1&&e.jsx("div",{className:"rb-map-switch",role:"tablist","aria-label":t==="is"?"Veldu stað":"Choose a location",children:s.map(($,M)=>e.jsx("button",{type:"button",role:"tab","aria-selected":M===r,className:"rb-map-tab",onClick:()=>i(M),children:$.address.split(",")[0]},$.address))}),e.jsx("div",{className:"rb-map-frame",children:e.jsx("div",{className:"rb-map-inner",children:e.jsx("iframe",{src:d,title:`${t==="is"?"Kort":"Map"}: ${b.address}`,loading:"lazy",referrerPolicy:"no-referrer-when-downgrade",allowFullScreen:!0},b.query)})}),e.jsxs("div",{className:"rb-map-meta",children:[e.jsx("span",{className:"rb-map-addr",children:b.address}),e.jsxs("a",{className:"rb-map-open",href:x,target:"_blank",rel:"noreferrer",children:[t==="is"?"Opna í Google kortum":"Open in Google Maps",e.jsx("svg",{width:"11",height:"11",viewBox:"0 0 11 11",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M3 1h7v7M10 1L1 10",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round",strokeLinejoin:"round"})})]})]})]})}const Ve=440,Xe=`
  /* ── paper grain ────────────────────────────────────────────────────────
  ...
  .rb-enter  { animation:rb-rise .9s ${n} both; }
  .rb-enter-2 { animation:rb-rise .9s ${n} .14s both; }
  .rb-enter-3 { animation:rb-rise .9s ${n} .26s both; }
  .rb-enter-4 { animation:rb-rise .9s ${n} .38s both; }
  ...
  .rb-break-img { animation:rb-break-zoom 12s ${n} both; }
  ...
  .rb-intro-tip { position:absolute; top:50%; left:0; width:11px; height:11px; margin:-5.5px 0 0 -5.5px;
    ...
    background:radial-gradient(circle, ${u} 0%, ${l} 52%, transparent 74%);
  ...
  .rb-navlink { color:${h}; text-decoration:none; font-size:14.5px;
    transition:color .2s ${n}; }
  .rb-navlink:hover, .rb-navlink:focus-visible { color:${u}; font-style:italic; }
  ...
  .rb-sticky-cta { display:inline-flex; align-items:center; gap:9px; text-decoration:none;
    ...
    transition:background .2s ${n}, transform .15s ${n}; }
  .rb-sticky-cta:hover { background:${u}; }
  ...
  .rb-cta {
    ...
    transition:background .25s ${n}, color .25s ${n}, border-color .25s ${n}, transform .18s ${n};
  }
  ...
  .rb-lang { background:none; border:none; cursor:pointer; padding:14px 13px; margin:-14px -13px; font-family:${C};
    font-size:13px; letter-spacing:.08em; color:${k}; transition:color .2s ${n}; border-radius:4px; }
  ...
  .rb-burger-line { position:absolute; left:12px; width:20px; height:1.5px; background:${y};
    border-radius:2px; transition:transform .4s ${n}, opacity .2s ${n}, background .2s ${n}; }
  .rb-burger-line:nth-child(1) { transform:translateY(-6px); }
  .rb-burger-line:nth-child(3) { transform:translateY(6px); }
  .rb-burger[aria-expanded="true"] .rb-burger-line { background:${u}; }
  ...
  .rb-menu { position:fixed; inset:0; z-index:300; display:flex; flex-direction:column;
    ...
    transition:opacity .42s ${n}, visibility 0s linear .42s; }
  .rb-menu[data-open="true"] { opacity:1; visibility:visible; transition:opacity .42s ${n}, visibility 0s; }
  ...
  .rb-menu-link { position:relative; display:block; text-decoration:none;
    ...
    transition:opacity .5s ${n}, transform .5s ${n}; }
  ...
  .rb-menu-num { font-family:${C}; font-size:11px; letter-spacing:.16em; color:${k};
  ...
  .rb-menu-foot { padding:clamp(18px,3vh,26px) clamp(22px,6vw,72px) calc(clamp(20px,3vh,30px) + env(safe-area-inset-bottom));
    ...
    opacity:0; transform:translateY(10px); transition:opacity .45s ${n} .34s, transform .45s ${n} .34s; }
  ...
  .rb-menu-cta { display:block; text-align:center; text-decoration:none; background:${l};
    ...
    padding:15px 24px; border-radius:3px; transition:background .2s ${n}, transform .15s ${n}; }
  ...
  .rb-foot-link { color:${h}; text-decoration:none; transition:color .2s ${n}; }
  .rb-foot-link:hover { color:${u}; }

  .rb-cover-art { position:absolute; top:50%; right:clamp(-30px,0vw,20px); transform:translateY(-50%);
    width:clamp(300px,40vw,${Ve}px); z-index:1; pointer-events:none; display:flex; align-items:center; justify-content:center; }
  ...
  .rb-story-img { animation:rb-story-zoom 14s ${n} both; filter:${ne}; }
  ...
  .rb-gallery-item::after { content:''; position:absolute; inset:0; border-radius:3px;
    border:1px solid rgba(238,211,170,0); transition:border-color .3s ${n}; pointer-events:none; }
  ...
  .rb-gallery-item img { width:100%; height:auto; display:block; filter:${ne};
    transition:transform .6s ${n}, filter .6s ${n}; }
  ...
  .rb-lightbox-fig img { max-width:100%; max-height:74vh; width:auto; height:auto; display:block; border-radius:3px;
    box-shadow:0 40px 90px -20px rgba(0,0,0,.7); animation:rb-lb-zoom .32s ${n} both; }
  ...
  .rb-lb-btn { position:absolute; background:rgba(19,19,19,.55); border:1px solid rgba(238,211,170,.22); color:${y};
    ...
    transition:background .2s ${n}, border-color .2s ${n}, transform .15s ${n}; }
  ...
  .rb-testi-fade { animation:rb-testi-in .7s ${n} both; }
  ...
  .rb-testi-dot::after { content:''; width:7px; height:7px; border-radius:50%; border:1px solid rgba(238,211,170,.4);
    transition:background .25s ${n}, border-color .25s ${n}, transform .2s ${n}; }
...
`,de=t=>String(t).padStart(2,"0"),oe=t=>`${Math.floor(t/60)}:${de(t%60)}`,ge=t=>`${de(Math.floor(t/60))}:${de(t%60)}`;function Qe(t,s){const r=ce[t],i=s.filter(d=>!d.closed);return{open:!1,label:i.length===s.length&&i.every(d=>d.open===i[0].open&&d.close===i[0].close)?r.statusHours(ge(i[0].open),ge(i[0].close)):r.statusHoursVaried}}function Je(t,s,r){const i=new Date(t),b=i.getUTCDay(),d=i.getUTCHours()*60+i.getUTCMinutes(),x=r[b],$=ce[s];return!x.closed&&d>=x.open&&d<x.close?{open:!0,label:$.statusOpen(oe(x.close))}:x.closed||d<x.open?{open:!1,label:$.statusOpensToday(oe(x.open))}:{open:!1,label:$.statusOpensTomorrow(oe(r[(b+1)%7].open))}}const v=(t,s=0)=>t?{}:{opacity:0,transform:"translateY(26px)",transition:`opacity .95s ${n} ${s}s, transform .95s ${n} ${s}s`};function ue({item:t,lang:s}){return e.jsxs("div",{className:"rb-row",style:{padding:"20px 0",borderBottom:`1px solid ${j}`},children:[e.jsxs("div",{style:{display:"flex",alignItems:"baseline",gap:4},children:[e.jsxs("span",{className:"rb-row-name",style:{fontFamily:g,fontSize:"clamp(19px,1.9vw,24px)",color:y,transition:`color .2s ${n}`},children:[t.name,t.tag&&e.jsx("span",{style:{fontFamily:C,fontSize:10.5,fontWeight:700,letterSpacing:".1em",textTransform:"uppercase",color:u,background:X,padding:"3px 8px",borderRadius:4,marginLeft:12,verticalAlign:"middle"},children:t.tag[s]})]}),e.jsx("span",{className:"rb-leader","aria-hidden":"true"}),e.jsx("span",{style:{fontSize:16,fontWeight:600,color:l,whiteSpace:"nowrap"},children:t.price})]}),t.desc[s]&&e.jsx("p",{style:{fontSize:14,lineHeight:1.55,color:h,margin:"8px 0 0",maxWidth:"46ch"},children:t.desc[s]})]})}function V({art:t,lang:s,fill:r,style:i}){return e.jsxs("figure",{className:"rb-menu-art",style:{margin:0,display:"flex",flexDirection:"column",height:r?"100%":void 0,...i},children:[e.jsx("div",{style:{overflow:"hidden",borderRadius:3,flex:r?"1 1 auto":void 0,aspectRatio:r?void 0:`${t.w} / ${t.h}`},children:e.jsx("img",{src:t.src,alt:t.cap[s],loading:"lazy",decoding:"async",width:t.w,height:t.h,style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}})}),e.jsxs("figcaption",{style:{display:"flex",alignItems:"baseline",gap:4,padding:"16px 0 14px",borderBottom:`1px solid ${j}`},children:[e.jsx("span",{style:{fontFamily:g,fontStyle:"italic",fontSize:"clamp(15px,1.5vw,17px)",color:k},children:t.cap[s]}),t.price&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"rb-leader","aria-hidden":"true"}),e.jsx("span",{style:{fontSize:14,fontWeight:600,color:l,whiteSpace:"nowrap"},children:t.price})]})]})]})}function Ze({art:t,lang:s,style:r}){return e.jsxs("figure",{className:"rb-menu-art",style:{margin:0,...r},children:[e.jsx("div",{style:{display:"grid",gridTemplateColumns:`repeat(${t.frames.length}, 1fr)`,gap:10},children:t.frames.map(i=>e.jsx("div",{style:{overflow:"hidden",borderRadius:3,aspectRatio:`${i.w} / ${i.h}`},children:e.jsx("img",{src:i.src,alt:i.alt[s],loading:"lazy",decoding:"async",width:i.w,height:i.h,style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}})},i.src))}),e.jsxs("figcaption",{style:{display:"flex",alignItems:"baseline",gap:4,padding:"16px 0 14px",borderBottom:`1px solid ${j}`},children:[e.jsx("span",{style:{fontFamily:g,fontStyle:"italic",fontSize:"clamp(15px,1.5vw,17px)",color:k},children:t.cap[s]}),t.price&&e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"rb-leader","aria-hidden":"true"}),e.jsx("span",{style:{fontSize:14,fontWeight:600,color:l,whiteSpace:"nowrap"},children:t.price})]})]})]})}function fe({art:t,text:s,reduced:r,flip:i}){return e.jsxs("div",{"data-reveal":!0,className:"rb-story-chapter",style:{...v(r,.08),display:"grid",gridTemplateColumns:i?"minmax(280px,420px) minmax(0,480px)":"minmax(0,480px) minmax(280px,420px)",gap:"clamp(28px,5vw,72px)",justifyContent:"center",alignItems:"center"},children:[e.jsx("img",{src:t.src,alt:"","aria-hidden":"true",loading:"lazy",decoding:"async",width:t.w,height:t.h,style:{gridColumn:i?2:1,gridRow:1,width:"100%",height:"auto",display:"block",borderRadius:3}}),e.jsx("p",{style:{gridColumn:i?1:2,gridRow:1,margin:0,borderLeft:`2px solid ${X}`,paddingLeft:"clamp(18px,2.4vw,32px)",fontSize:"clamp(17px,1.9vw,21px)",lineHeight:1.72,color:"rgba(243,234,211,.86)"},children:s})]})}function et({photo:t,lang:s,onOpen:r,style:i}){return e.jsx("button",{type:"button",className:"rb-gallery-item","data-reveal":!0,style:i,onClick:r,"aria-label":t.caption[s],children:e.jsx("img",{src:t.srcSm,srcSet:`${t.srcSm} 800w, ${t.src} 2000w`,sizes:"(max-width:480px) 92vw, (max-width:820px) 46vw, (max-width:1239px) 31vw, 384px",alt:t.caption[s],loading:"lazy",decoding:"async",style:{aspectRatio:`${t.w} / ${t.h}`}})})}function tt({lang:t,reduced:s,reviews:r}){const[i,b]=c.useState(0),[d,x]=c.useState(!1);c.useEffect(()=>{if(s||d||r.length<=1)return;const M=window.setInterval(()=>b(f=>(f+1)%r.length),6500);return()=>window.clearInterval(M)},[s,d,r]),c.useEffect(()=>{i>=r.length&&b(0)},[r,i]);const $=r[i]??r[0];return e.jsxs("div",{onMouseEnter:()=>x(!0),onMouseLeave:()=>x(!1),onFocus:()=>x(!0),onBlur:()=>x(!1),children:[e.jsxs("blockquote",{className:s?void 0:"rb-testi-fade",style:{margin:"0 auto",maxWidth:"38ch",fontFamily:g,fontWeight:400,fontSize:"clamp(26px,3.6vw,46px)",lineHeight:1.25,color:y},children:["“",$.quote[t],"”"]},i),e.jsx("figcaption",{className:s?void 0:"rb-testi-fade",style:{fontSize:14,color:k,marginTop:16},children:$.who},`w-${i}`),r.length>1&&e.jsx("div",{role:"tablist","aria-label":t==="en"?"Reviews":"Umsagnir",style:{display:"flex",gap:0,justifyContent:"center",marginTop:4},children:r.map((M,f)=>e.jsx("button",{type:"button",role:"tab","aria-selected":f===i,"aria-label":`${t==="en"?"Review":"Umsögn"} ${f+1}`,"data-active":f===i,className:"rb-testi-dot",onClick:()=>b(f)},f))})]})}function rt(){const[t,s]=We(),r=ce[t],{LINKS:i,HOURS_BY_DAY:b,FEATURE:d,MENU:x,BREAD:$,CAKES:M,GALLERY:f,REVIEWS:ve,hoursRows:we,mainName:Q,trustLine:je,heroTitle:ke,heroSub:$e,heroLine:Se,statementQuote:Ne,statementWho:Te,storyP1:ze,storyP2:Ie}=ye(),pe=Math.min(x.length,Math.ceil(x.length/2)+1),he=c.useRef(null),[m,me]=c.useState(!1);c.useEffect(()=>{const a=window.matchMedia("(prefers-reduced-motion: reduce)");me(a.matches);const o=p=>me(p.matches);return a.addEventListener("change",o),()=>a.removeEventListener("change",o)},[]);const[J,be]=c.useState(null);c.useEffect(()=>{be(Date.now());const a=window.setInterval(()=>be(Date.now()),3e4);return()=>window.clearInterval(a)},[]);const R=c.useMemo(()=>J===null?Qe(t,b):Je(J,t,b),[J,t,b]);c.useEffect(()=>{Ee(N)},[]);const[P,Z]=c.useState(!1);Be(()=>{if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;let a=!0;try{a=window.sessionStorage.getItem("rb-intro-seen")!=="1"}catch{}a&&Z(!0)},[]),c.useEffect(()=>{if(!P)return;const a=window.setTimeout(()=>Z(!1),2150);return()=>window.clearTimeout(a)},[P]);const[w,H]=c.useState(!1),ee=c.useRef(null);c.useEffect(()=>{if(w)return;const a=ee.current;if(!a)return;ee.current=null;const o=document.querySelector(a);o&&o.scrollIntoView({behavior:m?"auto":"smooth",block:"start"})},[w,m]),c.useEffect(()=>{if(!w)return;const a=window.scrollY,o=document.body.style,p={position:o.position,top:o.top,left:o.left,right:o.right,width:o.width,overflow:o.overflow};o.position="fixed",o.top=`-${a}px`,o.left="0",o.right="0",o.width="100%",o.overflow="hidden";const W=D=>{D.key==="Escape"&&H(!1)};window.addEventListener("keydown",W);const O=window.matchMedia("(min-width:821px)"),_=D=>{D.matches&&H(!1)};return O.addEventListener("change",_),()=>{o.position=p.position,o.top=p.top,o.left=p.left,o.right=p.right,o.width=p.width,o.overflow=p.overflow,window.scrollTo({top:a,left:0,behavior:"instant"}),window.removeEventListener("keydown",W),O.removeEventListener("change",_)}},[w]);const te=c.useRef(!1);c.useEffect(()=>{if(P){te.current=!0;return}if(!te.current){te.current=!0;return}try{window.sessionStorage.setItem("rb-intro-seen","1")}catch{}},[P]),c.useEffect(()=>{if(m)return;const a=he.current;if(!a||!("IntersectionObserver"in window))return;const o=S=>{S.style.opacity="1",S.style.transform="none"},p=new IntersectionObserver(S=>{S.forEach(ie=>{ie.isIntersecting&&(o(ie.target),p.unobserve(ie.target))})},{threshold:.1,rootMargin:"0px 0px -6% 0px"}),W=Array.from(a.querySelectorAll("[data-reveal]"));W.forEach(S=>p.observe(S));const O=()=>{W.forEach(S=>{S.style.opacity!=="1"&&S.getBoundingClientRect().top<window.innerHeight&&(o(S),p.unobserve(S))})},_=()=>{document.visibilityState==="visible"&&O()},D=window.setTimeout(O,2500);return document.addEventListener("visibilitychange",_),()=>{p.disconnect(),window.clearTimeout(D),document.removeEventListener("visibilitychange",_)}},[m,t,f]);const Ce=c.useMemo(()=>["Vínarbrauð","Súrdeigsbrauð","Snúður","Kanillengja","Pistasíusnúður","Kleina","Rúgbrauð","Skúffukaka"],[]),[L,re]=c.useState(null),ae=()=>re(null),G=a=>re(o=>o===null?o:(o+a+f.length)%f.length);c.useEffect(()=>{if(L===null)return;const a=document.body.style.overflow;document.body.style.overflow="hidden";const o=p=>{p.key==="Escape"&&ae(),p.key==="ArrowRight"&&G(1),p.key==="ArrowLeft"&&G(-1)};return window.addEventListener("keydown",o),()=>{document.body.style.overflow=a,window.removeEventListener("keydown",o)}},[L]);const Y="clamp(80px,11vh,140px) clamp(20px,4.5vw,72px)",F={maxWidth:1180,margin:"0 auto"};return e.jsxs("div",{ref:he,className:"rb-page",lang:t,style:{fontFamily:C,color:y,background:N,overflowX:"clip",WebkitFontSmoothing:"antialiased"},children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:Xe}}),P&&e.jsx("div",{className:"rb-intro",onClick:()=>Z(!1),"aria-hidden":"true",children:e.jsxs("div",{className:"rb-intro-logo",children:[e.jsx("img",{className:"rb-intro-draw",src:q,alt:"",decoding:"async"}),e.jsx("span",{className:"rb-intro-tip"})]})}),e.jsx("div",{className:"rb-awning",id:"top","aria-hidden":"true"}),e.jsxs("div",{className:"rb-stickybar",children:[e.jsx("a",{href:"#top",className:"rb-sticky-logo","aria-label":"Reynir bakari",style:{display:"flex",alignItems:"center"},children:e.jsx("img",{src:q,alt:"",width:132,height:57,decoding:"async",style:{width:96,height:"auto",display:"block"}})}),e.jsxs("nav",{className:"rb-sticky-nav",children:[e.jsx("a",{href:"#menu",className:"rb-navlink",children:r.navMenu}),e.jsx("a",{href:"#bread",className:"rb-navlink",children:r.navBread}),e.jsx("a",{href:"#gallery",className:"rb-navlink",children:r.navGallery}),e.jsx(z,{to:U,className:"rb-navlink",children:r.navStory}),e.jsx("a",{href:"#visit",className:"rb-navlink",children:r.navVisit})]}),e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"clamp(10px,1.6vw,20px)"},children:[e.jsxs("div",{className:"rb-bar-lang",role:"group","aria-label":"Language",style:{display:"flex",gap:2,alignItems:"center"},children:[e.jsx("button",{className:"rb-lang","aria-pressed":t==="en",onClick:()=>s("en"),children:"EN"}),e.jsx("span",{"aria-hidden":"true",style:{color:k},children:"/"}),e.jsx("button",{className:"rb-lang","aria-pressed":t==="is",onClick:()=>s("is"),children:"ÍS"})]}),e.jsxs("span",{style:{display:"flex",alignItems:"center",gap:7,fontSize:12,letterSpacing:".08em",textTransform:"uppercase",color:R.open?u:k,whiteSpace:"nowrap"},children:[e.jsx("span",{className:"rb-sticky-dot",style:{background:R.open?l:"rgba(243,234,211,.4)"}}),e.jsx("span",{className:"rb-sticky-status",children:R.label})]}),e.jsx(z,{to:se,className:"rb-sticky-cta",children:le[t].navOrder}),e.jsxs("button",{type:"button",className:"rb-burger rb-burger-bar","aria-expanded":w,"aria-controls":"rb-mobile-menu","aria-label":t==="is"?"Valmynd":"Menu",onClick:()=>H(a=>!a),children:[e.jsx("span",{className:"rb-burger-line","aria-hidden":"true"}),e.jsx("span",{className:"rb-burger-line","aria-hidden":"true"}),e.jsx("span",{className:"rb-burger-line","aria-hidden":"true"})]})]})]}),e.jsxs("div",{className:"rb-menu",id:"rb-mobile-menu","data-open":w,"aria-hidden":!w,children:[e.jsxs("div",{className:"rb-menu-top",children:[e.jsx("img",{src:q,alt:"",width:132,height:57,decoding:"async",style:{width:104,height:"auto",display:"block"}}),e.jsxs("button",{type:"button",className:"rb-burger rb-burger-close","aria-expanded":w,"aria-controls":"rb-mobile-menu","aria-label":t==="is"?"Loka valmynd":"Close menu",onClick:()=>H(!1),children:[e.jsx("span",{className:"rb-burger-line","aria-hidden":"true"}),e.jsx("span",{className:"rb-burger-line","aria-hidden":"true"}),e.jsx("span",{className:"rb-burger-line","aria-hidden":"true"})]})]}),e.jsx("nav",{className:"rb-menu-nav","aria-label":t==="is"?"Valmynd":"Menu",children:[{href:"#menu",label:r.navMenu},{href:"#bread",label:r.navBread},{href:"#gallery",label:r.navGallery},{to:U,label:r.navStory},{href:"#visit",label:r.navVisit}].map((a,o)=>{const p=e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"rb-menu-num","aria-hidden":"true",children:String(o+1).padStart(2,"0")}),a.label]}),W={...T,...A};return a.to?e.jsx(z,{to:a.to,className:"rb-menu-link",style:W,onClick:()=>H(!1),tabIndex:w?0:-1,children:p},a.label):e.jsx("a",{href:a.href,className:"rb-menu-link",style:W,onClick:O=>{O.preventDefault(),ee.current=a.href,H(!1)},tabIndex:w?0:-1,children:p},a.label)})}),e.jsxs("div",{className:"rb-menu-foot",children:[e.jsxs("div",{className:"rb-menu-footrow",children:[e.jsxs("span",{className:"rb-menu-status",style:{color:R.open?u:k},children:[e.jsx("span",{className:"rb-sticky-dot",style:{background:R.open?l:"rgba(243,234,211,.4)"}}),R.label]}),e.jsxs("div",{role:"group","aria-label":"Language",style:{display:"flex",gap:2,alignItems:"center"},children:[e.jsx("button",{className:"rb-lang","aria-pressed":t==="en",onClick:()=>s("en"),tabIndex:w?0:-1,children:"EN"}),e.jsx("span",{"aria-hidden":"true",style:{color:k},children:"/"}),e.jsx("button",{className:"rb-lang","aria-pressed":t==="is",onClick:()=>s("is"),tabIndex:w?0:-1,children:"ÍS"})]})]}),e.jsx(z,{to:se,className:"rb-menu-cta",onClick:()=>H(!1),tabIndex:w?0:-1,children:le[t].navOrder})]})]}),e.jsxs("section",{className:"rb-cover",style:{position:"relative",display:"flex",flexDirection:"column",padding:"0 clamp(20px,4.5vw,72px)"},children:[e.jsxs("div",{className:"rb-cover-grid",style:{...F,flex:1,width:"100%",display:"grid",gridTemplateColumns:"1fr",alignItems:"center",position:"relative",padding:"clamp(24px,5vh,56px) 0"},children:[e.jsx("div",{className:"rb-cover-art rb-enter-3",children:e.jsx("img",{className:"rb-hero-spin",src:Me,alt:t==="en"?"A Reynir pistachio snúður, glazed and topped with pistachios":"Pistasíusnúður frá Reyni, gljáður og toppaður með pistasíum",style:{width:"100%",height:"auto",display:"block"}})}),e.jsxs("div",{className:"rb-cover-copy",style:{display:"flex",flexDirection:"column",alignItems:"flex-start",maxWidth:640,position:"relative",zIndex:2},children:[e.jsx("div",{className:"rb-cover-meta rb-enter",style:{display:"flex",gap:18,alignItems:"center",fontSize:12.5,letterSpacing:".14em",textTransform:"uppercase",flexWrap:"wrap"},children:e.jsxs("span",{style:{display:"inline-flex",alignItems:"center",gap:8,color:l},children:[e.jsx("span",{"aria-hidden":"true",style:{width:6,height:6,borderRadius:"50%",background:R.open?"#8FA876":l}}),R.label]})}),e.jsx("h1",{className:"rb-enter-2",style:{fontFamily:g,fontWeight:700,fontSize:"clamp(46px, 9.5vw, 134px)",lineHeight:.98,letterSpacing:".02em",margin:"clamp(16px,3vh,30px) 0 0",...T,...A},children:ke[t]}),e.jsx("p",{className:"rb-enter-3",style:{fontStyle:"italic",fontSize:"clamp(17px,1.9vw,23px)",color:y,margin:"clamp(16px,2.5vh,24px) 0 0",lineHeight:1.5,maxWidth:"30ch"},children:$e[t]}),e.jsx("p",{className:"rb-enter-3",style:{fontSize:"clamp(14.5px,1.2vw,16px)",color:h,margin:"12px 0 0",maxWidth:"40ch",lineHeight:1.6},children:Se[t]}),e.jsxs("div",{className:"rb-cover-ctas rb-enter-4",style:{display:"flex",gap:14,marginTop:"clamp(24px,3.5vh,36px)"},children:[e.jsx("a",{href:i.order,target:"_blank",rel:"noreferrer",className:"rb-cta rb-cta-gold",children:r.ctaDelivery}),e.jsx("a",{href:"#menu",className:"rb-cta rb-cta-ghost",children:r.ctaMenu})]})]})]}),e.jsx("div",{style:{borderTop:`1px solid ${I}`,borderBottom:`1px solid ${I}`,padding:"18px 0",overflow:"hidden",position:"relative",zIndex:2},children:e.jsx("div",{className:"rb-marquee-track","aria-hidden":"true",children:[0,1].map(a=>e.jsx("div",{style:{display:"flex",alignItems:"center"},children:Ce.map((o,p)=>e.jsxs("span",{style:{display:"inline-flex",alignItems:"center"},children:[e.jsx("span",{style:{fontFamily:g,fontSize:"clamp(20px,2.4vw,30px)",color:p%2?l:u,padding:"0 26px"},children:o}),e.jsx("span",{style:{width:5,height:5,borderRadius:"50%",background:l,opacity:.6}})]},`${a}-${p}`))},a))})})]}),e.jsx("section",{id:"menu",style:{background:N,borderTop:`1px solid ${j}`,padding:Y},children:e.jsxs("div",{style:F,children:[e.jsxs("div",{"data-reveal":!0,style:v(m),children:[e.jsx("div",{style:{borderTop:`1px solid ${I}`,paddingTop:16,fontSize:12,fontWeight:700,letterSpacing:".24em",textTransform:"uppercase",color:l},children:r.menuMasthead}),e.jsx("h2",{style:{fontFamily:g,fontWeight:400,fontSize:"clamp(34px,4.6vw,62px)",lineHeight:1.03,margin:"18px 0 0",...T,...A},children:r.ovenTitle}),e.jsx("p",{style:{fontSize:16,color:h,margin:"16px 0 0",maxWidth:"52ch",lineHeight:1.65},children:r.ovenIntro})]}),e.jsxs("div",{"data-reveal":!0,className:"rb-feature",style:{...v(m,.1),marginTop:"clamp(40px,6vh,68px)",borderTop:`1px solid ${j}`,borderBottom:`1px solid ${j}`,padding:"clamp(32px,5vh,52px) 0",display:"grid",gridTemplateColumns:"1fr 0.85fr",gap:"clamp(24px,4vw,64px)",alignItems:"center"},children:[e.jsxs("div",{children:[e.jsx("div",{style:{fontSize:12,fontWeight:700,letterSpacing:".2em",textTransform:"uppercase",color:l},children:r.featuredLabel}),e.jsxs("div",{style:{display:"flex",alignItems:"baseline",gap:20,flexWrap:"wrap",marginTop:14},children:[e.jsx("h3",{style:{fontFamily:g,fontWeight:400,fontSize:"clamp(34px,5vw,64px)",margin:0,...T,...A},children:d.name}),e.jsx("span",{style:{fontSize:22,fontWeight:600,color:l},children:d.price})]}),e.jsx("p",{style:{fontSize:17,lineHeight:1.7,color:h,margin:"16px 0 0",maxWidth:"46ch"},children:d.desc[t]})]}),e.jsx("div",{className:"rb-feature-art",style:{display:"flex",justifyContent:"center"},children:e.jsx("figure",{className:"rb-frame",style:{margin:0,width:"min(100%, 420px)",borderRadius:16,padding:6,border:"1px solid rgba(238,211,170,.22)",background:"linear-gradient(160deg, rgba(243,234,211,.06), rgba(243,234,211,.02))",boxShadow:"0 34px 70px -24px rgba(0,0,0,.75), inset 0 1px 0 rgba(255,255,255,.06)"},children:e.jsxs("div",{style:{position:"relative",borderRadius:10,overflow:"hidden",aspectRatio:"1 / 1"},children:[e.jsx("img",{src:He,alt:t==="en"?"A Reynir pistachio snúður torn open, gooey pistachio glaze stretching between the halves":"Pistasíusnúður frá Reyni rifinn í sundur, pistasíugljái teygist á milli helminganna",loading:"lazy",decoding:"async",style:{width:"100%",height:"100%",objectFit:"cover",display:"block"}}),e.jsx("span",{style:{position:"absolute",top:14,left:14,fontFamily:C,fontSize:10.5,fontWeight:700,letterSpacing:".1em",textTransform:"uppercase",color:u,background:X,padding:"4px 9px",borderRadius:4,boxShadow:"0 6px 16px -6px rgba(0,0,0,.6)"},children:r.featuredLabel})]})})})]}),e.jsxs("div",{className:"rb-menu-cols","data-reveal":!0,style:{...v(m,.12),display:"grid",gridTemplateColumns:"1fr 1fr",columnGap:"clamp(40px,6vw,88px)",rowGap:0,marginTop:"clamp(36px,5vh,56px)"},children:[e.jsxs("div",{style:{display:"grid",alignContent:"start"},children:[e.jsx(V,{art:K.lengjur,lang:t,style:{marginBottom:14}}),x.slice(0,pe).map(a=>e.jsx(ue,{item:a,lang:t},a.name))]}),e.jsxs("div",{style:{display:"grid",alignContent:"start"},children:[x.slice(pe).map(a=>e.jsx(ue,{item:a,lang:t},a.name)),e.jsx(V,{art:K.bordid,lang:t,style:{marginTop:26}})]})]})]})}),e.jsxs("section",{id:"story",style:{background:E},children:[e.jsxs("div",{className:"rb-story-open",style:{position:"relative",height:"clamp(380px,72vh,760px)",overflow:"hidden"},children:[e.jsx("img",{src:B.open.src,alt:"","aria-hidden":"true",loading:"lazy",decoding:"async",width:B.open.w,height:B.open.h,className:"rb-story-img",style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:`linear-gradient(0deg, ${E} 0%, rgba(11,10,9,.78) 22%, rgba(92,28,31,.28) 62%, rgba(11,10,9,.45) 100%)`}}),e.jsx("div",{style:{position:"absolute",left:0,right:0,bottom:0,padding:"clamp(28px,5vw,72px)"},children:e.jsxs("div",{style:{maxWidth:1180,margin:"0 auto"},children:[e.jsx("div",{"data-reveal":!0,style:{...v(m),fontSize:12,fontWeight:700,letterSpacing:".24em",textTransform:"uppercase",color:u},children:r.statementKicker}),e.jsxs("blockquote",{"data-reveal":!0,style:{...v(m,.08),fontFamily:g,fontWeight:400,fontSize:"clamp(32px,5.4vw,76px)",lineHeight:1.1,letterSpacing:".005em",color:y,margin:"18px 0 0",maxWidth:"18ch"},children:["“",Ne[t],"”"]}),e.jsx("div",{"data-reveal":!0,style:{...v(m,.14),fontSize:14,color:"rgba(243,234,211,.72)",marginTop:18},children:Te[t]})]})})]}),e.jsx("div",{style:{padding:"clamp(56px,9vh,110px) clamp(20px,4.5vw,72px) clamp(72px,11vh,140px)"},children:e.jsxs("div",{style:{maxWidth:1180,margin:"0 auto",display:"grid",gap:"clamp(48px,8vh,96px)"},children:[e.jsx(fe,{art:B.founding,text:ze[t],reduced:m}),e.jsx(fe,{art:B.today,text:Ie[t],reduced:m,flip:!0}),e.jsx("div",{"data-reveal":!0,style:{...v(m,.1)},children:e.jsx(z,{to:U,className:"rb-cta rb-cta-ghost",children:r.storyMore})})]})})]}),e.jsx("section",{id:"bread",style:{background:E,padding:Y},children:e.jsxs("div",{style:F,children:[e.jsxs("div",{"data-reveal":!0,style:{...v(m),display:"flex",justifyContent:"space-between",alignItems:"flex-end",gap:24,flexWrap:"wrap",borderTop:`1px solid ${I}`,paddingTop:16},children:[e.jsxs("div",{style:{maxWidth:620},children:[e.jsx("div",{style:{fontSize:12,fontWeight:700,letterSpacing:".24em",textTransform:"uppercase",color:l},children:r.breadKicker}),e.jsx("h2",{style:{fontFamily:g,fontWeight:400,fontSize:"clamp(34px,4.8vw,64px)",lineHeight:1.03,margin:"16px 0 0",...T,...A},children:r.breadTitle}),e.jsx("p",{style:{fontSize:16,lineHeight:1.7,color:h,margin:"16px 0 0"},children:r.breadIntro})]}),e.jsx("div",{style:{fontSize:13.5,color:k,fontStyle:"italic"},children:r.breadNote})]}),e.jsxs("div",{className:"rb-bread-grid","data-reveal":!0,style:{...v(m,.12),display:"grid",gridTemplateColumns:"minmax(260px,400px) minmax(0,1fr)",columnGap:"clamp(40px,6vw,88px)",alignItems:"stretch",marginTop:"clamp(36px,5vh,56px)"},children:[e.jsx(V,{art:K.braud,lang:t,fill:!0}),e.jsx("div",{children:$.map(a=>e.jsxs("div",{style:{padding:"16px 0",borderBottom:"1px solid rgba(243,234,211,.1)"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"baseline",gap:4},children:[e.jsx("span",{style:{fontFamily:g,fontSize:"clamp(18px,1.8vw,22px)",color:u,lineHeight:1.3},children:a.name}),e.jsx("span",{className:"rb-leader","aria-hidden":"true"}),e.jsx("span",{style:{fontSize:15,fontWeight:600,color:l,whiteSpace:"nowrap"},children:a.price})]}),e.jsx("div",{style:{fontSize:13.5,color:h,marginTop:5,lineHeight:1.5},children:a.desc[t]})]},a.name))})]})]})}),e.jsx("section",{style:{background:Fe,padding:Y},children:e.jsxs("div",{style:F,children:[e.jsxs("div",{className:"rb-catering-grid","data-reveal":!0,style:{...v(m),display:"grid",gridTemplateColumns:"1fr 1fr",gap:"clamp(28px,5vw,80px)",alignItems:"center"},children:[e.jsxs("div",{children:[e.jsx("div",{style:{fontSize:12,fontWeight:700,letterSpacing:".24em",textTransform:"uppercase",color:l},children:r.cateringKicker}),e.jsx("h2",{style:{fontFamily:g,fontWeight:400,fontSize:"clamp(30px,3.6vw,50px)",margin:"16px 0 0",...T,...A},children:r.cateringTitle}),e.jsx("p",{style:{fontSize:16,lineHeight:1.7,color:h,margin:"16px 0 0",maxWidth:"46ch"},children:r.cateringBody}),e.jsx("a",{href:`mailto:${i.orderEmail}`,className:"rb-cta rb-cta-ghost",style:{marginTop:"clamp(20px,3vh,28px)"},children:r.cateringCta}),e.jsx(V,{art:K.kaka,lang:t,style:{marginTop:"clamp(28px,4vh,40px)",maxWidth:480}})]}),e.jsxs("div",{children:[e.jsx(Ze,{art:Oe,lang:t,style:{marginBottom:"clamp(20px,3vh,30px)"}}),e.jsx("div",{style:{display:"grid",gap:0},children:M.map(a=>e.jsxs("div",{style:{padding:"13px 0",borderBottom:`1px solid ${j}`},children:[e.jsxs("div",{style:{display:"flex",alignItems:"baseline",gap:4},children:[e.jsx("span",{style:{fontFamily:g,fontSize:"clamp(18px,1.8vw,22px)",color:y},children:a.name}),e.jsx("span",{className:"rb-leader","aria-hidden":"true"}),e.jsx("span",{style:{fontSize:15,fontWeight:600,color:l,whiteSpace:"nowrap"},children:a.price})]}),a.desc[t]&&e.jsx("p",{style:{fontSize:13.5,lineHeight:1.55,color:h,margin:"6px 0 0",maxWidth:"44ch"},children:a.desc[t]})]},a.name))})]})]}),e.jsxs("figure",{"data-reveal":!0,style:{...v(m,.14),margin:"0",marginTop:"clamp(48px,7vh,84px)",borderTop:`1px solid ${j}`,paddingTop:"clamp(36px,5vh,52px)",textAlign:"center"},children:[e.jsx(tt,{lang:t,reduced:m,reviews:ve}),e.jsx("div",{style:{fontSize:13.5,color:h,marginTop:18},children:je[t]})]})]})}),e.jsx(qe,{lang:t,orderPath:se}),e.jsxs("section",{id:"gallery",style:{background:N,padding:"clamp(56px,9vh,110px) 0 clamp(64px,10vh,120px)"},children:[e.jsx("div",{style:{padding:"0 max(20px, calc((100vw - 1180px) / 2 + 20px))"},children:e.jsx("div",{"data-reveal":!0,style:{...v(m),borderTop:`1px solid ${I}`,paddingTop:16},children:e.jsxs("div",{style:{maxWidth:640},children:[e.jsx("div",{style:{fontSize:12,fontWeight:700,letterSpacing:".24em",textTransform:"uppercase",color:l},children:r.galleryKicker}),e.jsx("h2",{style:{fontFamily:g,fontWeight:400,fontSize:"clamp(30px,4vw,52px)",lineHeight:1.03,margin:"18px 0 0",...T,...A},children:r.galleryTitle}),e.jsx("p",{style:{fontSize:16,color:h,margin:"16px 0 0",lineHeight:1.65},children:r.galleryIntro})]})})}),e.jsx("div",{className:"rb-gallery-strip",style:{marginTop:"clamp(28px,4vh,44px)"},children:f.map((a,o)=>e.jsx(et,{photo:a,lang:t,onOpen:()=>re(o),style:v(m,Math.min(o,5)*.05)},a.src))}),e.jsx("div",{style:{...F,padding:"0 clamp(20px,4.5vw,72px)",marginTop:"clamp(24px,3.5vh,36px)"},children:e.jsx(z,{to:U,className:"rb-cta rb-cta-ghost",children:r.galleryMore})})]}),e.jsx("section",{id:"visit",style:{background:N,padding:Y},children:e.jsx("div",{style:F,children:e.jsxs("div",{className:"rb-visit-grid",style:{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"clamp(32px,5vw,80px)",alignItems:"start"},children:[e.jsxs("div",{"data-reveal":!0,style:v(m),children:[e.jsx("div",{style:{fontSize:12,fontWeight:700,letterSpacing:".24em",textTransform:"uppercase",color:l,borderTop:`1px solid ${I}`,paddingTop:16},children:r.visitKicker}),e.jsx("h2",{style:{fontFamily:g,fontWeight:400,fontSize:"clamp(38px,5vw,72px)",lineHeight:1.02,margin:"18px 0 0",...T,...A},children:r.visitTitle}),e.jsx("div",{style:{fontFamily:g,fontSize:"clamp(22px,2.4vw,28px)",color:y,marginTop:"clamp(20px,3vh,28px)"},children:Q}),e.jsxs("div",{style:{marginTop:18,display:"grid",gap:12,maxWidth:420},children:[we[t].map(a=>e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",gap:16,borderBottom:`1px solid ${j}`,paddingBottom:10,fontSize:14.5,color:h},children:[e.jsx("span",{children:a.label}),e.jsx("span",{style:{color:y},children:a.value})]},a.label)),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",gap:16,borderBottom:`1px solid ${j}`,paddingBottom:10},children:[e.jsx("span",{style:{fontSize:14.5,color:h},children:r.rowPhone}),e.jsx("a",{href:`tel:${i.phone}`,className:"rb-foot-link",style:{fontSize:14.5,fontWeight:600},children:i.phoneLabel})]}),e.jsxs("div",{style:{display:"flex",justifyContent:"space-between",gap:16},children:[e.jsx("span",{style:{fontSize:14.5,color:h},children:r.rowEmail}),e.jsx("a",{href:`mailto:${i.email}`,className:"rb-foot-link",style:{fontSize:14.5,fontWeight:600,wordBreak:"break-all"},children:i.email})]})]}),e.jsxs("div",{style:{display:"flex",flexWrap:"wrap",gap:12,marginTop:"clamp(26px,4vh,36px)"},children:[e.jsx("a",{href:i.order,target:"_blank",rel:"noreferrer",className:"rb-cta rb-cta-gold",children:r.orderPrimary}),e.jsx("a",{href:i.wolt,target:"_blank",rel:"noreferrer",className:"rb-cta rb-cta-ghost",children:r.orderWolt})]}),e.jsx("p",{style:{fontSize:14.5,color:h,margin:"18px 0 0",lineHeight:1.6,maxWidth:"34ch"},children:r.deliveryNote})]}),e.jsxs("div",{"data-reveal":!0,style:{...v(m,.1)},children:[e.jsx("figure",{style:{margin:0,borderRadius:4,overflow:"hidden",border:`1px solid ${I}`},children:e.jsx("img",{src:Pe,alt:t==="en"?"Inside Reynir bakari on Dalvegur: a wall of framed black-and-white bakery photographs above the tables":"Inni í Reyni bakara á Dalvegi: veggur með innrömmuðum svarthvítum myndum úr bakaríinu fyrir ofan borðin",width:1900,height:1400,loading:"lazy",decoding:"async",style:{width:"100%",height:"auto",display:"block"}})}),e.jsx(Ke,{lang:t,locations:[{label:r.mainLabel,address:Q,query:"Reynir bakari, Dalvegur 4, 201 Kópavogur"}]})]})]})})}),e.jsx("footer",{style:{background:E,borderTop:`1px solid ${j}`,padding:"52px clamp(20px,4.5vw,72px)"},children:e.jsxs("div",{style:{...F,display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:22},children:[e.jsxs("div",{children:[e.jsx("img",{src:q,alt:"","aria-hidden":"true",width:120,height:52,loading:"lazy",decoding:"async",style:{width:120,height:"auto",display:"block"}}),e.jsx("div",{style:{fontSize:13,color:k,marginTop:12},children:r.footerTag})]}),e.jsxs("div",{style:{fontSize:13.5,color:h,lineHeight:1.8,textAlign:"right"},children:[e.jsxs("div",{children:[Q," · ",i.phoneLabel]}),e.jsxs("div",{style:{display:"flex",gap:18,justifyContent:"flex-end",marginTop:6,flexWrap:"wrap"},children:[e.jsx("a",{href:i.instagram,target:"_blank",rel:"noreferrer",className:"rb-foot-link",children:"Instagram"}),e.jsx("a",{href:i.facebook,target:"_blank",rel:"noreferrer",className:"rb-foot-link",children:"Facebook"}),e.jsx("a",{href:i.order,target:"_blank",rel:"noreferrer",className:"rb-foot-link",children:"aha.is"}),e.jsx("a",{href:i.wolt,target:"_blank",rel:"noreferrer",className:"rb-foot-link",children:"Wolt"}),e.jsx(z,{to:_e,className:"rb-foot-link",children:r.legalLink})]}),e.jsx("div",{style:{fontSize:12,color:k,marginTop:10},children:r.legalLine})]})]})}),L!==null&&e.jsxs("div",{className:"rb-lightbox",role:"dialog","aria-modal":"true","aria-label":f[L].caption[t],onClick:ae,children:[e.jsx("button",{type:"button",className:"rb-lb-btn rb-lb-close",onClick:ae,"aria-label":r.galleryClose,children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 18 18",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M2 2L16 16M16 2L2 16",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round"})})}),e.jsx("button",{type:"button",className:"rb-lb-btn rb-lb-prev",onClick:a=>{a.stopPropagation(),G(-1)},"aria-label":r.galleryPrev,children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 18 18",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M11 3L5 9L11 15",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})})}),e.jsx("button",{type:"button",className:"rb-lb-btn rb-lb-next",onClick:a=>{a.stopPropagation(),G(1)},"aria-label":r.galleryNext,children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 18 18",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M7 3L13 9L7 15",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})})}),e.jsxs("figure",{className:"rb-lightbox-fig",onClick:a=>a.stopPropagation(),children:[e.jsx("img",{src:f[L].src,alt:f[L].caption[t],decoding:"async"},f[L].src),e.jsx("figcaption",{className:"rb-lightbox-cap",children:f[L].caption[t]})]})]}),e.jsx(De,{})]})}function st(){return e.jsx(Le,{children:e.jsx(rt,{})})}export{st as default};
