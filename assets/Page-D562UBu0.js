import{r as p,s as ie,j as e}from"./index-CYkigCbj.js";import ne from"./lenis-niKyKZQP.js";import{c as le}from"./company-Dj0FZhSK.js";import{P as me}from"./PreviewChrome-C1Wtla8x.js";import{P as de}from"./PreviewFooter-DvBOQJv0.js";import"./copy-C7_1aP-a.js";import"./createLucideIcon-CfKWMQ9l.js";import"./proxy-CNAlm4EX.js";import"./index-Cr2_b_7w.js";import"./send-YXoEzB_j.js";import"./index-CFQYWTTj.js";import"./external-link-Bk1qr-DW.js";import"./x-DJVRURuk.js";import"./check-DMGq8Tgj.js";import"./mail-CYTNeLo2.js";import"./SndrBadge-BvAgYvFk.js";const n="/iceland-redesigns/mirrorsuite",Z="info@themirrorsuite.com",ce="mailto:info@themirrorsuite.com",pe="Ljárskógarströnd 17, 371 Búðardalur, Iceland",he="the Glass Suite ehf.",E={hero:`${n}/hero.jpg`,dusk:`${n}/int-1.jpg`,wide2:`${n}/wide-2.jpg`,wide3:`${n}/wide-3.jpg`,wide4:`${n}/wide-4.jpg`,wide5:`${n}/wide-5.jpg`,wide6:`${n}/wide-6.jpg`,wide7:`${n}/wide-7.jpg`,int2:`${n}/int-2.jpg`,int3:`${n}/int-3.jpg`,int4:`${n}/int-4.jpg`,land1:`${n}/land-1.jpg`,land2:`${n}/land-2.jpg`,tall1:`${n}/tall-1.jpg`,tall2:`${n}/tall-2.jpg`,tall3:`${n}/tall-3.jpg`,tall4:`${n}/tall-4.jpg`,tall5:`${n}/tall-5.jpg`,tall6:`${n}/tall-6.jpg`,tall7:`${n}/tall-7.jpg`,tall8:`${n}/tall-8.jpg`,tall9:`${n}/tall-9.jpg`,sq1:`${n}/sq-1.jpg`,sq2:`${n}/sq-2.jpg`,port1:`${n}/port-1.jpg`,port2:`${n}/port-2.jpg`,port3:`${n}/port-3.jpg`,port4:`${n}/port-4.jpg`},X=[{id:"rodin",label:"The row"},{id:"svitan",label:"The suite"},{id:"floran",label:"The names"},{id:"bokun",label:"Book"}],J={word:"The Mirror Suite",sub:"Mirror suites on the shore of Hvammsfjörður, fifty metres from the sea."},U={lead:"The sea on one side. The sea again, in the glass.",body:"A row of mirror-clad suites stands on the shore in West Iceland, each with floor-to-ceiling glass facing the fjord, its own glass-walled sauna, and a hot tub under the open sky. Fifty metres away, the tide does the decorating."},fe=[{img:"dusk",label:"The dusk",text:"A suite and its hot tub on the moor at golden hour, the fjord light reflected in the cladding."},{img:"tall1",label:"The bed",text:"From under the duvet: the next mirror cube standing in the window."},{img:"tall5",label:"The night",text:"The suite lit under a starry sky, the aurora low on the horizon."},{img:"tall2",label:"The glass",text:"Mirror panels handing the room to the fjord and the sky."}],$={lead:"Each suite carries its own sauna and its own sky.",body:"Floor-to-ceiling windows face the fjord, a private glass-walled sauna faces the same water, and the hot tub sits outside under whatever the night brings. Self check-in from three, and the suite is yours until eleven.",facts:[{n:"2",l:"guests per suite"},{n:"50",l:"metres to the sea"},{n:"15–11",l:"check-in to check-out"}],amenities:["Private glass-walled sauna","Outdoor hot tub","Floor-to-ceiling ocean glass","Bathrobes and floor heating","Kitchenette with coffee and spices","Credit cards accepted"]},I={lead:"Named after what grows on the shore.",body:"Four suites, identical to one another, each named for a plant that grows between the row and the water. Small, hardy, and entirely of this coast.",names:[{en:"Arctic Thyme",is:"Blóðberg",lat:"Thymus praecox ssp. arcticus",note:"Of the mint family. It mats over dry gravel and heath, turns rose-purple through July and August, and has been picked for tea here for centuries.",bloom:"#C2698D"},{en:"Lupine",is:"Lúpína",lat:"Lupinus nootkatensis",note:"Carried back from Alaska in 1945 to hold the loose soil down. It settled in, and it is now the blue that means summer has arrived.",bloom:"#7B84D2"},{en:"Bearberry",is:"Sortulyng",lat:"Arctostaphylos uva-ursi",note:"Of the heath family. Thick evergreen leaves and red fruit, low to the ground, and it will not survive a winter it has been grazed through.",bloom:"#A8443A"},{en:"Forget-me-not",is:"Gleym-mér-ei",lat:"Myosotis arvensis",note:"Small and blue, in nearly every part of the country. The Icelandic name is the English one, word for word. Your listing writes it Gleymmerey.",bloom:"#8FB8DE"}],foot:"All four suites are identical in layout, design and amenities. The name on the door is the only thing that changes."},w={lead:"4.98 from fifty-four guests, and not one of them on your own website.",score:"4.98",count:"54 reviews · Guest Favourite",source:"Airbnb",body:"Ninety-eight per cent of them are five stars, and Marat is a Superhost at 4.97 across 133 stays. Your own booking page still says “no reviews yet”. A guest deciding at midnight never sees any of it.",sourceNote:"Real reviews, quoted verbatim from your Airbnb listing (the Mirror Suite 2, Lupine) on 16 August 2026. On your own site they would sit here, on your own domain, working for you instead of for Airbnb.",quotes:[{text:"The location was amazing! We were able to catch the sunset over the mountain from inside our room and in the private sauna! It was really stunning, and we would highly recommend staying here!",name:"Brendan",meta:"Austin, Texas · Airbnb, August 2026"},{text:"This was one of our two favorite places & homes on our entire Iceland trip. Perfect to relax and enjoy. We can only recommend staying here",name:"Alexandra",meta:"Eleven years on Airbnb · August 2026"},{text:"The mirror suite was cozy, unique, and had beautiful views of both the ocean and the mountains. It was a peaceful place to relax.",name:"Tamara",meta:"Orlando, Florida · Airbnb, July 2026"},{text:"Unique location and it was wonderful to sit in the hot tub overlooking the water.",name:"Lesley-Anne",meta:"Thirteen years on Airbnb · July 2026"}]},M={note:"Scroll to run the night",chapters:[{at:0,text:"Fifty metres from the sea."},{at:.22,text:"Three of the four walls are glass."},{at:.45,text:"A glass sauna, facing the same water."},{at:.67,text:"A hot tub kept warm all winter."},{at:.86,text:"Some nights the sky does the decorating."}]},V={lead:"Marat and Isabelle",body:"The duo behind the row: Marat runs marketing and strategy, Isabelle runs communication and the guests. Lena joined in 2026 and keeps the suites spotless."},D={title:"Ask for a suite",body:"Send your dates and party of two, and we answer personally with availability and a price. No card, no charge, nothing is booked yet.",success:"Thank you. Your request is with us and we answer personally, usually within a day."},ge={"@context":"https://schema.org","@type":"LodgingBusiness",name:"The Mirror Suite",legalName:"the Glass Suite ehf.",description:"Mirror-clad luxury suites on the shore of Hvammsfjörður in West Iceland, 50 metres from the sea, each with a private glass-walled sauna and outdoor hot tub.",email:Z,url:"https://www.themirrorsuite.com",address:{"@type":"PostalAddress",streetAddress:"Ljárskógarströnd 17",postalCode:"371",addressLocality:"Búðardalur",addressCountry:"IS"},aggregateRating:{"@type":"AggregateRating",ratingValue:"4.98",reviewCount:"54",bestRating:"5"},checkinTime:"15:00",checkoutTime:"11:00"},K=le,ee="#0F141C",ue="#EEF0EA",Q="ms_seen";let R=null;const q=new Set;let F=0,S=!1;function te(){if(F=0,!q.size)return;const a=window.innerHeight,m=[];q.forEach(r=>{const s=r.el.getBoundingClientRect();m.push({n:r,p:(s.top+s.height/2-a/2)/(a/2+s.height/2),vis:s.bottom>-80&&s.top<a+80})});for(const{n:r,p:s,vis:l}of m)l&&(r.el.style.transform=`translate3d(0, ${(-s*r.d).toFixed(3)}%, 0)`);F=requestAnimationFrame(te)}function ae(a,m){if(!a||S)return()=>{};const r={el:a,d:m};return q.add(r),F||(F=requestAnimationFrame(te)),()=>{q.delete(r),a.style.transform=""}}function B({src:a,alt:m,drift:r=10,ratio:s="4/3"}){const l=p.useRef(null);p.useEffect(()=>ae(l.current,r),[r]);const h=Math.max(9,r*1.35);return e.jsx("figure",{className:"ms-frame",style:{"--dz":`${h}%`,aspectRatio:s},children:e.jsx("div",{className:"ms-frame-in",ref:l,children:e.jsx("img",{src:a,alt:m,loading:"lazy",decoding:"async"})})})}function b({as:a="div",className:m="",children:r}){return e.jsx(a,{className:`ms-rise ${m}`,children:e.jsx("span",{className:"ms-rise-in",children:r})})}function xe({onDone:a}){const[m,r]=p.useState(0),s=p.useRef(!1);return p.useEffect(()=>{const l=performance.now();let h=0;const i=Array.from(document.images),y=Math.max(1,i.length);let t=i.filter(u=>u.complete).length;const o=()=>{t+=1};i.forEach(u=>{u.complete||(u.addEventListener("load",o),u.addEventListener("error",o))});const f=()=>{const u=performance.now()-l,v=Math.min(1,t/y),j=Math.min(1,Math.max(u/2400,Math.min(v,u/1100)));if(r(Math.round(j*100)),j>=1&&!s.current){s.current=!0,window.setTimeout(()=>{a(),window.dispatchEvent(new CustomEvent("ms:revealed"))},240);return}h=requestAnimationFrame(f)};return h=requestAnimationFrame(f),()=>cancelAnimationFrame(h)},[a]),e.jsxs("div",{className:"ms-loader",role:"status","aria-label":"Loading",children:[e.jsx("div",{className:"ms-loader-word",style:{"--p":`${100-m}%`},children:"THE MIRROR SUITE"}),e.jsx("div",{className:"ms-loader-horizon","aria-hidden":"true"})]})}function ve(){const[a,m]=p.useState(0);return e.jsx("section",{className:"ms-row",id:"rodin","aria-label":"The row of suites",children:e.jsx("div",{className:"ms-row-track",children:fe.map((r,s)=>e.jsxs("button",{type:"button",className:`ms-panel ${a===s?"is-open":""}`,onMouseEnter:()=>m(s),onFocus:()=>m(s),onClick:()=>m(s),"aria-expanded":a===s,children:[e.jsx("img",{src:E[r.img],alt:r.text,loading:"lazy",decoding:"async"}),e.jsx("span",{className:"ms-panel-scrim","aria-hidden":"true"}),e.jsx("span",{className:"ms-panel-label",children:r.label}),e.jsx("span",{className:"ms-panel-text",children:r.text})]},r.img))})})}function we(){const[a,m]=p.useState(!1),r=s=>{s.preventDefault();const l=new FormData(s.currentTarget);try{const h="ms_demo_requests",i=JSON.parse(localStorage.getItem(h)||"[]");i.push({...Object.fromEntries(l.entries()),at:new Date().toISOString()}),localStorage.setItem(h,JSON.stringify(i))}catch{}m(!0)};return a?e.jsx("div",{className:"ms-book-done",role:"status",children:e.jsx("p",{children:D.success})}):e.jsxs("form",{className:"ms-book-form",onSubmit:r,children:[e.jsxs("div",{className:"ms-field-row",children:[e.jsxs("div",{className:"ms-field",children:[e.jsx("label",{htmlFor:"ms-in",children:"Arrival"}),e.jsx("input",{id:"ms-in",name:"arrival",type:"date",required:!0})]}),e.jsxs("div",{className:"ms-field",children:[e.jsx("label",{htmlFor:"ms-out",children:"Departure"}),e.jsx("input",{id:"ms-out",name:"departure",type:"date",required:!0})]})]}),e.jsxs("div",{className:"ms-field-row",children:[e.jsxs("div",{className:"ms-field",children:[e.jsx("label",{htmlFor:"ms-name",children:"Name"}),e.jsx("input",{id:"ms-name",name:"name",type:"text",autoComplete:"name",required:!0})]}),e.jsxs("div",{className:"ms-field",children:[e.jsx("label",{htmlFor:"ms-email",children:"Email"}),e.jsx("input",{id:"ms-email",name:"email",type:"email",autoComplete:"email",required:!0})]})]}),e.jsx("button",{className:"ms-cta",type:"submit",children:"Send the request"}),e.jsx("p",{className:"ms-book-note",children:"Demo prototype: the request is stored only in this browser."})]})}function Ye(){const[a,m]=p.useState(!1),[r,s]=p.useState(!1),[l,h]=p.useState(!1),i=p.useRef(null);p.useEffect(()=>{S=window.matchMedia("(prefers-reduced-motion: reduce)").matches,ie(ee),document.title="The Mirror Suite — Mirror suites by the sea in West Iceland";const t=new URLSearchParams(window.location.search).has("loader");let o=!1;try{o=sessionStorage.getItem(Q)==="1"}catch{o=!0}if(!S&&(t||!o)){s(!0);try{sessionStorage.setItem(Q,"1")}catch{}}else m(!0),window.setTimeout(()=>window.dispatchEvent(new CustomEvent("ms:revealed")),60)},[]),p.useEffect(()=>{if(window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const t=new ne({lerp:.1,smoothWheel:!0});R=t;let o=requestAnimationFrame(function f(u){t.raf(u),o=requestAnimationFrame(f)});return()=>{cancelAnimationFrame(o),t.destroy(),R=null}},[]),p.useEffect(()=>{const t=i.current;if(!t)return;if(t.classList.add("js"),S){t.classList.add("reduced");return}const o=new IntersectionObserver(v=>v.forEach(j=>{j.isIntersecting&&(j.target.classList.add("is-on"),o.unobserve(j.target))}),{threshold:.2});t.querySelectorAll(".ms-rise, .ms-frame, .ms-fact, .ms-amen li, .ms-flora-row, .ms-row-track").forEach(v=>o.observe(v));const f=t.querySelector(".ms-nav"),u=t.querySelector(".ms-hero");if(f&&u){const v=new IntersectionObserver(([j])=>f.classList.toggle("is-past",!j.isIntersecting),{rootMargin:"-72px 0px 0px 0px",threshold:0});return v.observe(u),()=>{o.disconnect(),v.disconnect()}}return()=>o.disconnect()},[a]),p.useEffect(()=>{const t=()=>{var o;return(o=i.current)==null?void 0:o.classList.add("is-revealed")};return window.addEventListener("ms:revealed",t),()=>window.removeEventListener("ms:revealed",t)},[]);const y=t=>o=>{o.preventDefault();const f=document.getElementById(t);f&&(R?R.scrollTo(f,{offset:-10}):f.scrollIntoView({behavior:S?"auto":"smooth",block:"start"}))};return e.jsxs("div",{className:"ms-root",ref:i,children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:ke}}),e.jsx("script",{type:"application/ld+json",dangerouslySetInnerHTML:{__html:JSON.stringify(ge)}}),r&&!a&&e.jsx(xe,{onDone:()=>m(!0)}),e.jsxs("header",{className:"ms-nav",children:[e.jsx("a",{className:"ms-nav-mark",href:"#top",onClick:y("top"),children:"THE MIRROR SUITE"}),e.jsx("nav",{className:"ms-nav-links","aria-label":"Sections",children:X.map(t=>e.jsx("a",{href:`#${t.id}`,onClick:y(t.id),children:t.label},t.id))}),e.jsxs("button",{className:`ms-burger ${l?"is-x":""}`,"aria-expanded":l,"aria-label":l?"Close menu":"Open menu",onClick:()=>h(t=>!t),children:[e.jsx("i",{}),e.jsx("i",{})]})]}),e.jsx("div",{className:`ms-sheet ${l?"is-open":""}`,"aria-hidden":!l,children:X.map((t,o)=>e.jsx("a",{href:`#${t.id}`,style:{transitionDelay:`${80+o*55}ms`},onClick:f=>{h(!1),y(t.id)(f)},children:t.label},t.id))}),e.jsxs("main",{id:"top",children:[e.jsxs("section",{className:"ms-hero",children:[e.jsx(be,{}),e.jsxs("div",{className:"ms-hero-lockup",children:[e.jsx("h1",{className:"ms-hero-word","aria-label":J.word,children:["The Mirror","Suite"].map((t,o)=>e.jsx("span",{className:"ms-hero-line",children:e.jsx("span",{className:"ms-hero-line-in",style:{transitionDelay:`${140+o*130}ms`},children:t})},t))}),e.jsx("p",{className:"ms-hero-sub",children:e.jsx("span",{children:J.sub})})]})]}),e.jsxs("section",{className:"ms-statement",children:[e.jsx(b,{as:"h2",className:"ms-statement-lead",children:U.lead}),e.jsx(b,{as:"p",className:"ms-statement-body",children:U.body})]}),e.jsx(ve,{}),e.jsx("section",{className:"ms-suite",id:"svitan",children:e.jsxs("div",{className:"ms-suite-grid",children:[e.jsxs("div",{className:"ms-suite-copy",children:[e.jsx(b,{as:"h2",className:"ms-h2",children:$.lead}),e.jsx(b,{as:"p",className:"ms-body",children:$.body}),e.jsx("div",{className:"ms-facts",role:"list",children:$.facts.map(t=>e.jsxs("div",{className:"ms-fact",role:"listitem",children:[e.jsx("span",{className:"ms-fact-n",children:t.n}),e.jsx("span",{className:"ms-fact-l",children:t.l})]},t.l))}),e.jsx("ul",{className:"ms-amen",children:$.amenities.map(t=>e.jsx("li",{children:t},t))})]}),e.jsxs("div",{className:"ms-suite-photos",children:[e.jsx(B,{src:E.int2,alt:"Inside a suite, glass facing the fjord",ratio:"3/2",drift:10}),e.jsxs("div",{className:"ms-suite-pair",children:[e.jsx(B,{src:E.port1,alt:"The kitchenette and its coffee",ratio:"3/3.6",drift:8}),e.jsx(B,{src:E.tall8,alt:"Mirror cladding meeting the dark timber end wall",ratio:"3/3.6",drift:9})]})]})]})}),e.jsx(ye,{}),e.jsx(je,{}),e.jsxs("section",{className:"ms-flora",id:"floran",children:[e.jsxs("div",{className:"ms-flora-head",children:[e.jsx(b,{as:"h2",className:"ms-h2",children:I.lead}),e.jsx(b,{as:"p",className:"ms-body",children:I.body})]}),e.jsx("ol",{className:"ms-flora-index",children:I.names.map((t,o)=>e.jsxs("li",{className:"ms-flora-row",style:{transitionDelay:`${o*90}ms`,"--bloom":t.bloom},children:[e.jsx("span",{className:"ms-flora-n",children:String(o+1).padStart(2,"0")}),e.jsx("span",{className:"ms-flora-mark","aria-hidden":"true",children:e.jsx("i",{})}),e.jsxs("span",{className:"ms-flora-name",children:[e.jsx("span",{className:"ms-flora-is",children:t.is}),e.jsx("span",{className:"ms-flora-en",children:t.en})]}),e.jsx("span",{className:"ms-flora-note",children:t.note}),e.jsx("span",{className:"ms-flora-lat",children:t.lat})]},t.en))}),e.jsx("p",{className:"ms-flora-foot",children:I.foot})]}),e.jsxs("section",{className:"ms-hosts",children:[e.jsx(b,{as:"h2",className:"ms-h2 ms-center",children:V.lead}),e.jsx(b,{as:"p",className:"ms-body ms-center",children:V.body})]}),e.jsxs("section",{className:"ms-book",id:"bokun",children:[e.jsxs("div",{className:"ms-book-copy",children:[e.jsx(b,{as:"h2",className:"ms-h2",children:D.title}),e.jsx(b,{as:"p",className:"ms-body",children:D.body})]}),e.jsx(we,{})]}),e.jsxs("footer",{className:"ms-footer",children:[e.jsx("div",{className:"ms-footer-horizon","aria-hidden":"true"}),e.jsx("div",{className:"ms-footer-word","aria-hidden":"true",children:"Sjáumst við sjóinn"}),e.jsxs("dl",{className:"ms-footer-dl",children:[e.jsxs("div",{children:[e.jsx("dt",{children:"Email"}),e.jsx("dd",{children:e.jsx("a",{href:ce,children:Z})})]}),e.jsxs("div",{children:[e.jsx("dt",{children:"Address"}),e.jsx("dd",{children:pe})]}),e.jsxs("div",{children:[e.jsx("dt",{children:"Company"}),e.jsx("dd",{children:he})]})]}),e.jsx(de,{company:K})]})]}),e.jsx(me,{company:K})]})}function be(){const a=p.useRef(null);return p.useEffect(()=>ae(a.current,8),[]),e.jsx("div",{className:"ms-hero-media",style:{"--dz":"11%"},children:e.jsx("div",{className:"ms-frame-in",ref:a,children:e.jsx("img",{src:E.hero,alt:"The mirror suites on the shore at golden hour",loading:"eager",decoding:"async"})})})}const z=121;function ye(){const[a,m]=p.useState(0),r=p.useRef(null),s=p.useRef(null),l=p.useRef(null);return p.useEffect(()=>{const h=r.current,i=s.current;if(!h||!i||S)return;const t=window.matchMedia("(max-width: 767px)").matches?"night-sm":"night",o=i.getContext("2d",{alpha:!0});if(!o)return;const f=new Array(z).fill(null);let u=-1,v=!1;const j=()=>{const g=Math.min(1.5,window.devicePixelRatio||1);i.width=Math.round(i.clientWidth*g),i.height=Math.round(i.clientHeight*g)},se=.12,Y=(g,d,x)=>{const c=i.width,N=i.height,k=Math.max(c/d,N/x),W=1-c/(d*k)>se?c/d:k,_=d*W,G=x*W;o.clearRect(0,0,c,N),o.drawImage(g,(c-_)/2,(N-G)/2,_,G)},L=g=>{let d=g;if(!f[d]){let c=1;for(;c<z;){if(f[Math.max(0,d-c)]){d=Math.max(0,d-c);break}if(f[Math.min(z-1,d+c)]){d=Math.min(z-1,d+c);break}c+=1}}const x=f[d];if(x)Y(x,x.naturalWidth,x.naturalHeight),u=d,i.dataset.frame=String(d);else{const c=l.current;c!=null&&c.complete&&c.naturalWidth&&Y(c,c.naturalWidth,c.naturalHeight)}},re=g=>`/iceland-redesigns/mirrorsuite/${t}/f${String(g+1).padStart(3,"0")}.webp`;let H=0;const O=()=>{if(v||H>=z)return;const g=H++,d=new Image;d.src=re(g);const x=()=>{v||(f[g]=d,(u<0||Math.abs(g-A)<2)&&L(A),O())};d.decode().then(x).catch(()=>{d.onload=x,d.onerror=()=>{O()}})};let A=0,T=0;const C=()=>{T||(T=requestAnimationFrame(()=>{T=0;const g=h.getBoundingClientRect(),d=g.height-window.innerHeight;if(d<=0)return;const x=Math.min(1,Math.max(0,-g.top/d)),c=Math.min(z-1,Math.round(x*(z-1)));c!==u&&(A=c,L(c));let N=0;for(let k=0;k<M.chapters.length;k+=1)x>=M.chapters[k].at&&(N=k);m(k=>k===N?k:N)}))};j(),C();const oe=window.setTimeout(()=>{for(let g=0;g<14;g++)O()},700),P=()=>{j(),L(A)};return window.addEventListener("scroll",C,{passive:!0}),window.addEventListener("resize",P),()=>{v=!0,window.clearTimeout(oe),window.removeEventListener("scroll",C),window.removeEventListener("resize",P),T&&cancelAnimationFrame(T)}},[]),e.jsx("section",{className:"ms-pano",ref:r,"aria-label":"The night",children:e.jsxs("div",{className:"ms-pano-sticky",children:[e.jsx("img",{ref:l,className:"ms-pano-still",src:E.tall5,alt:"The suites, the glass sauna and the hot tub under the aurora",loading:"eager",decoding:"async"}),e.jsx("canvas",{ref:s,className:"ms-pano-canvas","aria-hidden":"true"}),e.jsx("div",{className:"ms-cmt",children:M.chapters.map((h,i)=>e.jsx("p",{className:`ms-cmt-l ${i===a?"is-on":""}`,children:h.text.split(" ").flatMap((y,t,o)=>[e.jsx("span",{className:"ms-cmt-w",children:e.jsx("i",{style:{transitionDelay:i===a?`${t*46}ms`:"0ms"},children:y})},`${y}-${t}`),...t<o.length-1?[" "]:[]])},h.text))}),e.jsx("div",{className:"ms-cmt-rail","aria-hidden":"true",children:M.chapters.map((h,i)=>e.jsx("span",{className:i<=a?"is-on":""},h.text))}),e.jsx("p",{className:`ms-pano-hint ${a>0?"is-gone":""}`,"aria-hidden":"true",children:M.note})]})})}function je(){const[a,m]=p.useState(0),r=w.quotes.length;return p.useEffect(()=>{if(S)return;const s=window.setInterval(()=>m(l=>(l+1)%r),7e3);return()=>window.clearInterval(s)},[r]),e.jsxs("section",{className:"ms-reviews","aria-label":"Guest reviews",children:[e.jsxs("div",{className:"ms-rev-head",children:[e.jsx(b,{as:"h2",className:"ms-h2",children:w.lead}),e.jsx(b,{as:"p",className:"ms-body",children:w.body})]}),e.jsxs("div",{className:"ms-rev-grid",children:[e.jsxs("div",{className:"ms-rev-score",children:[e.jsx("span",{className:"ms-rev-n",children:w.score}),e.jsx("span",{className:"ms-rev-stars","aria-hidden":"true",children:"★★★★★"}),e.jsx("span",{className:"ms-rev-c",children:w.count}),e.jsxs("span",{className:"ms-rev-src",children:["Verified on ",w.source]})]}),e.jsxs("div",{className:"ms-rev-stage",children:[e.jsx("span",{className:"ms-rev-ord","aria-hidden":"true",children:w.quotes.map((s,l)=>e.jsx("b",{className:l===a?"is-on":"",children:String(l+1).padStart(2,"0")},s.text))}),e.jsxs("div",{className:"ms-rev-rail","aria-hidden":"true",children:[e.jsx("span",{className:"ms-rev-rail-l",children:"Reviews"}),e.jsx("span",{className:"ms-rev-rail-t",children:e.jsx("i",{style:{"--p":(a+1)/r}})})]}),e.jsxs("div",{className:"ms-rev-body",children:[e.jsxs("p",{className:"ms-rev-badge",children:[e.jsx("span",{"aria-hidden":"true"}),"Verified on ",w.source]}),e.jsx("ul",{className:"ms-rev-list",children:w.quotes.map((s,l)=>e.jsx("li",{className:`ms-rev-q ${l===a?"is-live":""}`,"aria-hidden":l!==a,children:e.jsx("blockquote",{children:s.text.split(" ").flatMap((h,i,y)=>[e.jsx("span",{className:"ms-rev-w",children:e.jsx("i",{style:{transitionDelay:l===a?`${i*38}ms`:"0ms"},children:h})},`${h}-${i}`),...i<y.length-1?[" "]:[]])})},s.text))}),e.jsxs("div",{className:"ms-rev-foot",children:[e.jsxs("p",{className:"ms-rev-who",children:[e.jsx("i",{"aria-hidden":"true"}),w.quotes[a].name," · ",w.quotes[a].meta]}),e.jsxs("div",{className:"ms-rev-nav",children:[e.jsx("button",{type:"button","aria-label":"Previous review",onClick:()=>m(s=>(s-1+r)%r),children:e.jsx("svg",{viewBox:"0 0 16 16",width:"16",height:"16","aria-hidden":"true",children:e.jsx("path",{d:"M10 12L6 8l4-4",fill:"none",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",strokeLinejoin:"round"})})}),e.jsx("button",{type:"button","aria-label":"Next review",onClick:()=>m(s=>(s+1)%r),children:e.jsx("svg",{viewBox:"0 0 16 16",width:"16",height:"16","aria-hidden":"true",children:e.jsx("path",{d:"M6 4l4 4-4 4",fill:"none",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",strokeLinejoin:"round"})})})]})]}),e.jsx("p",{className:"ms-rev-note",children:w.sourceNote})]})]})]})]})}const ke=`
@font-face{font-family:'BricolageMs';src:url('/iceland-redesigns/fonts/bricolage/bricolage-grotesque-v9-latin_latin-ext-200.woff2') format('woff2');font-weight:200;font-display:swap}
@font-face{font-family:'BricolageMs';src:url('/iceland-redesigns/fonts/bricolage/bricolage-grotesque-v9-latin_latin-ext-300.woff2') format('woff2');font-weight:300;font-display:swap}
@font-face{font-family:'BricolageMs';src:url('/iceland-redesigns/fonts/bricolage/bricolage-grotesque-v9-latin_latin-ext-500.woff2') format('woff2');font-weight:500;font-display:swap}
@font-face{font-family:'SwitzerMs';src:url('/iceland-redesigns/fonts/switzer/Switzer-Light.woff2') format('woff2');font-weight:300;font-display:swap}
@font-face{font-family:'SwitzerMs';src:url('/iceland-redesigns/fonts/switzer/Switzer-Regular.woff2') format('woff2');font-weight:400;font-display:swap}
@font-face{font-family:'SwitzerMs';src:url('/iceland-redesigns/fonts/switzer/Switzer-Medium.woff2') format('woff2');font-weight:500;font-display:swap}

.ms-root{
  --deep:${ee}; --bone:${ue}; --glass:#8FBFB0;
